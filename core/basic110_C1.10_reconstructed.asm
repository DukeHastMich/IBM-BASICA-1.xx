...
# RECONSTRUCTED SOURCE - generated from the 32 KiB ROM image
# -----------------------------------------------------------------------------
# This file is a maintainable behavioral reconstruction. Original Microsoft/IBM
...
BASICA_ENTRY_1:
    call   L_6BAD                                # 0003: E8 A7 6B
    retf                                         # 0006: CB
BASICA_ENTRY_2:
    call   L_650C                                # 0007: E8 02 65
    retf                                         # 000A: CB
ROM_ENTRY_000B:
    pop    bp                                    # 000B: 5D
L_000C:
    call   L_2FD6                                # 000C: E8 C7 2F
    je     L_001E                                # 000F: 74 0D
    mov    si,WORD PTR ds:0x4e9                  # 0011: 8B 36 E9 04
...
STMDSP:
    ...
    .word L_2968               # token CB reserved
    .word TOKH_TO              # token CC TO
    .word TOKH_THEN            # token CD THEN
    .word TOKH_TAB             # token CE TAB(
    .word TOKH_STEP            # token CF STEP
    .word TOKH_USR             # token D0 USR
    .word TOKH_FN              # token D1 FN
    .word TOKH_SPC             # token D2 SPC(
    .word TOKH_NOT             # token D3 NOT
    .word TOKH_ERL             # token D4 ERL
    .word TOKH_ERR             # token D5 ERR
    .word TOKH_STRING          # token D6 STRING$
    .word TOKH_USING           # token D7 USING
    .word TOKH_INSTR           # token D8 INSTR
    .word L_2B8C               # token D9 reserved
    .word TOKH_VARPTR          # token DA VARPTR
    .word TOKH_CSRLIN          # token DB CSRLIN
    .word TOKH_POINT           # token DC POINT
    .word TOKH_OFF             # token DD OFF
    .word TOKH_INKEY           # token DE INKEY$
    .word L_28F8               # token DF reserved
    .word L_290B               # token E0 reserved
    .word L_2280               # token E1 reserved
    .word L_2947               # token E2 reserved
    .word L_260D               # token E3 reserved
    .word L_2612               # token E4 reserved
    .word L_1B75               # token E5 reserved
    .word L_6BAD               # token E6 reserved
    .word L_6B51               # token E7 reserved
    .word L_6B82               # token E8 reserved
    .word L_659C               # token E9 reserved
    .word L_55FA               # token EA reserved
    .word L_5698               # token EB reserved
    .word L_5712               # token EC reserved
    .word L_44C0               # token ED reserved
    .word TOKH_AND             # token EE AND
    .word TOKH_OR              # token EF OR
ALPTAB:
...
L_0774:
    int    0x86                                  # 0774: CD 86
    mov    bx,WORD PTR ds:0x2e                   # 0776: 8B 1E 2E 00
    .byte 0x8A, 0xC7, 0x22, 0xC3 # 077A
    inc    al                                    # 077E: FE C0
    je     L_078B                                # 0780: 74 09
    mov    al,ds:0x34f                           # 0782: A0 4F 03
    .byte 0x0A, 0xC0 # 0785
...
L_07D8:
    .byte 0x32, 0xC0 # 07D8
    mov    ds:0x536,al                           # 07DA: A2 36 05
    mov    ds:0x5f,al                            # 07DD: A2 5F 00
    mov    ds:0x462,al                           # 07E0: A2 62 04
    mov    ds:0x60,al                            # 07E3: A2 60 00
    mov    bx,WORD PTR ds:0x2e                   # 07E6: 8B 1E 2E 00
    mov    WORD PTR ds:0x347,bx                  # 07EA: 89 1E 47 03
    .byte 0x32, 0xC0 # 07EE
    mov    ds:0x465,al                           # 07F0: A2 65 04
    mov    ds:0x46b,al                           # 07F3: A2 6B 04
    .byte 0x8A, 0xC7, 0x22, 0xC3 # 07F6
    inc    al                                    # 07FA: FE C0
    je     L_0802                                # 07FC: 74 04
    mov    WORD PTR ds:0x349,bx                  # 07FE: 89 1E 49 03
L_0802:
    mov    cx,0x80c                              # 0802: B9 0C 08
L_0805:
    mov    bx,WORD PTR ds:0x345                  # 0805: 8B 1E 45 03
...
L_086E:
    ...
    push   bx                                    # 087C: 53
    mov    bx,WORD PTR ds:0x347                  # 087D: 8B 1E 47 03
    pop    si                                    # 0881: 5E
...
L_08B6:
    int    0x8a                                  # 08B6: CD 8A
    .byte 0x32, 0xC0 # 08B8
    mov    ds:0x6f,al                            # 08BA: A2 6F 00
    call   L_44FB                                # 08BD: E8 3B 3C
    call   L_2C5D                                # 08C0: E8 9A 23
    mov    bx,0x72d                              # 08C3: BB 2D 07
    call   L_7B55                                # 08C6: E8 8C 72
    mov    al,ds:0x28                            # 08C9: A0 28 00
    sub    al,0x2                                # 08CC: 2C 02
    jne    L_08D3                                # 08CE: 75 03
    call   L_36C1                                # 08D0: E8 EE 2D
L_08D3:
    int    0x8b                                  # 08D3: CD 8B
    mov    bx,0xffff                             # 08D5: BB FF FF
    mov    WORD PTR ds:0x2e,bx                   # 08D8: 89 1E 2E 00
    mov    al,ds:0x33e                           # 08DC: A0 3E 03
    .byte 0x0A, 0xC0 # 08DF
    je     L_092C                                # 08E1: 74 49
    mov    bx,WORD PTR ds:0x33f                  # 08E3: 8B 1E 3F 03
    push   bx                                    # 08E7: 53
    call   L_6550                                # 08E8: E8 65 5C
    pop    dx                                    # 08EB: 5A
    push   dx                                    # 08EC: 52
    call   L_0A67                                # 08ED: E8 77 01
    mov    al,0x2a                               # 08F0: B0 2A
    jb     L_08F6                                # 08F2: 72 02
    mov    al,0x20                               # 08F4: B0 20
L_08F6:
    call   L_2BA5                                # 08F6: E8 AC 22
    call   L_3180                                # 08F9: E8 84 28
    pop    dx                                    # 08FC: 5A
    jae    L_090D                                # 08FD: 73 0E
    .byte 0x32, 0xC0 # 08FF
    mov    ds:0x33e,al                           # 0901: A2 3E 03
    jmp    L_08B6                                # 0904: EB B0
L_0906:
    .byte 0x32, 0xC0 # 0906
    mov    ds:0x33e,al                           # 0908: A2 3E 03
    jmp    L_0922                                # 090B: EB 15
L_090D:
    mov    bx,WORD PTR ds:0x341                  # 090D: 8B 1E 41 03
    .byte 0x03, 0xDA # 0911
    jb     L_0906                                # 0913: 72 F1
    push   dx                                    # 0915: 52
    mov    dx,0xfff9                             # 0916: BA F9 FF
    .byte 0x3B, 0xDA # 0919
    pop    dx                                    # 091B: 5A
    jae    L_0906                                # 091C: 73 E8
    mov    WORD PTR ds:0x33f,bx                  # 091E: 89 1E 3F 03
L_0922:
    mov    al,ds:0x1f7                           # 0922: A0 F7 01
    .byte 0x0A, 0xC0 # 0925
    je     L_08D3                                # 0927: 74 AA
    jmp    L_36D4                                # 0929: E9 A8 2D
L_092C:
    call   L_3180                                # 092C: E8 51 28
    jb     L_08D3                                # 092F: 72 A2
    call   L_0F1D                                # 0931: E8 E9 05
    inc    al                                    # 0934: FE C0
    dec    al                                    # 0936: FE C8
    je     L_08D3                                # 0938: 74 99
    pushf                                        # 093A: 9C
    call   L_106B                                # 093B: E8 2D 07
    jae    L_0948                                # 093E: 73 08
    call   L_2FD6                                # 0940: E8 93 26
    jne    L_0948                                # 0943: 75 03
    jmp    SNERR                                 # 0945: E9 76 FE
L_0948:
    call   L_0D83                                # 0948: E8 38 04
    mov    al,BYTE PTR [bx]                      # 094B: 8A 07
    cmp    al,0x20                               # 094D: 3C 20
    jne    L_0954                                # 094F: 75 03
    call   L_6544                                # 0951: E8 F0 5B
L_0954:
    push   dx                                    # 0954: 52
    call   L_0A89                                # 0955: E8 31 01
    pop    dx                                    # 0958: 5A
    popf                                         # 0959: 9D
    mov    WORD PTR ds:0x343,bx                  # 095A: 89 1E 43 03
    int    0x8c                                  # 095E: CD 8C
...
L_0965:
    push   dx                                    # 0965: 52
    push   cx                                    # 0966: 51
    call   L_4758                                # 0967: E8 EE 3D
    call   L_0F1D                                # 096A: E8 B0 05
    .byte 0x0A, 0xC0 # 096D
    pushf                                        # 096F: 9C
    mov    WORD PTR ds:0x349,dx                  # 0970: 89 16 49 03
    call   L_0A67                                # 0974: E8 F0 00
...
L_0982:
    ...
    pushf                                        # 0983: 9C
    push   bx                                    # 0984: 53
    call   L_2435                                # 0985: E8 AD 1A
    pop    bx                                    # 0988: 5B
    popf                                         # 0989: 9D
    pop    cx                                    # 098A: 59
    push   cx                                    # 098B: 51
    jae    L_0991                                # 098C: 73 03
    call   L_2267                                # 098E: E8 D6 18
L_0991:
    pop    dx                                    # 0991: 5A
    popf                                         # 0992: 9D
    push   dx                                    # 0993: 52
    je     L_09DD                                # 0994: 74 47
    pop    dx                                    # 0996: 5A
    mov    al,ds:0x46b                           # 0997: A0 6B 04
    .byte 0x0A, 0xC0 # 099A
    jne    L_09A6                                # 099C: 75 08
    mov    bx,WORD PTR ds:0x30a                  # 099E: 8B 1E 0A 03
    mov    WORD PTR ds:0x32f,bx                  # 09A2: 89 1E 2F 03
L_09A6:
    mov    bx,WORD PTR ds:0x358                  # 09A6: 8B 1E 58 03
    pop    si                                    # 09AA: 5E
    ...
    .byte 0x03, 0xD9 # 09B0
    push   bx                                    # 09B2: 53
    call   L_64CB                                # 09B3: E8 15 5B
    pop    bx                                    # 09B6: 5B
    mov    WORD PTR ds:0x358,bx                  # 09B7: 89 1E 58 03
...
L_09CF:
    ...
    jne    L_09CF                                # 09DB: 75 F2
L_09DD:
    int    0x8d                                  # 09DD: CD 8D
    pop    dx                                    # 09DF: 5A
    call   L_0A01                                # 09E0: E8 1E 00
    mov    bx,WORD PTR ds:0x4e9                  # 09E3: 8B 1E E9 04
    mov    WORD PTR ds:0x352,bx                  # 09E7: 89 1E 52 03
    call   L_2D37                                # 09EB: E8 49 23
    int    0x8e                                  # 09EE: CD 8E
    mov    bx,WORD PTR ds:0x352                  # 09F0: 8B 1E 52 03
    mov    WORD PTR ds:0x4e9,bx                  # 09F4: 89 1E E9 04
    jmp    L_08D3                                # 09F8: E9 D8 FE
L_09FB:
    mov    bx,WORD PTR ds:0x30                   # 09FB: 8B 1E 30 00
...
L_0A12:
    .byte 0x0A, 0xC0 # 0A12
    je     L_0A26                                # 0A14: 74 10
    cmp    al,0x20                               # 0A16: 3C 20
    jae    L_0A0F                                # 0A18: 73 F5
    cmp    al,0xb                                # 0A1A: 3C 0B
    jb     L_0A0F                                # 0A1C: 72 F1
    call   L_0F1E                                # 0A1E: E8 FD 04
    call   L_0F1D                                # 0A21: E8 F9 04
    jmp    L_0A12                                # 0A24: EB EC
L_0A26:
    inc    bx                                    # 0A26: 43
    xchg   dx,bx                                 # 0A27: 87 DA
    mov    WORD PTR [bx],dx                      # 0A29: 89 17
    jmp    L_0A01                                # 0A2B: EB D4
L_0A2D:
    ...
    call   L_2DF4                                # 0A42: E8 AF 23
    jmp    L_2C3C:0x274                          # 0A45: EA 74 02 3C 2C
L_0A4A:
...
L_0A5B:
    mov    WORD PTR ds:0x33b,bx                  # 0A5B: 89 1E 3B 03
...
L_0A62:
    ...
    push   bx                                    # 0A66: 53
L_0A67:
    mov    bx,WORD PTR ds:0x30                   # 0A67: 8B 1E 30 00
L_0A6B:
    .byte 0x8B, 0xCB # 0A6B
...
L_0A89:
    .byte 0x32, 0xC0 # 0A89
    mov    ds:0x2fd,al                           # 0A8B: A2 FD 02
    mov    ds:0x2fc,al                           # 0A8E: A2 FC 02
    int    0x8f                                  # 0A91: CD 8F
    mov    cx,0x13b                              # 0A93: B9 3B 01
    mov    dx,0xb8                               # 0A96: BA B8 00
L_0A99:
    mov    al,BYTE PTR [bx]                      # 0A99: 8A 07
    .byte 0x0A, 0xC0 # 0A9B
    jne    L_0ABF                                # 0A9D: 75 20
L_0A9F:
    mov    bx,0x140                              # 0A9F: BB 40 01
...
L_0AE3:
    mov    ds:0x2fc,al                           # 0AE3: A2 FC 02
    mov    ds:0x2fd,al                           # 0AE6: A2 FD 02
L_0AE9:
...
L_0B13:
    ...
    call   L_19EB                                # 0B16: E8 D2 0E
    call   L_2F45                                # 0B19: E8 29 24
...
L_0BD1:
    ...
    call   L_0D2C                                # 0BD8: E8 51 01
    .byte 0x32, 0xC0 # 0BDB
    mov    ds:0x2fd,al                           # 0BDD: A2 FD 02
    pop    ax                                    # 0BE0: 58
    call   L_0D2C                                # 0BE1: E8 48 01
...
L_0C22:
    ...
    call   L_0D2A                                # 0C2D: E8 FA 00
L_0C30:
    pop    ax                                    # 0C30: 58
    cmp    al,0xb1                               # 0C31: 3C B1
    jne    L_0C3A                                # 0C33: 75 05
    call   L_0D2C                                # 0C35: E8 F4 00
...
L_0C41:
    push   ax                                    # 0C41: 50
    call   L_0D2A                                # 0C42: E8 E5 00
    mov    al,0x8f                               # 0C45: B0 8F
    call   L_0D2C                                # 0C47: E8 E2 00
    pop    ax                                    # 0C4A: 58
    push   ax                                    # 0C4B: 50
...
L_0C7A:
    ...
    call   L_0D2C                                # 0C7C: E8 AD 00
    push   dx                                    # 0C7F: 52
    call   L_106B                                # 0C80: E8 E8 03
    call   L_0D83                                # 0C83: E8 FD 00
L_0C86:
    pop    si                                    # 0C86: 5E
...
L_0C8C:
    .byte 0x8A, 0xC3 # 0C8C
    call   L_0D2C                                # 0C8E: E8 9B 00
    .byte 0x8A, 0xC7 # 0C91
L_0C93:
    pop    bx                                    # 0C93: 5B
    call   L_0D2C                                # 0C94: E8 95 00
...
L_0C9A:
    ...
    call   L_0D83                                # 0CA1: E8 DF 00
    pop    cx                                    # 0CA4: 59
    pop    dx                                    # 0CA5: 5A
    push   bx                                    # 0CA6: 53
    mov    al,ds:0x2fb                           # 0CA7: A0 FB 02
    cmp    al,0x2                                # 0CAA: 3C 02
    jne    L_0CC8                                # 0CAC: 75 1A
    mov    bx,WORD PTR ds:0x4a3                  # 0CAE: 8B 1E A3 04
...
L_0CC8:
    ...
    call   L_0D2C                                # 0CCD: E8 5C 00
    mov    bx,0x4a3                              # 0CD0: BB A3 04
    call   L_1B25                                # 0CD3: E8 4F 0E
    jb     L_0CDB                                # 0CD6: 72 03
    mov    bx,0x49f                              # 0CD8: BB 9F 04
L_0CDB:
    pop    ax                                    # 0CDB: 58
L_0CDC:
    push   ax                                    # 0CDC: 50
    mov    al,BYTE PTR [bx]                      # 0CDD: 8A 07
    call   L_0D2C                                # 0CDF: E8 4A 00
    pop    ax                                    # 0CE2: 58
    inc    bx                                    # 0CE3: 43
    dec    al                                    # 0CE4: FE C8
...
L_0D3D:
    ...
    dec    bx                                    # 0D40: 4B
    dec    al                                    # 0D41: FE C8
    mov    ds:0x2fd,al                           # 0D43: A2 FD 02
    pop    cx                                    # 0D46: 59
    pop    dx                                    # 0D47: 5A
    call   L_19EB                                # 0D48: E8 A0 0C
L_0D4B:
    call   L_0D2C                                # 0D4B: E8 DE FF
    inc    bx                                    # 0D4E: 43
    call   L_19EB                                # 0D4F: E8 99 0C
    call   L_2F45                                # 0D52: E8 F0 21
...
L_0D83:
    ...
    je     L_0D83                                # 0D88: 74 F9
    cmp    al,0x9                                # 0D8A: 3C 09
    je     L_0D83                                # 0D8C: 74 F5
    cmp    al,0xa                                # 0D8E: 3C 0A
    je     L_0D83                                # 0D90: 74 F1
    inc    bx                                    # 0D92: 43
    ret                                          # 0D93: C3
FOR:
    mov    al,0x64                               # 0D94: B0 64
    mov    ds:0x339,al                           # 0D96: A2 39 03
    call   L_376E                                # 0D99: E8 D2 29
    call   L_2DF4                                # 0D9C: E8 55 20
    out    0x52,ax                               # 0D9F: E7 52
    mov    WORD PTR ds:0x33b,dx                  # 0DA1: 89 16 3B 03
    mov    al,ds:0x2fb                           # 0DA5: A0 FB 02
    push   ax                                    # 0DA8: 50
    call   L_1727                                # 0DA9: E8 7B 09
    pop    ax                                    # 0DAC: 58
    push   bx                                    # 0DAD: 53
    ...
    mov    WORD PTR ds:0x335,bx                  # 0DBE: 89 1E 35 03
...
L_0DC7:
    ...
    inc    bx                                    # 0DD6: 43
    push   bx                                    # 0DD7: 53
    mov    bx,WORD PTR ds:0x335                  # 0DD8: 8B 1E 35 03
    .byte 0x3B, 0xDA # 0DDC
    pop    bx                                    # 0DDE: 5B
    pop    dx                                    # 0DDF: 5A
    ...
    pop    dx                                    # 0DE2: 5A
    .byte 0x8B, 0xE3 # 0DE3
    mov    WORD PTR ds:0x345,bx                  # 0DE5: 89 1E 45 03
    .byte 0xB1 # 0DE9
L_0DEA:
    .byte 0x5A # 0DEA
    xchg   dx,bx                                 # 0DEB: 87 DA
    mov    cl,0x8                                # 0DED: B1 08
    call   L_2CD5                                # 0DEF: E8 E3 1E
    push   bx                                    # 0DF2: 53
    mov    bx,WORD PTR ds:0x335                  # 0DF3: 8B 1E 35 03
    pop    si                                    # 0DF7: 5E
    xchg   si,bx                                 # 0DF8: 87 DE
    push   si                                    # 0DFA: 56
    push   bx                                    # 0DFB: 53
    mov    bx,WORD PTR ds:0x2e                   # 0DFC: 8B 1E 2E 00
    pop    si                                    # 0E00: 5E
    xchg   si,bx                                 # 0E01: 87 DE
    push   si                                    # 0E03: 56
    call   L_2DF4                                # 0E04: E8 ED 1F
    int3                                         # 0E07: CC
    call   L_1B25                                # 0E08: E8 1A 0D
...
L_0E15:
    pushf                                        # 0E15: 9C
    call   L_1727                                # 0E16: E8 0E 09
    popf                                         # 0E19: 9D
    push   bx                                    # 0E1A: 53
    js     L_0E20                                # 0E1B: 78 03
    .byte 0xE9, 0x1C, 0x00 # 0E1D
L_0E20:
    call   L_6BAD                                # 0E20: E8 8A 5D
    pop    si                                    # 0E23: 5E
...
L_0E3C:
    ...
    call   L_1728                                # 0E56: E8 CF 08
    push   bx                                    # 0E59: 53
    call   L_6B51                                # 0E5A: E8 F4 5C
    call   L_63F3                                # 0E5D: E8 93 55
    call   L_7B75                                # 0E60: E8 12 6D
L_0E63:
    pop    bx                                    # 0E63: 5B
L_0E64:
    push   cx                                    # 0E64: 51
    push   dx                                    # 0E65: 52
    .byte 0x8A, 0xC8 # 0E66
    call   L_1B25                                # 0E68: E8 BA 0C
    .byte 0x8A, 0xE8 # 0E6B
    push   cx                                    # 0E6D: 51
    dec    bx                                    # 0E6E: 4B
    call   L_0F1D                                # 0E6F: E8 AB 00
    je     L_0E77                                # 0E72: 74 03
    jmp    SNERR                                 # 0E74: E9 47 F9
L_0E77:
    call   L_24FB                                # 0E77: E8 81 16
    call   L_0F1D                                # 0E7A: E8 A0 00
    push   bx                                    # 0E7D: 53
    push   bx                                    # 0E7E: 53
    mov    bx,WORD PTR ds:0x45a                  # 0E7F: 8B 1E 5A 04
    mov    WORD PTR ds:0x2e,bx                   # 0E83: 89 1E 2E 00
    mov    bx,WORD PTR ds:0x33b                  # 0E87: 8B 1E 3B 03
    pop    si                                    # 0E8B: 5E
...
L_0EBA:
    ...
    inc    bx                                    # 0EC9: 43
    mov    WORD PTR ds:0x2e,dx                   # 0ECA: 89 16 2E 00
    test   BYTE PTR ds:0x476,0xff                # 0ECE: F6 06 76 04 FF
    je     L_0EFB                                # 0ED3: 74 26
    push   bx                                    # 0ED5: 53
    mov    al,0x5b                               # 0ED6: B0 5B
    call   L_2BA5                                # 0ED8: E8 CA 1C
    xchg   dx,bx                                 # 0EDB: 87 DA
    call   L_6550                                # 0EDD: E8 70 56
    mov    al,0x5d                               # 0EE0: B0 5D
    call   L_2BA5                                # 0EE2: E8 C0 1C
    pop    bx                                    # 0EE5: 5B
    jmp    L_0EFB                                # 0EE6: EB 13
L_0EE8:
    int    0x96                                  # 0EE8: CD 96
    call   L_2C88                                # 0EEA: E8 9B 1D
    mov    WORD PTR ds:0x345,sp                  # 0EED: 89 26 45 03
    mov    WORD PTR ds:0x343,bx                  # 0EF1: 89 1E 43 03
...
L_0F1E:
    ...
    jb     L_0F25                                # 0F22: 72 01
    ret                                          # 0F24: C3
L_0F25:
    cmp    al,0x20                               # 0F25: 3C 20
    je     L_0F1D                                # 0F27: 74 F4
...
L_0F45:
    ...
    inc    bx                                    # 0F5C: 43
L_0F5D:
    mov    WORD PTR ds:0x2fe,bx                  # 0F5D: 89 1E FE 02
    mov    bh,0x0                                # 0F61: B7 00
L_0F63:
    .byte 0x8A, 0xD8 # 0F63
    mov    WORD PTR ds:0x302,bx                  # 0F65: 89 1E 02 03
    mov    al,0x2                                # 0F69: B0 02
    mov    ds:0x301,al                           # 0F6B: A2 01 03
    mov    bx,0x4                                # 0F6E: BB 04 00
    pop    ax                                    # 0F71: 58
    .byte 0x0A, 0xC0 # 0F72
    ret                                          # 0F74: C3
L_0F75:
    ...
    inc    bx                                    # 0F77: 43
    inc    bx                                    # 0F78: 43
    mov    WORD PTR ds:0x2fe,bx                  # 0F79: 89 1E FE 02
    dec    bx                                    # 0F7D: 4B
...
L_0F85:
    mov    bx,WORD PTR ds:0x2fe                  # 0F85: 8B 1E FE 02
    jmp    L_0F1E                                # 0F89: EB 93
L_0F8B:
    inc    al                                    # 0F8B: FE C0
    rol    al,1                                  # 0F8D: D0 C0
    mov    ds:0x301,al                           # 0F8F: A2 01 03
    push   dx                                    # 0F92: 52
    push   cx                                    # 0F93: 51
    ...
    pop    cx                                    # 0FA0: 59
    pop    dx                                    # 0FA1: 5A
    mov    WORD PTR ds:0x2fe,bx                  # 0FA2: 89 1E FE 02
    pop    ax                                    # 0FA6: 58
    mov    bx,0x4                                # 0FA7: BB 04 00
    .byte 0x0A, 0xC0 # 0FAA
    ret                                          # 0FAC: C3
L_0FAD:
    cmp    al,0x9                                # 0FAD: 3C 09
    jb     L_0FB4                                # 0FAF: 72 03
    jmp    L_0F1D                                # 0FB1: E9 69 FF
L_0FB4:
...
L_0FDA:
    mov    al,ds:0x301                           # 0FDA: A0 01 03
    mov    ds:0x2fb,al                           # 0FDD: A2 FB 02
    cmp    al,0x8                                # 0FE0: 3C 08
    je     L_0FF5                                # 0FE2: 74 11
    mov    bx,WORD PTR ds:0x302                  # 0FE4: 8B 1E 02 03
    mov    WORD PTR ds:0x4a3,bx                  # 0FE8: 89 1E A3 04
    mov    bx,WORD PTR ds:0x304                  # 0FEC: 8B 1E 04 03
    mov    WORD PTR ds:0x4a5,bx                  # 0FF0: 89 1E A5 04
L_0FF4:
    ret                                          # 0FF4: C3
L_0FF5:
    mov    bx,0x302                              # 0FF5: BB 02 03
...
L_103E:
    ...
    call   L_0F1D                                # 104C: E8 CE FE
    jmp    L_1006                                # 104F: EB B5
L_1051:
    call   L_0F1D                                # 1051: E8 C9 FE
L_1054:
    call   L_1F0A                                # 1054: E8 B3 0E
...
L_105E:
    ...
    mov    dx,WORD PTR ds:0x349                  # 1062: 8B 16 49 03
    jne    L_106B                                # 1066: 75 03
    jmp    L_0F1D                                # 1068: E9 B2 FE
L_106B:
    dec    bx                                    # 106B: 4B
L_106C:
    call   L_0F1D                                # 106C: E8 AE FE
    cmp    al,0xe                                # 106F: 3C 0E
    je     L_1075                                # 1071: 74 02
    cmp    al,0xd                                # 1073: 3C 0D
L_1075:
    mov    dx,WORD PTR ds:0x302                  # 1075: 8B 16 02 03
    jne    L_107E                                # 1079: 75 03
    jmp    L_0F1D                                # 107B: E9 9F FE
L_107E:
    .byte 0x32, 0xC0 # 107E
    mov    ds:0x300,al                           # 1080: A2 00 03
    dec    bx                                    # 1083: 4B
    mov    dx,0x0                                # 1084: BA 00 00
L_1087:
    call   L_0F1D                                # 1087: E8 93 FE
...
GOSUB:
    ...
    call   L_2CD5                                # 10D0: E8 02 1C
    call   L_106B                                # 10D3: E8 95 FF
    pop    cx                                    # 10D6: 59
    push   bx                                    # 10D7: 53
    push   bx                                    # 10D8: 53
    mov    bx,WORD PTR ds:0x2e                   # 10D9: 8B 1E 2E 00
    pop    si                                    # 10DD: 5E
...
L_10EC:
    push   cx                                    # 10EC: 51
GOTO:
    call   L_106B                                # 10ED: E8 7B FF
L_10F0:
    mov    al,ds:0x300                           # 10F0: A0 00 03
...
L_1100:
    ...
    push   bx                                    # 1102: 53
    mov    bx,WORD PTR ds:0x2fe                  # 1103: 8B 1E FE 02
    pop    si                                    # 1107: 5E
    ...
    inc    bx                                    # 110E: 43
    push   bx                                    # 110F: 53
    mov    bx,WORD PTR ds:0x2e                   # 1110: 8B 1E 2E 00
    .byte 0x3B, 0xDA # 1114
    pop    bx                                    # 1116: 5B
...
L_111C:
    ...
    call   L_0A67                                # 111E: E8 46 F9
L_1121:
    jae    L_1130                                # 1121: 73 0D
    dec    cx                                    # 1123: 49
    mov    al,0xd                                # 1124: B0 0D
    mov    ds:0x33d,al                           # 1126: A2 3D 03
    pop    bx                                    # 1129: 5B
...
RETURN:
    ...
    .byte 0x8B, 0xE3 # 113E
    mov    WORD PTR ds:0x345,bx                  # 1140: 89 1E 45 03
...
L_114D:
    pop    bx                                    # 114D: 5B
    mov    WORD PTR ds:0x2e,bx                   # 114E: 89 1E 2E 00
...
LET:
    call   L_376E                                # 118F: E8 DC 25
    call   L_2DF4                                # 1192: E8 5F 1C
    out    0x89,ax                               # 1195: E7 89
    push   ss                                    # 1197: 16
    cmp    ax,WORD PTR [bp+di]                   # 1198: 3B 03
    push   dx                                    # 119A: 52
    mov    al,ds:0x2fb                           # 119B: A0 FB 02
    push   ax                                    # 119E: 50
    call   L_1727                                # 119F: E8 85 05
    pop    ax                                    # 11A2: 58
    pop    si                                    # 11A3: 5E
...
RESUME:
    mov    al,ds:0x34f                           # 1258: A0 4F 03
    .byte 0x0A, 0xC0 # 125B
    jne    L_1267                                # 125D: 75 08
    .byte 0x33, 0xC0 # 125F
    mov    ds:0x34d,ax                           # 1261: A3 4D 03
    jmp    L_07CD                                # 1264: E9 66 F5
L_1267:
    inc    al                                    # 1267: FE C0
    mov    ds:0x28,al                            # 1269: A2 28 00
    cmp    BYTE PTR [bx],0x83                    # 126C: 80 3F 83
    je     L_1283                                # 126F: 74 12
    call   L_106B                                # 1271: E8 F7 FD
    jne    L_1282                                # 1274: 75 0C
    .byte 0x0B, 0xD2 # 1276
    je     L_128A                                # 1278: 74 10
    call   L_10F0                                # 127A: E8 73 FE
    .byte 0x32, 0xC0 # 127D
    mov    ds:0x34f,al                           # 127F: A2 4F 03
L_1282:
    ret                                          # 1282: C3
L_1283:
    call   L_0F1D                                # 1283: E8 97 FC
    jne    L_1282                                # 1286: 75 FA
L_1288:
    jmp    L_1291                                # 1288: EB 07
L_128A:
    .byte 0x32, 0xC0 # 128A
    mov    ds:0x34f,al                           # 128C: A2 4F 03
    inc    al                                    # 128F: FE C0
L_1291:
    mov    ax,ds:0x347                           # 1291: A1 47 03
    mov    ds:0x2e,ax                            # 1294: A3 2E 00
    mov    bx,WORD PTR ds:0x34b                  # 1297: 8B 1E 4B 03
...
ERRORS:
    call   L_1F1C                                # 12A9: E8 70 0C
    jne    L_1288                                # 12AC: 75 DA
    .byte 0x0A, 0xC0 # 12AE
    jne    L_12B5                                # 12B0: 75 03
    jmp    L_1059                                # 12B2: E9 A4 FD
L_12B5:
...
AUTO:
    ...
    call   L_2DF4                                # 12CB: E8 26 1B
    sub    al,0x8b                               # 12CE: 2C 8B
    push   ss                                    # 12D0: 16
    inc    cx                                    # 12D1: 41
    add    si,WORD PTR [si+0x8]                  # 12D2: 03 74 08
    call   L_106B                                # 12D5: E8 93 FD
...
L_12DF:
    ...
    jmp    L_1059                                # 12E5: E9 71 FD
L_12E8:
    mov    WORD PTR ds:0x341,bx                  # 12E8: 89 1E 41 03
    mov    ds:0x33e,al                           # 12EC: A2 3E 03
    pop    bx                                    # 12EF: 5B
    mov    WORD PTR ds:0x33f,bx                  # 12F0: 89 1E 3F 03
    pop    cx                                    # 12F4: 59
    jmp    L_08D3                                # 12F5: E9 DB F5
IFS:
    call   L_1727                                # 12F8: E8 2C 04
    mov    al,BYTE PTR [bx]                      # 12FB: 8A 07
    cmp    al,0x2c                               # 12FD: 3C 2C
    jne    L_1304                                # 12FF: 75 03
    call   L_0F1D                                # 1301: E8 19 FC
L_1304:
    cmp    al,0x89                               # 1304: 3C 89
    je     L_130D                                # 1306: 74 05
    call   L_2DF4                                # 1308: E8 E9 1A
    int    0x4b                                  # 130B: CD 4B
L_130D:
    push   bx                                    # 130D: 53
...
L_1328:
    mov    bx,WORD PTR ds:0x302                  # 1328: 8B 1E 02 03
L_132C:
    ret                                          # 132C: C3
L_132D:
...
L_134B:
    dec    bx                                    # 134B: 4B
    call   L_0F1D                                # 134C: E8 CE FB
    jne    L_1354                                # 134F: 75 03
    call   L_2C71                                # 1351: E8 1D 19
L_1354:
...
L_137A:
    pop    cx                                    # 137A: 59
    call   L_1727                                # 137B: E8 A9 03
    push   bx                                    # 137E: 53
    call   L_1B25                                # 137F: E8 A3 07
    je     L_1393                                # 1382: 74 0F
    call   L_70C8                                # 1384: E8 41 5D
    call   L_264C                                # 1387: E8 C2 12
    mov    BYTE PTR [bx],0x20                    # 138A: C6 07 20
    mov    bx,WORD PTR ds:0x4a3                  # 138D: 8B 1E A3 04
    inc    BYTE PTR [bx]                         # 1391: FE 07
L_1393:
    int    0x99                                  # 1393: CD 99
    mov    bx,WORD PTR ds:0x4a3                  # 1395: 8B 1E A3 04
    push   bx                                    # 1399: 53
    call   L_2FD6                                # 139A: E8 39 1C
...
L_13E0:
    ...
    mov    bx,WORD PTR ds:0x4e9                  # 13E5: 8B 1E E9 04
    .byte 0x03, 0xD9 # 13E9
    call   L_2FD6                                # 13EB: E8 E8 1B
    mov    al,BYTE PTR [bx]                      # 13EE: 8A 07
    jne    L_140A                                # 13F0: 75 18
    mov    al,ds:0x2a                            # 13F2: A0 2A 00
    .byte 0x8A, 0xE8 # 13F5
    call   L_4F2C                                # 13F7: E8 32 3B
    cmp    al,0xff                               # 13FA: 3C FF
    je     L_140A                                # 13FC: 74 0C
    .byte 0x3A, 0xC5 # 13FE
    jb     L_1405                                # 1400: 72 03
    call   L_2C71                                # 1402: E8 6C 18
L_1405:
...
L_1412:
    push   ax                                    # 1412: 50
    call   L_0F1D                                # 1413: E8 07 FB
    call   L_1F0A                                # 1416: E8 F1 0A
    pop    ax                                    # 1419: 58
    push   ax                                    # 141A: 50
...
L_143F:
    mov    al,ds:0x29                            # 143F: A0 29 00
L_1442:
    .byte 0x8A, 0xD8 # 1442
    inc    al                                    # 1444: FE C0
    je     L_144F                                # 1446: 74 07
    mov    bh,0x0                                # 1448: B7 00
    call   L_65C9                                # 144A: E8 7C 51
    xchg   dx,bx                                 # 144D: 87 DA
L_144F:
    pop    bx                                    # 144F: 5B
    call   L_2DF4                                # 1450: E8 A1 19
    sub    WORD PTR [bp+di+0x58],cx              # 1453: 29 4B 58
    sub    al,0xd2                               # 1456: 2C D2
    push   bx                                    # 1458: 53
    je     L_146E                                # 1459: 74 13
    mov    cx,0x32                               # 145B: B9 32 00
    mov    bx,WORD PTR ds:0x4e9                  # 145E: 8B 1E E9 04
    .byte 0x03, 0xD9 # 1462
    call   L_2FD6                                # 1464: E8 6F 1B
    mov    al,BYTE PTR [bx]                      # 1467: 8A 07
    jne    L_146E                                # 1469: 75 03
    call   L_4F2C                                # 146B: E8 BE 3A
L_146E:
    not    al                                    # 146E: F6 D0
    .byte 0x02, 0xC2 # 1470
...
L_148A:
    call   L_2BA5                                # 148A: E8 18 17
    dec    ch                                    # 148D: FE CD
    jne    L_148A                                # 148F: 75 F9
L_1491:
    pop    bx                                    # 1491: 5B
    call   L_0F1D                                # 1492: E8 88 FA
...
L_1498:
    ...
    mov    WORD PTR ds:0x4e9,bx                  # 14AA: 89 1E E9 04
    pop    bx                                    # 14AE: 5B
    ret                                          # 14AF: C3
L_14B0:
    push   bx                                    # 14B0: 53
...
L_14E0:
    call   L_2DF4                                # 14E0: E8 11 19
    test   WORD PTR [si],di                      # 14E3: 85 3C
...
INPUT:
    ...
    .byte 0x32, 0xC0 # 1578
    mov    ds:0x45f,al                           # 157A: A2 5F 04
    call   L_0F1D                                # 157D: E8 9D F9
    jmp    L_1586                                # 1580: EB 04
L_1582:
    call   L_2DF4                                # 1582: E8 6F 18
    .byte 0x3B # 1585
L_1586:
...
READ:
    push   bx                                    # 163E: 53
    mov    bx,WORD PTR ds:0x35e                  # 163F: 8B 1E 5E 03
    .byte 0x0D # 1643
L_1644:
    .byte 0x32, 0xC0 # 1644
    mov    ds:0x33a,al                           # 1646: A2 3A 03
    pop    si                                    # 1649: 5E
    xchg   si,bx                                 # 164A: 87 DE
    push   si                                    # 164C: 56
    jmp    L_1653                                # 164D: EB 04
    .byte 0xE8, 0xA2, 0x17, 0x2C # 164F
L_1653:
    call   L_376E                                # 1653: E8 18 21
    pop    si                                    # 1656: 5E
    ...
    je     L_166B                                # 165F: 74 0A
    mov    al,ds:0x33a                           # 1661: A0 3A 03
    .byte 0x0A, 0xC0 # 1664
    je     L_166B                                # 1666: 74 03
    jmp    L_16F6                                # 1668: E9 8B 00
L_166B:
    or     ax,0xc032                             # 166B: 0D 32 C0
    mov    ds:0x452,al                           # 166E: A2 52 04
    call   L_2FD6                                # 1671: E8 62 19
    je     L_1679                                # 1674: 74 03
    jmp    L_4504                                # 1676: E9 8B 2E
L_1679:
    call   L_1B25                                # 1679: E8 A9 04
    push   ax                                    # 167C: 50
    jne    L_16B7                                # 167D: 75 38
    call   L_0F1D                                # 167F: E8 9B F8
    .byte 0x8A, 0xF0, 0x8A, 0xE8 # 1682
    cmp    al,0x22                               # 1686: 3C 22
    je     L_1698                                # 1688: 74 0E
    mov    al,ds:0x33a                           # 168A: A0 3A 03
...
L_170A:
    ...
    inc    bx                                    # 170D: 43
    mov    WORD PTR ds:0x337,dx                  # 170E: 89 16 37 03
L_1712:
    call   L_0F1D                                # 1712: E8 08 F8
    cmp    al,0x84                               # 1715: 3C 84
    jne    L_16F6                                # 1717: 75 DD
    jmp    L_166B                                # 1719: E9 4F FF
L_171C:
    call   L_2DF4                                # 171C: E8 D5 16
    out    0xe9,ax                               # 171F: E7 E9
    add    al,0x0                                # 1721: 04 00
L_1723:
    call   L_2DF4                                # 1723: E8 CE 16
    .byte 0x28 # 1726
L_1727:
    .byte 0x4B # 1727
L_1728:
    .byte 0xB6, 0x00 # 1728
L_172A:
    .byte 0x52, 0xB1, 0x01, 0xE8, 0xA5, 0x15, 0xCD, 0x9D # 172A
    call   L_18E7                                # 1732: E8 B2 01
    .byte 0x32, 0xC0 # 1735
    mov    ds:0x4a8,al                           # 1737: A2 A8 04
    mov    WORD PTR ds:0x352,bx                  # 173A: 89 1E 52 03
L_173E:
    mov    bx,WORD PTR ds:0x352                  # 173E: 8B 1E 52 03
    pop    cx                                    # 1742: 59
    mov    al,BYTE PTR [bx]                      # 1743: 8A 07
    mov    WORD PTR ds:0x331,bx                  # 1745: 89 1E 31 03
...
L_178F:
    mov    al,ds:0x2fb                           # 178F: A0 FB 02
    sub    al,0x3                                # 1792: 2C 03
    jne    L_1799                                # 1794: 75 03
    jmp    L_07D6                                # 1796: E9 3D F0
L_1799:
    .byte 0x0A, 0xC0 # 1799
    push   WORD PTR ds:0x4a3                     # 179B: FF 36 A3 04
    jns    L_17A4                                # 179F: 79 03
    .byte 0xE9, 0x11, 0x00 # 17A1
L_17A4:
    push   WORD PTR ds:0x4a5                     # 17A4: FF 36 A5 04
    jp     L_17AD                                # 17A8: 7A 03
    .byte 0xE9, 0x08, 0x00 # 17AA
L_17AD:
    push   WORD PTR ds:0x49f                     # 17AD: FF 36 9F 04
    push   WORD PTR ds:0x4a1                     # 17B1: FF 36 A1 04
L_17B5:
...
L_17BF:
    push   cx                                    # 17BF: 51
    mov    bx,WORD PTR ds:0x331                  # 17C0: 8B 1E 31 03
    jmp    L_172A                                # 17C4: E9 63 FF
L_17C7:
...
L_17E0:
    mov    WORD PTR ds:0x331,bx                  # 17E0: 89 1E 31 03
    call   L_0F1D                                # 17E4: E8 36 F7
    jmp    L_17C9                                # 17E7: EB E0
L_17E9:
    call   L_6B51                                # 17E9: E8 65 53
...
L_1808:
    ...
    push   bx                                    # 1810: 53
    call   L_1B25                                # 1811: E8 11 03
    je     L_1819                                # 1814: 74 03
    jmp    L_178F                                # 1816: E9 76 FF
L_1819:
    mov    bx,WORD PTR ds:0x4a3                  # 1819: 8B 1E A3 04
    push   bx                                    # 181D: 53
...
L_192E:
    ...
    call   L_0F1D                                # 1932: E8 E8 F5
    mov    al,ds:0x28                            # 1935: A0 28 00
    push   bx                                    # 1938: 53
...
L_193E:
    ...
    call   L_0F1D                                # 1942: E8 D8 F5
    push   bx                                    # 1945: 53
    mov    bx,WORD PTR ds:0x347                  # 1946: 8B 1E 47 03
...
L_194F:
    ...
    call   L_0F1D                                # 1953: E8 C7 F5
    call   L_2DF4                                # 1956: E8 9B 14
    sub    BYTE PTR [si],bh                      # 1959: 28 3C
    and    si,WORD PTR [di+0xd]                  # 195B: 23 75 0D
    call   L_1F19                                # 195E: E8 B8 05
    push   bx                                    # 1961: 53
    call   L_3FA5                                # 1962: E8 40 26
    xchg   dx,bx                                 # 1965: 87 DA
    pop    bx                                    # 1967: 5B
    .byte 0xE9, 0x03, 0x00, 0xE8, 0xF9, 0x1E # 1968
L_196E:
    call   L_2DF4                                # 196E: E8 83 14
    sub    WORD PTR [bp+di-0x79],dx              # 1971: 29 53 87
...
L_19C0:
    ...
    call   L_2DF4                                # 19C3: E8 2E 14
    sub    bx,ax                                 # 19C6: 29 C3
L_19C8:
    mov    dh,0x7d                               # 19C8: B6 7D
    call   L_172A                                # 19CA: E8 5D FD
    mov    bx,WORD PTR ds:0x352                  # 19CD: 8B 1E 52 03
    push   bx                                    # 19D1: 53
    call   L_7DAB                                # 19D2: E8 D6 63
    pop    bx                                    # 19D5: 5B
    ret                                          # 19D6: C3
L_19D7:
    call   L_376E                                # 19D7: E8 94 1D
    push   bx                                    # 19DA: 53
    xchg   dx,bx                                 # 19DB: 87 DA
    mov    WORD PTR ds:0x4a3,bx                  # 19DD: 89 1E A3 04
    call   L_1B25                                # 19E1: E8 41 01
...
L_19FF:
    ...
    call   L_0F1D                                # 1A02: E8 18 F5
    call   L_19ED                                # 1A05: E8 E5 FF
...
L_1A12:
    ...
    call   L_19ED                                # 1A15: E8 D5 FF
    call   L_2F45                                # 1A18: E8 2A 15
...
L_1A8D:
    ...
    .byte 0x8A, 0xC8 # 1A91
    push   cx                                    # 1A93: 51
    call   L_0F1D                                # 1A94: E8 86 F4
    .byte 0x8A, 0xC1 # 1A97
    cmp    al,0x5                                # 1A99: 3C 05
    jae    L_1ABF                                # 1A9B: 73 22
    call   L_1723                                # 1A9D: E8 83 FC
    call   L_2DF4                                # 1AA0: E8 51 13
    sub    al,0xe8                               # 1AA3: 2C E8
    xchg   sp,ax                                 # 1AA5: 94
    dec    cx                                    # 1AA6: 49
    xchg   dx,bx                                 # 1AA7: 87 DA
    mov    bx,WORD PTR ds:0x4a3                  # 1AA9: 8B 1E A3 04
    pop    si                                    # 1AAD: 5E
    xchg   si,bx                                 # 1AAE: 87 DE
    push   si                                    # 1AB0: 56
    push   bx                                    # 1AB1: 53
    xchg   dx,bx                                 # 1AB2: 87 DA
    call   L_1F1C                                # 1AB4: E8 65 04
...
L_1B13:
    ...
    call   L_172A                                # 1B15: E8 12 FC
    call   L_6BAD                                # 1B18: E8 92 50
    not    bx                                    # 1B1B: F7 D3
    mov    WORD PTR ds:0x4a3,bx                  # 1B1D: 89 1E A3 04
    pop    cx                                    # 1B21: 59
    jmp    L_173E                                # 1B22: E9 19 FC
L_1B25:
    mov    al,ds:0x2fb                           # 1B25: A0 FB 02
...
L_1B75:
    mov    al,ds:0x63                            # 1B75: A0 63 00
    jmp    L_1B7D                                # 1B78: EB 03
TOKH_CSRLIN:
    call   L_4F2C                                # 1B7A: E8 AF 33
L_1B7D:
    inc    al                                    # 1B7D: FE C0
L_1B7F:
    .byte 0x8A, 0xD8, 0x32, 0xC0, 0x8A, 0xF8 # 1B7F
    jmp    L_650C                                # 1B85: E9 84 49
L_1B88:
    call   L_1BB9                                # 1B88: E8 2E 00
    push   dx                                    # 1B8B: 52
    ...
    jmp    L_1059                                # 1B9A: E9 BC F4
L_1B9D:
    push   cs                                    # 1B9D: 0E
    mov    bx,0x6507                             # 1B9E: BB 07 65
    push   bx                                    # 1BA1: 53
    push   WORD PTR ds:0x350                     # 1BA2: FF 36 50 03
    push   dx                                    # 1BA6: 52
    mov    al,ds:0x2fb                           # 1BA7: A0 FB 02
    push   ax                                    # 1BAA: 50
...
L_1BD3:
    ...
    ret                                          # 1BDC: C3
L_1BDD:
    call   L_1BB9                                # 1BDD: E8 D9 FF
    push   dx                                    # 1BE0: 52
    call   L_2DF4                                # 1BE1: E8 10 12
    out    0xe8,ax                               # 1BE4: E7 E8
    ret    0x5e06                                # 1BE6: C2 06 5E
    .byte 0x87, 0xDE, 0x56, 0x89, 0x17, 0x5B, 0xC3 # 1BE9
DEF:
    cmp    al,0xd0                               # 1BF0: 3C D0
    je     L_1BDD                                # 1BF2: 74 E9
    cmp    al,0xd1                               # 1BF4: 3C D1
    je     L_1C14                                # 1BF6: 74 1C
    call   L_2DF4                                # 1BF8: E8 F9 11
    push   bx                                    # 1BFB: 53
    call   L_2DF4                                # 1BFC: E8 F5 11
    inc    bp                                    # 1BFF: 45
    call   L_2DF4                                # 1C00: E8 F1 11
    inc    di                                    # 1C03: 47
    mov    dx,ds                                 # 1C04: 8C DA
    je     L_1C0F                                # 1C06: 74 07
    call   L_2DF4                                # 1C08: E8 E9 11
    out    0xe8,ax                               # 1C0B: E7 E8
    fwait                                        # 1C0D: 9B
    push   es                                    # 1C0E: 06
L_1C0F:
    mov    WORD PTR ds:0x350,dx                  # 1C0F: 89 16 50 03
    ret                                          # 1C13: C3
L_1C14:
...
L_1C29:
    call   L_0F1D                                # 1C29: E8 F1 F2
    call   L_376E                                # 1C2C: E8 3F 1B
    mov    al,BYTE PTR [bx]                      # 1C2F: 8A 07
    cmp    al,0x29                               # 1C31: 3C 29
    jne    L_1C38                                # 1C33: 75 03
    jmp    DATAS                                 # 1C35: E9 23 F5
L_1C38:
    call   L_2DF4                                # 1C38: E8 B9 11
    sub    al,0xeb                               # 1C3B: 2C EB
    out    dx,al                                 # 1C3D: EE
L_1C3E:
    call   L_1E0A                                # 1C3E: E8 C9 01
    mov    al,ds:0x2fb                           # 1C41: A0 FB 02
    .byte 0x0A, 0xC0 # 1C44
    push   ax                                    # 1C46: 50
    mov    WORD PTR ds:0x352,bx                  # 1C47: 89 1E 52 03
...
L_1C56:
    ...
    jmp    L_1D2D                                # 1C5C: E9 CE 00
L_1C5F:
    call   L_0F1D                                # 1C5F: E8 BB F2
    mov    WORD PTR ds:0x331,bx                  # 1C62: 89 1E 31 03
    xchg   dx,bx                                 # 1C66: 87 DA
    mov    bx,WORD PTR ds:0x352                  # 1C68: 8B 1E 52 03
    call   L_2DF4                                # 1C6C: E8 85 11
    sub    BYTE PTR [bp+si],dh                   # 1C6F: 28 32
    ...
    call   L_376E                                # 1C7B: E8 F0 1A
    xchg   dx,bx                                 # 1C7E: 87 DA
    pop    si                                    # 1C80: 5E
    xchg   si,bx                                 # 1C81: 87 DE
    push   si                                    # 1C83: 56
    mov    al,ds:0x2fb                           # 1C84: A0 FB 02
    push   ax                                    # 1C87: 50
    push   dx                                    # 1C88: 52
    call   L_1727                                # 1C89: E8 9B FA
    mov    WORD PTR ds:0x352,bx                  # 1C8C: 89 1E 52 03
    pop    bx                                    # 1C90: 5B
    mov    WORD PTR ds:0x331,bx                  # 1C91: 89 1E 31 03
    pop    ax                                    # 1C95: 58
    call   L_1DDA                                # 1C96: E8 41 01
    mov    cl,0x4                                # 1C99: B1 04
    call   L_2CD5                                # 1C9B: E8 37 10
    mov    bx,0xfff8                             # 1C9E: BB F8 FF
    .byte 0x03, 0xDC, 0x8B, 0xE3 # 1CA1
    call   L_64A1                                # 1CA5: E8 F9 47
    mov    al,ds:0x2fb                           # 1CA8: A0 FB 02
    push   ax                                    # 1CAB: 50
    mov    bx,WORD PTR ds:0x352                  # 1CAC: 8B 1E 52 03
    mov    al,BYTE PTR [bx]                      # 1CB0: 8A 07
    cmp    al,0x29                               # 1CB2: 3C 29
    je     L_1CC9                                # 1CB4: 74 13
    call   L_2DF4                                # 1CB6: E8 3B 11
    sub    al,0x53                               # 1CB9: 2C 53
    mov    bx,WORD PTR ds:0x331                  # 1CBB: 8B 1E 31 03
    call   L_2DF4                                # 1CBF: E8 32 11
    sub    al,0xeb                               # 1CC2: 2C EB
    mov    cl,0x58                               # 1CC4: B1 58
    mov    ds:0x3e4,al                           # 1CC6: A2 E4 03
L_1CC9:
    pop    ax                                    # 1CC9: 58
    .byte 0x0A, 0xC0 # 1CCA
    je     L_1D1C                                # 1CCC: 74 4E
    mov    ds:0x2fb,al                           # 1CCE: A2 FB 02
...
L_1D1C:
    mov    bx,WORD PTR ds:0x352                  # 1D1C: 8B 1E 52 03
    call   L_0F1D                                # 1D20: E8 FA F1
    push   bx                                    # 1D23: 53
    mov    bx,WORD PTR ds:0x331                  # 1D24: 8B 1E 31 03
    call   L_2DF4                                # 1D28: E8 C9 10
    .byte 0x29, 0xB0 # 1D2B
L_1D2D:
    .byte 0x52, 0x89, 0x1E, 0x31, 0x03 # 1D2D
    mov    al,ds:0x37c                           # 1D32: A0 7C 03
    add    al,0x4                                # 1D35: 04 04
    push   ax                                    # 1D37: 50
    ror    al,1                                  # 1D38: D0 C8
    .byte 0x8A, 0xC8 # 1D3A
    call   L_2CD5                                # 1D3C: E8 96 0F
    pop    ax                                    # 1D3F: 58
    .byte 0x8A, 0xC8 # 1D40
    not    al                                    # 1D42: F6 D0
    inc    al                                    # 1D44: FE C0
    ...
    pop    bx                                    # 1D55: 5B
    mov    WORD PTR ds:0x37a,bx                  # 1D56: 89 1E 7A 03
    mov    bx,WORD PTR ds:0x3e4                  # 1D5A: 8B 1E E4 03
    mov    WORD PTR ds:0x37c,bx                  # 1D5E: 89 1E 7C 03
    .byte 0x8B, 0xCB # 1D62
    mov    bx,0x37e                              # 1D64: BB 7E 03
    mov    dx,0x3e6                              # 1D67: BA E6 03
    call   L_1DF3                                # 1D6A: E8 86 00
    .byte 0x8A, 0xF8, 0x8A, 0xD8 # 1D6D
    mov    WORD PTR ds:0x3e4,bx                  # 1D71: 89 1E E4 03
    mov    bx,WORD PTR ds:0x450                  # 1D75: 8B 1E 50 04
    inc    bx                                    # 1D79: 43
    mov    WORD PTR ds:0x450,bx                  # 1D7A: 89 1E 50 04
    .byte 0x8A, 0xC7, 0x0A, 0xC3 # 1D7E
    mov    ds:0x44d,al                           # 1D82: A2 4D 04
    mov    bx,WORD PTR ds:0x331                  # 1D85: 8B 1E 31 03
    call   L_171C                                # 1D89: E8 90 F9
    dec    bx                                    # 1D8C: 4B
    call   L_0F1D                                # 1D8D: E8 8D F1
    je     L_1D95                                # 1D90: 74 03
    jmp    SNERR                                 # 1D92: E9 29 EA
L_1D95:
    call   L_1B25                                # 1D95: E8 8D FD
    jne    L_1DAB                                # 1D98: 75 11
    mov    dx,0x32c                              # 1D9A: BA 2C 03
    mov    bx,WORD PTR ds:0x4a3                  # 1D9D: 8B 1E A3 04
    .byte 0x3B, 0xDA # 1DA1
    jb     L_1DAB                                # 1DA3: 72 06
    call   L_2624                                # 1DA5: E8 7C 08
    call   L_2691                                # 1DA8: E8 E6 08
L_1DAB:
    mov    bx,WORD PTR ds:0x37a                  # 1DAB: 8B 1E 7A 03
    ...
    .byte 0x8B, 0xE3 # 1DC6
    mov    bx,WORD PTR ds:0x450                  # 1DC8: 8B 1E 50 04
    dec    bx                                    # 1DCC: 4B
    mov    WORD PTR ds:0x450,bx                  # 1DCD: 89 1E 50 04
    .byte 0x8A, 0xC7, 0x0A, 0xC3 # 1DD1
    mov    ds:0x44d,al                           # 1DD5: A2 4D 04
    pop    bx                                    # 1DD8: 5B
    pop    ax                                    # 1DD9: 58
L_1DDA:
    push   bx                                    # 1DDA: 53
...
L_1DFA:
    push   bx                                    # 1DFA: 53
    mov    bx,WORD PTR ds:0x2e                   # 1DFB: 8B 1E 2E 00
    inc    bx                                    # 1DFF: 43
    .byte 0x0B, 0xDB # 1E00
    pop    bx                                    # 1E02: 5B
...
L_1E0A:
    call   L_2DF4                                # 1E0A: E8 E7 0F
    .byte 0xD1, 0xB0, 0x80, 0xA2 # 1E0D
    cmp    WORD PTR [bp+di],ax                   # 1E11: 39 03
    or     al,BYTE PTR [bx]                      # 1E13: 0A 07
    .byte 0x8A, 0xC8 # 1E15
    jmp    L_3775                                # 1E17: E9 5B 19
L_1E1A:
...
L_1E46:
    ...
    push   dx                                    # 1E49: 52
    call   L_2DF4                                # 1E4A: E8 A7 0F
    sub    al,0xe8                               # 1E4D: 2C E8
    retf                                         # 1E4F: CB
...
FNWAIT:
    ...
    dec    bx                                    # 1E5F: 4B
    call   L_0F1D                                # 1E60: E8 BA F0
    je     L_1E6C                                # 1E63: 74 07
    call   L_2DF4                                # 1E65: E8 8C 0F
    sub    al,0xe8                               # 1E68: 2C E8
...
WIDTHS:
    ...
    call   L_1727                                # 1E8E: E8 96 F8
    call   L_1B25                                # 1E91: E8 91 FC
    ...
    jmp    L_1059                                # 1EA3: E9 B3 F1
L_1EA6:
    .byte 0x8A, 0xD0 # 1EA6
    push   dx                                    # 1EA8: 52
    call   L_2DF4                                # 1EA9: E8 48 0F
    sub    al,0xe8                               # 1EAC: 2C E8
...
L_1ECA:
    call   L_0F1D                                # 1ECA: E8 50 F0
    call   L_1F1C                                # 1ECD: E8 4C 00
    push   ax                                    # 1ED0: 50
    call   L_2DF4                                # 1ED1: E8 20 0F
    sub    al,0xe8                               # 1ED4: 2C E8
    inc    sp                                    # 1ED6: 44
    add    BYTE PTR [bx+si+0x53],bl              # 1ED7: 00 58 53
    push   dx                                    # 1EDA: 52
    call   L_3FA5                                # 1EDB: E8 C7 20
    call   L_5913                                # 1EDE: E8 32 3A
    .byte 0x0A, 0xC0 # 1EE1
    jns    L_1EE8                                # 1EE3: 79 03
    jmp    L_1059                                # 1EE5: E9 71 F1
L_1EE8:
    inc    bx                                    # 1EE8: 43
    pop    dx                                    # 1EE9: 5A
    ...
    ret                                          # 1EED: C3
L_1EEE:
    call   L_1F1F                                # 1EEE: E8 2E 00
    call   L_52AC                                # 1EF1: E8 B8 33
    mov    ds:0x29,al                            # 1EF4: A2 29 00
L_1EF7:
    ...
    inc    al                                    # 1EFF: FE C0
    .byte 0x02, 0xC2 # 1F01
    mov    ds:0x2a,al                            # 1F03: A2 2A 00
    ret                                          # 1F06: C3
L_1F07:
    call   L_0F1D                                # 1F07: E8 13 F0
L_1F0A:
    call   L_1727                                # 1F0A: E8 1A F8
L_1F0D:
    push   bx                                    # 1F0D: 53
    call   L_6BAD                                # 1F0E: E8 9C 4C
    xchg   dx,bx                                 # 1F11: 87 DA
    pop    bx                                    # 1F13: 5B
    .byte 0x8A, 0xC6, 0x0A, 0xC0 # 1F14
    ret                                          # 1F18: C3
L_1F19:
    call   L_0F1D                                # 1F19: E8 01 F0
L_1F1C:
    call   L_1727                                # 1F1C: E8 08 F8
L_1F1F:
    call   L_1F0D                                # 1F1F: E8 EB FF
    je     L_1F27                                # 1F22: 74 03
    jmp    L_1059                                # 1F24: E9 32 F1
L_1F27:
    dec    bx                                    # 1F27: 4B
    call   L_0F1D                                # 1F28: E8 F2 EF
    .byte 0x8A, 0xC2 # 1F2B
    ret                                          # 1F2D: C3
LLIST:
    call   L_14B0                                # 1F2E: E8 7F F5
    dec    bx                                    # 1F31: 4B
    call   L_0F1D                                # 1F32: E8 E8 EF
LIST:
    int    0xa2                                  # 1F35: CD A2
    pop    cx                                    # 1F37: 59
    call   L_0A2D                                # 1F38: E8 F2 EA
    push   cx                                    # 1F3B: 51
    call   L_4758                                # 1F3C: E8 19 28
    mov    bx,WORD PTR ds:0x33b                  # 1F3F: 8B 1E 3B 03
    dec    bx                                    # 1F43: 4B
    call   L_0F1D                                # 1F44: E8 D6 EF
    je     L_1F57                                # 1F47: 74 0E
    call   L_2DF4                                # 1F49: E8 A8 0E
    sub    al,0xe8                               # 1F4C: 2C E8
    ret                                          # 1F4E: C3
    .byte 0x1F, 0xB2, 0x02, 0x32, 0xC0, 0xE8, 0x96, 0x21 # 1F4F
L_1F57:
    mov    bx,0xffff                             # 1F57: BB FF FF
    mov    WORD PTR ds:0x2e,bx                   # 1F5A: 89 1E 2E 00
    call   L_2FD6                                # 1F5E: E8 75 10
    jne    L_1F68                                # 1F61: 75 05
    mov    al,0x1                                # 1F63: B0 01
    mov    ds:0x6f,al                            # 1F65: A2 6F 00
L_1F68:
    pop    bx                                    # 1F68: 5B
    pop    dx                                    # 1F69: 5A
...
L_1FCD:
    ...
    .byte 0x32, 0xC0 # 1FD2
    mov    ds:0x2fc,al                           # 1FD4: A2 FC 02
    .byte 0x32, 0xC0 # 1FD7
    mov    ds:0x45e,al                           # 1FD9: A2 5E 04
    call   L_4758                                # 1FDC: E8 79 27
...
L_20AC:
    mov    al,ds:0x2fc                           # 20AC: A0 FC 02
    or     al,0x2                                # 20AF: 0C 02
L_20B1:
    mov    ds:0x2fc,al                           # 20B1: A2 FC 02
    .byte 0x32, 0xC0 # 20B4
    ret                                          # 20B6: C3
L_20B7:
    mov    al,ds:0x2fc                           # 20B7: A0 FC 02
...
L_2123:
    ...
    mov    al,ds:0x45e                           # 212B: A0 5E 04
    .byte 0x0A, 0xC0 # 212E
    mov    al,0x0                                # 2130: B0 00
    mov    ds:0x45e,al                           # 2132: A2 5E 04
    jmp    L_214C                                # 2135: EB 15
L_2137:
    cmp    al,0x5b                               # 2137: 3C 5B
    jne    L_2142                                # 2139: 75 07
    .byte 0x32, 0xC0 # 213B
    mov    ds:0x45e,al                           # 213D: A2 5E 04
    jmp    L_215F                                # 2140: EB 1D
L_2142:
    mov    al,ds:0x45e                           # 2142: A0 5E 04
    .byte 0x0A, 0xC0 # 2145
    mov    al,0xff                               # 2147: B0 FF
    mov    ds:0x45e,al                           # 2149: A2 5E 04
L_214C:
...
L_2172:
    ...
    .byte 0x32, 0xC0 # 217A
    mov    ds:0x45e,al                           # 217C: A2 5E 04
L_217F:
    pop    bx                                    # 217F: 5B
    jmp    L_1FE7                                # 2180: E9 64 FE
L_2183:
    call   L_2F45                                # 2183: E8 BF 0D
...
L_21AE:
    mov    bx,WORD PTR ds:0x302                  # 21AE: 8B 1E 02 03
...
DELETE:
    call   L_0A2D                                # 2239: E8 F1 E7
    push   cx                                    # 223C: 51
    call   L_2435                                # 223D: E8 F5 01
    pop    cx                                    # 2240: 59
    pop    dx                                    # 2241: 5A
    push   cx                                    # 2242: 51
    push   cx                                    # 2243: 51
    call   L_0A67                                # 2244: E8 20 E8
...
L_2254:
    ...
    jmp    L_1059                                # 2256: E9 00 EE
L_2259:
    mov    bx,0x72d                              # 2259: BB 2D 07
    call   L_7B55                                # 225C: E8 F6 58
    pop    cx                                    # 225F: 59
...
L_2267:
    ...
    mov    bx,WORD PTR ds:0x358                  # 2269: 8B 1E 58 03
L_226D:
    .byte 0x8B, 0xF2 # 226D
    ...
    .byte 0x8B, 0xD9 # 2279
    mov    WORD PTR ds:0x358,bx                  # 227B: 89 1E 58 03
    ret                                          # 227F: C3
L_2280:
    call   L_22B5                                # 2280: E8 32 00
    call   L_4749                                # 2283: E8 C3 24
    push   ds                                    # 2286: 1E
    mov    ds,WORD PTR ds:0x350                  # 2287: 8E 1E 50 03
...
POKE:
    ...
    call   L_2DF4                                # 2298: E8 59 0B
L_229B:
    sub    al,0xe8                               # 229B: 2C E8
    jge    L_229B                                # 229D: 7D FC
    pop    dx                                    # 229F: 5A
    push   es                                    # 22A0: 06
    mov    es,WORD PTR ds:0x350                  # 22A1: 8E 06 50 03
    .byte 0x8B, 0xFA # 22A5
    stos   BYTE PTR es:[di],al                   # 22A7: AA
    pop    es                                    # 22A8: 07
    ret                                          # 22A9: C3
L_22AA:
    call   L_1727                                # 22AA: E8 7A F4
    push   bx                                    # 22AD: 53
...
L_22B5:
    ...
    push   cx                                    # 22B8: 51
    call   L_1B25                                # 22B9: E8 69 F8
    js     L_22B4                                # 22BC: 78 F6
    int    0xa4                                  # 22BE: CD A4
    mov    al,ds:0x4a6                           # 22C0: A0 A6 04
    cmp    al,0x90                               # 22C3: 3C 90
    jne    L_22B4                                # 22C5: 75 ED
    call   L_7B75                                # 22C7: E8 AB 58
    js     L_22B4                                # 22CA: 78 E8
    call   L_6B51                                # 22CC: E8 82 48
...
L_22F1:
    call   L_2DF4                                # 22F1: E8 00 0B
    sub    al,0xe8                               # 22F4: 2C E8
    in     eax,dx                                # 22F6: 66 ED
    je     L_2317                                # 22F8: 74 1D
    pop    ax                                    # 22FA: 58
    call   L_2DF4                                # 22FB: E8 F6 0A
    sub    al,0x52                               # 22FE: 2C 52
    call   L_106B                                # 2300: E8 68 ED
    je     L_2308                                # 2303: 74 03
    jmp    SNERR                                 # 2305: E9 B6 E4
L_2308:
    .byte 0x0B, 0xD2 # 2308
    jne    L_230F                                # 230A: 75 03
    jmp    L_1059                                # 230C: E9 4A ED
L_230F:
...
L_2317:
    push   cx                                    # 2317: 51
    call   L_0A67                                # 2318: E8 4C E7
    pop    dx                                    # 231B: 5A
    push   dx                                    # 231C: 52
    push   cx                                    # 231D: 51
    call   L_0A67                                # 231E: E8 46 E7
    .byte 0x8B, 0xD9 # 2321
    pop    dx                                    # 2323: 5A
    .byte 0x3B, 0xDA # 2324
    xchg   dx,bx                                 # 2326: 87 DA
    jae    L_232D                                # 2328: 73 03
    jmp    L_1059                                # 232A: E9 2C ED
L_232D:
    pop    dx                                    # 232D: 5A
    pop    cx                                    # 232E: 59
    pop    ax                                    # 232F: 58
...
L_2388:
    .byte 0x32, 0xC0 # 2388
    mov    ds:0x33d,al                           # 238A: A2 3D 03
    mov    bx,WORD PTR ds:0x30                   # 238D: 8B 1E 30 00
    dec    bx                                    # 2391: 4B
L_2392:
    inc    bx                                    # 2392: 43
...
L_23D7:
    push   bx                                    # 23D7: 53
    call   L_0A67                                # 23D8: E8 8C E6
    lahf                                         # 23DB: 9F
    dec    cx                                    # 23DC: 49
    sahf                                         # 23DD: 9E
    mov    al,0xd                                # 23DE: B0 0D
    jb     L_2421                                # 23E0: 72 3F
    call   L_2C5D                                # 23E2: E8 78 08
    mov    bx,0x23fc                             # 23E5: BB FC 23
    push   dx                                    # 23E8: 52
    call   L_7B55                                # 23E9: E8 69 57
    pop    bx                                    # 23EC: 5B
    call   L_6550                                # 23ED: E8 60 41
    pop    cx                                    # 23F0: 59
    pop    bx                                    # 23F1: 5B
    push   bx                                    # 23F2: 53
    push   cx                                    # 23F3: 51
...
L_2421:
    ...
    push   bx                                    # 2424: 53
    mov    bx,WORD PTR ds:0x2fe                  # 2425: 8B 1E FE 02
L_2429:
    push   bx                                    # 2429: 53
    dec    bx                                    # 242A: 4B
...
L_2434:
    ret                                          # 2434: C3
L_2435:
    mov    al,ds:0x33d                           # 2435: A0 3D 03
    .byte 0x0A, 0xC0 # 2438
    je     L_2434                                # 243A: 74 F8
    jmp    L_2388                                # 243C: E9 49 FF
OPTION:
    call   L_2DF4                                # 243F: E8 B2 09
    inc    dx                                    # 2442: 42
    call   L_2DF4                                # 2443: E8 AE 09
    inc    cx                                    # 2446: 41
    call   L_2DF4                                # 2447: E8 AA 09
    push   bx                                    # 244A: 53
    call   L_2DF4                                # 244B: E8 A6 09
    inc    bp                                    # 244E: 45
    mov    al,ds:0x45d                           # 244F: A0 5D 04
    .byte 0x0A, 0xC0 # 2452
    je     L_2459                                # 2454: 74 03
    jmp    L_07C7                                # 2456: E9 6E E3
L_2459:
    push   bx                                    # 2459: 53
    mov    bx,WORD PTR ds:0x35a                  # 245A: 8B 1E 5A 03
    xchg   dx,bx                                 # 245E: 87 DA
    mov    bx,WORD PTR ds:0x35c                  # 2460: 8B 1E 5C 03
    .byte 0x3B, 0xDA # 2464
...
L_247C:
    mov    ds:0x45c,al                           # 247C: A2 5C 04
    inc    al                                    # 247F: FE C0
    mov    ds:0x45d,al                           # 2481: A2 5D 04
    call   L_0F1D                                # 2484: E8 96 EA
L_2487:
    ret                                          # 2487: C3
L_2488:
...
RANDOM:
    ...
    call   L_1727                                # 24A0: E8 84 F2
    push   bx                                    # 24A3: 53
    call   L_6BAD                                # 24A4: E8 06 47
    jmp    L_24C9                                # 24A7: EB 20
L_24A9:
    push   bx                                    # 24A9: 53
L_24AA:
    mov    bx,0x24d2                             # 24AA: BB D2 24
    call   L_7B55                                # 24AD: E8 A5 56
...
L_24B9:
    ...
    call   L_6BAD                                # 24C6: E8 E4 46
L_24C9:
    mov    WORD PTR ds:0xc,bx                    # 24C9: 89 1E 0C 00
...
L_24F7:
    ...
    jmp    L_24FD                                # 24F9: EB 02
L_24FB:
    mov    cl,0x1a                               # 24FB: B1 1A
L_24FD:
    mov    ch,0x0                                # 24FD: B5 00
    xchg   dx,bx                                 # 24FF: 87 DA
    mov    bx,WORD PTR ds:0x2e                   # 2501: 8B 1E 2E 00
    mov    WORD PTR ds:0x45a,bx                  # 2505: 89 1E 5A 04
...
L_253B:
    ...
    inc    bx                                    # 253E: 43
    mov    WORD PTR ds:0x45a,dx                  # 253F: 89 16 5A 04
L_2543:
    call   L_0F1D                                # 2543: E8 D7 E9
...
L_255C:
    ...
    je     L_250B                                # 2566: 74 A3
    cmp    al,0xb2                               # 2568: 3C B2
    jne    L_250D                                # 256A: 75 A1
    dec    ch                                    # 256C: FE CD
    jne    L_250D                                # 256E: 75 9D
L_2570:
    ret                                          # 2570: C3
L_2571:
    cmp    al,0x82                               # 2571: 3C 82
    je     L_250B                                # 2573: 74 96
    cmp    al,0x83                               # 2575: 3C 83
    jne    L_250D                                # 2577: 75 94
    dec    ch                                    # 2579: FE CD
    je     L_2570                                # 257B: 74 F3
    call   L_0F1D                                # 257D: E8 9D E9
    je     L_252A                                # 2580: 74 A8
    xchg   dx,bx                                 # 2582: 87 DA
    mov    bx,WORD PTR ds:0x2e                   # 2584: 8B 1E 2E 00
    push   bx                                    # 2588: 53
    mov    bx,WORD PTR ds:0x45a                  # 2589: 8B 1E 5A 04
    mov    WORD PTR ds:0x2e,bx                   # 258D: 89 1E 2E 00
    xchg   dx,bx                                 # 2591: 87 DA
    push   cx                                    # 2593: 51
    call   L_376E                                # 2594: E8 D7 11
    pop    cx                                    # 2597: 59
    dec    bx                                    # 2598: 4B
    call   L_0F1D                                # 2599: E8 81 E9
    mov    dx,0x252a                             # 259C: BA 2A 25
    je     L_25A9                                # 259F: 74 08
    call   L_2DF4                                # 25A1: E8 50 08
    sub    al,0x4b                               # 25A4: 2C 4B
    mov    dx,0x2579                             # 25A6: BA 79 25
L_25A9:
    pop    si                                    # 25A9: 5E
    xchg   si,bx                                 # 25AA: 87 DE
    push   si                                    # 25AC: 56
    mov    WORD PTR ds:0x2e,bx                   # 25AD: 89 1E 2E 00
    pop    bx                                    # 25B1: 5B
    push   dx                                    # 25B2: 52
    ret                                          # 25B3: C3
...
L_263E:
    call   L_26D6                                # 263E: E8 95 00
L_2641:
    mov    bx,0x32c                              # 2641: BB 2C 03
    push   bx                                    # 2644: 53
...
L_2680:
    ...
    .byte 0x8A, 0xC1 # 2688
    call   L_2641                                # 268A: E8 B4 FF
L_268D:
    mov    dx,0x32c                              # 268D: BA 2C 03
    .byte 0xB0 # 2690
L_2691:
    .byte 0x52 # 2691
    mov    bx,WORD PTR ds:0x30c                  # 2692: 8B 1E 0C 03
    mov    WORD PTR ds:0x4a3,bx                  # 2696: 89 1E A3 04
    mov    al,0x3                                # 269A: B0 03
    mov    ds:0x2fb,al                           # 269C: A2 FB 02
    call   L_64B9                                # 269F: E8 17 3E
    mov    dx,0x32f                              # 26A2: BA 2F 03
    .byte 0x3B, 0xDA # 26A5
    mov    WORD PTR ds:0x30c,bx                  # 26A7: 89 1E 0C 03
    pop    bx                                    # 26AB: 5B
...
L_26DC:
    lahf                                         # 26DC: 9F
    push   ax                                    # 26DD: 50
    mov    bx,WORD PTR ds:0x35c                  # 26DE: 8B 1E 5C 03
    xchg   dx,bx                                 # 26E2: 87 DA
    mov    bx,WORD PTR ds:0x32f                  # 26E4: 8B 1E 2F 03
    not    al                                    # 26E8: F6 D0
    .byte 0x8A, 0xC8 # 26EA
    ...
    mov    WORD PTR ds:0x32f,bx                  # 26F5: 89 1E 2F 03
    inc    bx                                    # 26F9: 43
...
L_270E:
    ...
    push   cx                                    # 2715: 51
L_2716:
    mov    bx,WORD PTR ds:0x30a                  # 2716: 8B 1E 0A 03
L_271A:
    mov    WORD PTR ds:0x32f,bx                  # 271A: 89 1E 2F 03
    mov    bx,0x0                                # 271E: BB 00 00
    push   bx                                    # 2721: 53
    mov    bx,WORD PTR ds:0x35c                  # 2722: 8B 1E 5C 03
    push   bx                                    # 2726: 53
    mov    bx,0x30e                              # 2727: BB 0E 03
    mov    dx,WORD PTR ds:0x30c                  # 272A: 8B 16 0C 03
    .byte 0x3B, 0xDA # 272E
...
L_2738:
    ...
    mov    WORD PTR ds:0x44e,bx                  # 273B: 89 1E 4E 04
    mov    bx,WORD PTR ds:0x35a                  # 273F: 8B 1E 5A 03
    mov    WORD PTR ds:0x44b,bx                  # 2743: 89 1E 4B 04
    mov    bx,WORD PTR ds:0x358                  # 2747: 8B 1E 58 03
L_274B:
    mov    dx,WORD PTR ds:0x44b                  # 274B: 8B 16 4B 04
    .byte 0x3B, 0xDA # 274F
...
L_276E:
    mov    bx,WORD PTR ds:0x44e                  # 276E: 8B 1E 4E 04
    mov    dx,WORD PTR [bx]                      # 2772: 8B 17
    .byte 0x0B, 0xD2 # 2774
    mov    bx,WORD PTR ds:0x35a                  # 2776: 8B 1E 5A 03
    je     L_2795                                # 277A: 74 19
    xchg   dx,bx                                 # 277C: 87 DA
    mov    WORD PTR ds:0x44e,bx                  # 277E: 89 1E 4E 04
    inc    bx                                    # 2782: 43
    inc    bx                                    # 2783: 43
    ...
    .byte 0x03, 0xDA # 278A
    mov    WORD PTR ds:0x44b,bx                  # 278C: 89 1E 4B 04
    xchg   dx,bx                                 # 2790: 87 DA
    jmp    L_274B                                # 2792: EB B7
L_2794:
    pop    cx                                    # 2794: 59
L_2795:
    mov    dx,WORD PTR ds:0x35c                  # 2795: 8B 16 5C 03
    .byte 0x3B, 0xDA # 2799
...
L_27A0:
    ...
    mov    WORD PTR ds:0x333,bx                  # 27B7: 89 1E 33 03
    pop    bx                                    # 27BB: 5B
    ...
    mov    bx,WORD PTR ds:0x333                  # 27C7: 8B 1E 33 03
...
L_27E9:
    .byte 0x8B, 0xCB # 27E9
    mov    bx,WORD PTR ds:0x32f                  # 27EB: 8B 1E 2F 03
...
L_280C:
    ...
    dec    bx                                    # 2824: 4B
    .byte 0x8B, 0xCB # 2825
    mov    bx,WORD PTR ds:0x32f                  # 2827: 8B 1E 2F 03
    ...
    .byte 0x8B, 0xD9 # 2834
    dec    bx                                    # 2836: 4B
    jmp    L_271A                                # 2837: E9 E0 FE
L_283A:
    push   cx                                    # 283A: 51
    push   bx                                    # 283B: 53
    mov    bx,WORD PTR ds:0x4a3                  # 283C: 8B 1E A3 04
    pop    si                                    # 2840: 5E
    xchg   si,bx                                 # 2841: 87 DE
    push   si                                    # 2843: 56
    call   L_18E7                                # 2844: E8 A0 F0
    pop    si                                    # 2847: 5E
    ...
    push   bx                                    # 2850: 53
    mov    bx,WORD PTR ds:0x4a3                  # 2851: 8B 1E A3 04
    push   bx                                    # 2855: 53
...
L_2860:
    ...
    push   bx                                    # 286E: 53
    mov    bx,WORD PTR ds:0x32d                  # 286F: 8B 1E 2D 03
...
L_28A9:
    mov    bx,WORD PTR ds:0x4a3                  # 28A9: 8B 1E A3 04
L_28AD:
...
L_28AF:
    ...
    mov    bx,WORD PTR ds:0x32f                  # 28BE: 8B 1E 2F 03
    .byte 0x3B, 0xDA # 28C2
    jne    L_28D0                                # 28C4: 75 0A
    .byte 0x32, 0xC0, 0x8A, 0xE8, 0x03, 0xD9 # 28C6
    mov    WORD PTR ds:0x32f,bx                  # 28CC: 89 1E 2F 03
L_28D0:
    pop    bx                                    # 28D0: 5B
L_28D1:
    ret                                          # 28D1: C3
L_28D2:
    int    0xee                                  # 28D2: CD EE
    mov    bx,WORD PTR ds:0x30c                  # 28D4: 8B 1E 0C 03
    dec    bx                                    # 28D8: 4B
    ...
    mov    WORD PTR ds:0x30c,bx                  # 28E3: 89 1E 0C 03
    ret                                          # 28E7: C3
TOKH_POINT:
...
L_2904:
    ...
    ret                                          # 290A: C3
L_290B:
    call   L_263C                                # 290B: E8 2E FD
    call   L_1F1F                                # 290E: E8 0E F6
L_2911:
    mov    bx,WORD PTR ds:0x32d                  # 2911: 8B 1E 2D 03
    mov    BYTE PTR [bx],dl                      # 2915: 88 17
L_2917:
    pop    cx                                    # 2917: 59
    jmp    L_268D                                # 2918: E9 72 FD
L_291B:
    call   L_0F1D                                # 291B: E8 FF E5
    call   L_2DF4                                # 291E: E8 D3 04
    sub    al,ch                                 # 2921: 28 E8
    div    bp                                    # 2923: F7 F5
    push   dx                                    # 2925: 52
    call   L_2DF4                                # 2926: E8 CB 04
    sub    al,0xe8                               # 2929: 2C E8
    cli                                          # 292B: FA
    in     ax,dx                                 # 292C: ED
    call   L_2DF4                                # 292D: E8 C4 04
    sub    WORD PTR [bp-0x79],bx                 # 2930: 29 5E 87
    ficom  WORD PTR [bp+0x53]                    # 2933: DE 56 53
    call   L_1B25                                # 2936: E8 EC F1
    je     L_2940                                # 2939: 74 05
    call   L_1F1F                                # 293B: E8 E1 F5
...
L_2947:
    call   L_1F1F                                # 2947: E8 D5 F5
    mov    al,0x20                               # 294A: B0 20
L_294C:
    push   ax                                    # 294C: 50
    .byte 0x8A, 0xC2 # 294D
    call   L_263E                                # 294F: E8 EC FC
    .byte 0x8A, 0xE8 # 2952
    pop    ax                                    # 2954: 58
    inc    ch                                    # 2955: FE C5
    dec    ch                                    # 2957: FE CD
    je     L_2917                                # 2959: 74 BC
    mov    bx,WORD PTR ds:0x32d                  # 295B: 8B 1E 2D 03
L_295F:
...
L_2A19:
    ret                                          # 2A19: C3
L_2A1A:
    call   L_0F1D                                # 2A1A: E8 00 E5
    call   L_1723                                # 2A1D: E8 03 ED
    call   L_1B25                                # 2A20: E8 02 F1
    mov    al,0x1                                # 2A23: B0 01
    push   ax                                    # 2A25: 50
    je     L_2A3E                                # 2A26: 74 16
    pop    ax                                    # 2A28: 58
    call   L_1F1F                                # 2A29: E8 F3 F4
    .byte 0x0A, 0xC0 # 2A2C
    jne    L_2A33                                # 2A2E: 75 03
    jmp    L_1059                                # 2A30: E9 26 E6
L_2A33:
    push   ax                                    # 2A33: 50
    call   L_2DF4                                # 2A34: E8 BD 03
    sub    al,0xe8                               # 2A37: 2C E8
    in     al,dx                                 # 2A39: EC
    in     al,dx                                 # 2A3A: EC
    call   L_643B                                # 2A3B: E8 FD 39
L_2A3E:
    call   L_2DF4                                # 2A3E: E8 B3 03
    sub    al,0x53                               # 2A41: 2C 53
    mov    bx,WORD PTR ds:0x4a3                  # 2A43: 8B 1E A3 04
    pop    si                                    # 2A47: 5E
    xchg   si,bx                                 # 2A48: 87 DE
    push   si                                    # 2A4A: 56
    call   L_1727                                # 2A4B: E8 D9 EC
    call   L_2DF4                                # 2A4E: E8 A3 03
    sub    WORD PTR [bp+di-0x18],dx              # 2A51: 29 53 E8
    push   ax                                    # 2A54: 50
...
L_2AD0:
    call   L_2DF4                                # 2AD0: E8 21 03
    sub    al,ch                                 # 2AD3: 28 E8
    xchg   di,ax                                 # 2AD5: 97
    ...
    mov    bx,WORD PTR ds:0x35c                  # 2AE1: 8B 1E 5C 03
    .byte 0x3B, 0xDA # 2AE5
    jb     L_2AFB                                # 2AE7: 72 12
    mov    bx,WORD PTR ds:0x30                   # 2AE9: 8B 1E 30 00
    .byte 0x3B, 0xDA # 2AED
...
L_2AFB:
    ...
    push   si                                    # 2AFF: 56
    call   L_2DF4                                # 2B00: E8 F1 02
    sub    al,0xe8                               # 2B03: 2C E8
...
L_2B7A:
    ...
    call   L_2DF4                                # 2B80: E8 71 02
    sub    al,0xe8                               # 2B83: 2C E8
    xchg   bp,ax                                 # 2B85: 95
    .byte 0xF3 # 2B86
L_2B87:
    .byte 0xE8, 0x6A, 0x02 # 2B87
    sub    bx,ax                                 # 2B8A: 29 C3
L_2B8C:
    call   L_1B25                                # 2B8C: E8 96 EF
    je     L_2B94                                # 2B8F: 74 03
    .byte 0xE9, 0x06, 0x00 # 2B91
L_2B94:
    call   L_28A9                                # 2B94: E8 12 FD
    call   L_2716                                # 2B97: E8 7C FB
L_2B9A:
    mov    dx,WORD PTR ds:0x35c                  # 2B9A: 8B 16 5C 03
    mov    bx,WORD PTR ds:0x32f                  # 2B9E: 8B 1E 2F 03
...
L_2BD6:
    ...
    call   L_2BA5                                # 2BD8: E8 CA FF
    call   L_4F2C                                # 2BDB: E8 4E 23
...
L_2BE6:
    ...
    mov    al,ds:0x29                            # 2BEA: A0 29 00
    .byte 0x8A, 0xE8 # 2BED
    call   L_4F2C                                # 2BEF: E8 3A 23
    inc    ch                                    # 2BF2: FE C5
    je     L_2C01                                # 2BF4: 74 0B
    dec    ch                                    # 2BF6: FE CD
    .byte 0x3A, 0xC5 # 2BF8
    jne    L_2BFF                                # 2BFA: 75 03
    call   L_2C71                                # 2BFC: E8 72 00
L_2BFF:
...
L_2C15:
    ...
    push   dx                                    # 2C22: 52
    push   bx                                    # 2C23: 53
    mov    al,ds:0x536                           # 2C24: A0 36 05
    and    al,0xc8                               # 2C27: 24 C8
    mov    ds:0x536,al                           # 2C29: A2 36 05
    call   L_44FB                                # 2C2C: E8 CC 18
    pop    bx                                    # 2C2F: 5B
    pop    dx                                    # 2C30: 5A
    pop    cx                                    # 2C31: 59
    mov    al,ds:0x46b                           # 2C32: A0 6B 04
    .byte 0x0A, 0xC0 # 2C35
    je     L_2C3C                                # 2C37: 74 03
    jmp    L_5D46                                # 2C39: E9 0A 31
L_2C3C:
    mov    al,ds:0x4ef                           # 2C3C: A0 EF 04
    .byte 0x0A, 0xC0 # 2C3F
    je     L_2C4A                                # 2C41: 74 07
    mov    bx,0xee8                              # 2C43: BB E8 0E
    push   bx                                    # 2C46: 53
    jmp    L_2D37                                # 2C47: E9 ED 00
L_2C4A:
    push   bx                                    # 2C4A: 53
    push   cx                                    # 2C4B: 51
    push   dx                                    # 2C4C: 52
    mov    bx,0x72d                              # 2C4D: BB 2D 07
    call   L_7B55                                # 2C50: E8 02 4F
    pop    dx                                    # 2C53: 5A
    pop    cx                                    # 2C54: 59
...
L_2C9D:
    ...
    call   L_263E                                # 2CB0: E8 8B F9
    mov    bx,WORD PTR ds:0x32d                  # 2CB3: 8B 1E 2D 03
    pop    dx                                    # 2CB7: 5A
    mov    WORD PTR [bx],dx                      # 2CB8: 89 17
    jmp    L_268D                                # 2CBA: E9 D0 F9
L_2CBD:
    push   ax                                    # 2CBD: 50
    call   L_263C                                # 2CBE: E8 7B F9
    pop    ax                                    # 2CC1: 58
    .byte 0x8A, 0xD0 # 2CC2
    call   L_2911                                # 2CC4: E8 4A FC
L_2CC7:
    mov    bx,0x6                                # 2CC7: BB 06 00
    mov    WORD PTR ds:0x4a3,bx                  # 2CCA: 89 1E A3 04
    mov    al,0x3                                # 2CCE: B0 03
    mov    ds:0x2fb,al                           # 2CD0: A2 FB 02
    pop    bx                                    # 2CD3: 5B
    ret                                          # 2CD4: C3
L_2CD5:
    push   bx                                    # 2CD5: 53
    mov    bx,WORD PTR ds:0x30a                  # 2CD6: 8B 1E 0A 03
...
L_2CF3:
    ret                                          # 2CF3: C3
L_2CF4:
    mov    bx,WORD PTR ds:0x2c                   # 2CF4: 8B 1E 2C 00
    dec    bx                                    # 2CF8: 4B
    dec    bx                                    # 2CF9: 4B
    mov    WORD PTR ds:0x345,bx                  # 2CFA: 89 1E 45 03
L_2CFE:
    mov    dx,0x7                                # 2CFE: BA 07 00
    jmp    L_07D8                                # 2D01: E9 D4 DA
L_2D04:
    cmp    WORD PTR ds:0x32f,bx                  # 2D04: 39 1E 2F 03
    jae    L_2CF3                                # 2D08: 73 E9
    push   cx                                    # 2D0A: 51
    push   dx                                    # 2D0B: 52
    push   bx                                    # 2D0C: 53
    call   L_2716                                # 2D0D: E8 06 FA
    pop    bx                                    # 2D10: 5B
    pop    dx                                    # 2D11: 5A
    pop    cx                                    # 2D12: 59
    cmp    WORD PTR ds:0x32f,bx                  # 2D13: 39 1E 2F 03
    jae    L_2CF3                                # 2D17: 73 DA
    jmp    L_2CFE                                # 2D19: EB E3
SCRATH:
    jne    L_2CF3                                # 2D1B: 75 D6
L_2D1D:
    mov    bx,WORD PTR ds:0x30                   # 2D1D: 8B 1E 30 00
    call   TOFF                                  # 2D21: E8 79 01
    mov    ds:0x464,al                           # 2D24: A2 64 04
    mov    ds:0x33e,al                           # 2D27: A2 3E 03
    mov    ds:0x33d,al                           # 2D2A: A2 3D 03
    mov    BYTE PTR [bx],al                      # 2D2D: 88 07
    inc    bx                                    # 2D2F: 43
    mov    BYTE PTR [bx],al                      # 2D30: 88 07
    inc    bx                                    # 2D32: 43
    mov    WORD PTR ds:0x358,bx                  # 2D33: 89 1E 58 03
L_2D37:
    int    0xae                                  # 2D37: CD AE
    mov    bx,WORD PTR ds:0x30                   # 2D39: 8B 1E 30 00
    dec    bx                                    # 2D3D: 4B
L_2D3E:
    int    0xaf                                  # 2D3E: CD AF
    mov    WORD PTR ds:0x33b,bx                  # 2D40: 89 1E 3B 03
    mov    al,ds:0x465                           # 2D44: A0 65 04
    .byte 0x0A, 0xC0 # 2D47
    jne    L_2D62                                # 2D49: 75 17
    .byte 0x32, 0xC0 # 2D4B
    mov    ds:0x45d,al                           # 2D4D: A2 5D 04
    mov    ds:0x45c,al                           # 2D50: A2 5C 04
...
L_2D62:
    ...
    .byte 0x32, 0xC0 # 2D6B
    mov    ds:0x34f,al                           # 2D6D: A2 4F 03
    .byte 0x8A, 0xD8, 0x8A, 0xF8 # 2D70
    mov    WORD PTR ds:0x34d,bx                  # 2D74: 89 1E 4D 03
    mov    WORD PTR ds:0x356,bx                  # 2D78: 89 1E 56 03
    mov    bx,WORD PTR ds:0x30a                  # 2D7C: 8B 1E 0A 03
    mov    al,ds:0x46b                           # 2D80: A0 6B 04
    .byte 0x0A, 0xC0 # 2D83
    jne    L_2D8B                                # 2D85: 75 04
    mov    WORD PTR ds:0x32f,bx                  # 2D87: 89 1E 2F 03
L_2D8B:
    .byte 0x32, 0xC0 # 2D8B
    call   RESTORE                               # 2D8D: E8 7C 00
    mov    bx,WORD PTR ds:0x358                  # 2D90: 8B 1E 58 03
    mov    WORD PTR ds:0x35a,bx                  # 2D94: 89 1E 5A 03
    mov    WORD PTR ds:0x35c,bx                  # 2D98: 89 1E 5C 03
    mov    al,ds:0x465                           # 2D9C: A0 65 04
    .byte 0x0A, 0xC0 # 2D9F
    jne    L_2DA6                                # 2DA1: 75 03
    call   L_435A                                # 2DA3: E8 B4 15
L_2DA6:
    mov    al,ds:0x536                           # 2DA6: A0 36 05
    and    al,0x1                                # 2DA9: 24 01
    jne    L_2DB0                                # 2DAB: 75 03
    mov    ds:0x536,al                           # 2DAD: A2 36 05
L_2DB0:
    pop    cx                                    # 2DB0: 59
    mov    bx,WORD PTR ds:0x2c                   # 2DB1: 8B 1E 2C 00
    dec    bx                                    # 2DB5: 4B
    dec    bx                                    # 2DB6: 4B
    mov    WORD PTR ds:0x345,bx                  # 2DB7: 89 1E 45 03
    inc    bx                                    # 2DBB: 43
    inc    bx                                    # 2DBC: 43
L_2DBD:
    int    0xb1                                  # 2DBD: CD B1
    .byte 0x8B, 0xE3 # 2DBF
    mov    bx,0x30e                              # 2DC1: BB 0E 03
    mov    WORD PTR ds:0x30c,bx                  # 2DC4: 89 1E 0C 03
    call   L_25BE                                # 2DC8: E8 F3 F7
    call   L_1498                                # 2DCB: E8 CA E6
    .byte 0x32, 0xC0, 0x8A, 0xF8, 0x8A, 0xD8 # 2DCE
    mov    WORD PTR ds:0x37c,bx                  # 2DD4: 89 1E 7C 03
    mov    ds:0x44d,al                           # 2DD8: A2 4D 04
    mov    WORD PTR ds:0x3e4,bx                  # 2DDB: 89 1E E4 03
    mov    WORD PTR ds:0x450,bx                  # 2DDF: 89 1E 50 04
    mov    WORD PTR ds:0x37a,bx                  # 2DE3: 89 1E 7A 03
    mov    ds:0x339,al                           # 2DE7: A2 39 03
    push   bx                                    # 2DEA: 53
    push   cx                                    # 2DEB: 51
    mov    bx,WORD PTR ds:0x33b                  # 2DEC: 8B 1E 3B 03
    ret                                          # 2DF0: C3
...
L_2DF4:
    ...
    push   si                                    # 2DFA: 56
    .byte 0x8B, 0xDF # 2DFB
    jne    L_2E09                                # 2DFD: 75 0A
    mov    al,BYTE PTR [bx]                      # 2DFF: 8A 07
    cmp    al,0x3a                               # 2E01: 3C 3A
    jb     L_2E06                                # 2E03: 72 01
    ret                                          # 2E05: C3
L_2E06:
    jmp    L_0F25                                # 2E06: E9 1C E1
L_2E09:
    jmp    SNERR                                 # 2E09: E9 B2 D9
RESTORE:
    xchg   dx,bx                                 # 2E0C: 87 DA
    mov    bx,WORD PTR ds:0x30                   # 2E0E: 8B 1E 30 00
    je     L_2E25                                # 2E12: 74 11
    xchg   dx,bx                                 # 2E14: 87 DA
    call   L_106B                                # 2E16: E8 52 E2
    push   bx                                    # 2E19: 53
    call   L_0A67                                # 2E1A: E8 4A DC
    .byte 0x8B, 0xD9 # 2E1D
    pop    dx                                    # 2E1F: 5A
...
L_2E25:
    dec    bx                                    # 2E25: 4B
    mov    WORD PTR ds:0x35e,bx                  # 2E26: 89 1E 5E 03
...
L_2E3B:
    popf                                         # 2E3B: 9D
L_2E3C:
    mov    WORD PTR ds:0x343,bx                  # 2E3C: 89 1E 43 03
    mov    bx,0x30e                              # 2E40: BB 0E 03
    mov    WORD PTR ds:0x30c,bx                  # 2E43: 89 1E 0C 03
    .byte 0xBB # 2E47
L_2E48:
    .byte 0x0C, 0xFF # 2E48
    pop    cx                                    # 2E4A: 59
L_2E4B:
    mov    bx,WORD PTR ds:0x2e                   # 2E4B: 8B 1E 2E 00
    push   bx                                    # 2E4F: 53
    pushf                                        # 2E50: 9C
    .byte 0x8A, 0xC3, 0x22, 0xC7 # 2E51
    inc    al                                    # 2E55: FE C0
    je     L_2E65                                # 2E57: 74 0C
    mov    WORD PTR ds:0x354,bx                  # 2E59: 89 1E 54 03
    mov    bx,WORD PTR ds:0x343                  # 2E5D: 8B 1E 43 03
    mov    WORD PTR ds:0x356,bx                  # 2E61: 89 1E 56 03
L_2E65:
    call   L_2C5D                                # 2E65: E8 F5 FD
    popf                                         # 2E68: 9D
    mov    bx,0x732                              # 2E69: BB 32 07
    je     L_2E71                                # 2E6C: 74 03
    jmp    L_0885                                # 2E6E: E9 14 DA
L_2E71:
    jmp    L_08B5                                # 2E71: E9 41 DA
    .byte 0xB0, 0x0F # 2E74
L_2E76:
    push   ax                                    # 2E76: 50
    mov    al,0x5e                               # 2E77: B0 5E
    call   L_2BA5                                # 2E79: E8 29 FD
    pop    ax                                    # 2E7C: 58
    add    al,0x40                               # 2E7D: 04 40
    call   L_2BA5                                # 2E7F: E8 23 FD
    jmp    L_2C71                                # 2E82: E9 EC FD
CONT:
    mov    bx,WORD PTR ds:0x356                  # 2E85: 8B 1E 56 03
    .byte 0x0B, 0xDB # 2E89
    mov    dx,0x11                               # 2E8B: BA 11 00
    jne    L_2E93                                # 2E8E: 75 03
    jmp    L_07D8                                # 2E90: E9 45 D9
L_2E93:
    mov    dx,WORD PTR ds:0x354                  # 2E93: 8B 16 54 03
    mov    WORD PTR ds:0x2e,dx                   # 2E97: 89 16 2E 00
    ret                                          # 2E9B: C3
TON:
    .byte 0xB8 # 2E9C
TOFF:
    .byte 0x32, 0xC0 # 2E9D
    mov    ds:0x476,al                           # 2E9F: A2 76 04
    ret                                          # 2EA2: C3
SWAP:
    call   L_376E                                # 2EA3: E8 C8 08
    push   dx                                    # 2EA6: 52
    push   bx                                    # 2EA7: 53
    mov    bx,0x46e                              # 2EA8: BB 6E 04
    call   L_64B9                                # 2EAB: E8 0B 36
    mov    bx,WORD PTR ds:0x35a                  # 2EAE: 8B 1E 5A 03
    pop    si                                    # 2EB2: 5E
    xchg   si,bx                                 # 2EB3: 87 DE
    push   si                                    # 2EB5: 56
    call   L_1B25                                # 2EB6: E8 6C EC
    push   ax                                    # 2EB9: 50
    call   L_2DF4                                # 2EBA: E8 37 FF
    sub    al,0xe8                               # 2EBD: 2C E8
...
L_2ECE:
    ...
    push   bx                                    # 2ED4: 53
    mov    bx,WORD PTR ds:0x35a                  # 2ED5: 8B 1E 5A 03
    .byte 0x3B, 0xDA # 2ED9
...
L_2EEF:
    ret                                          # 2EEF: C3
L_2EF0:
    jmp    L_1059                                # 2EF0: E9 66 E1
ERASE:
    mov    al,0x1                                # 2EF3: B0 01
    mov    ds:0x339,al                           # 2EF5: A2 39 03
    call   L_376E                                # 2EF8: E8 73 08
    jne    L_2EF0                                # 2EFB: 75 F3
    push   bx                                    # 2EFD: 53
    mov    ds:0x339,al                           # 2EFE: A2 39 03
...
L_2F08:
    ...
    mov    bx,WORD PTR ds:0x35c                  # 2F16: 8B 1E 5C 03
L_2F1A:
...
CLEAR:
    ...
    dec    bx                                    # 2F59: 4B
    call   L_0F1D                                # 2F5A: E8 C0 DF
    je     L_2F4D                                # 2F5D: 74 EE
L_2F5F:
    call   L_2DF4                                # 2F5F: E8 92 FE
    sub    al,0x74                               # 2F62: 2C 74
...
L_2F70:
    dec    bx                                    # 2F70: 4B
    call   L_0F1D                                # 2F71: E8 A9 DF
    push   dx                                    # 2F74: 52
    je     L_2FC5                                # 2F75: 74 4E
    call   L_2DF4                                # 2F77: E8 7A FE
    sub    al,0x74                               # 2F7A: 2C 74
    dec    ax                                    # 2F7C: 48
    call   L_2FB7                                # 2F7D: E8 37 00
    dec    bx                                    # 2F80: 4B
    call   L_0F1D                                # 2F81: E8 99 DF
...
L_2F89:
    ...
    push   bx                                    # 2F9B: 53
    mov    bx,WORD PTR ds:0x358                  # 2F9C: 8B 1E 58 03
    mov    cx,0x14                               # 2FA0: B9 14 00
    .byte 0x03, 0xD9, 0x3B, 0xDA # 2FA3
    jae    L_2FC2                                # 2FA7: 73 19
    xchg   dx,bx                                 # 2FA9: 87 DA
    mov    WORD PTR ds:0x30a,bx                  # 2FAB: 89 1E 0A 03
    pop    bx                                    # 2FAF: 5B
    mov    WORD PTR ds:0x2c,bx                   # 2FB0: 89 1E 2C 00
    pop    bx                                    # 2FB4: 5B
...
L_2FB7:
    ...
    jmp    L_1059                                # 2FBE: E9 98 E0
L_2FC1:
    ret                                          # 2FC1: C3
L_2FC2:
    jmp    L_2CF4                                # 2FC2: E9 2F FD
L_2FC5:
    mov    dx,WORD PTR ds:0x2c                   # 2FC5: 8B 16 2C 00
    sub    dx,WORD PTR ds:0x30a                  # 2FC9: 2B 16 0A 03
...
L_2FD6:
    int    0xb2                                  # 2FD6: CD B2
    push   bx                                    # 2FD8: 53
    mov    bx,WORD PTR ds:0x4e9                  # 2FD9: 8B 1E E9 04
    .byte 0x0B, 0xDB # 2FDD
    pop    bx                                    # 2FDF: 5B
    ret                                          # 2FE0: C3
...
L_2FF1:
    mov    bx,WORD PTR ds:0x56                   # 2FF1: 8B 1E 56 00
...
L_3042:
    mov    al,ds:0x29                            # 3042: A0 29 00
    .byte 0x3A, 0xC7 # 3045
    je     L_301A                                # 3047: 74 D1
    inc    bh                                    # 3049: FE C7
    jmp    L_4F20                                # 304B: E9 D2 1E
L_304E:
    mov    bx,WORD PTR ds:0x5b                   # 304E: 8B 1E 5B 00
    mov    bh,0x1                                # 3052: B7 01
    mov    WORD PTR ds:0x58,bx                   # 3054: 89 1E 58 00
...
L_3076:
    mov    al,ds:0x5b                            # 3076: A0 5B 00
    .byte 0x8A, 0xF8 # 3079
    mov    al,ds:0x5c                            # 307B: A0 5C 00
    .byte 0x8A, 0xD8, 0x2A, 0xC7 # 307E
    jb     L_301A                                # 3082: 72 96
    inc    al                                    # 3084: FE C0
    push   ax                                    # 3086: 50
    call   L_3123                                # 3087: E8 99 00
    mov    al,ds:0x58                            # 308A: A0 58 00
    inc    bl                                    # 308D: FE C3
    .byte 0x3A, 0xC3 # 308F
    dec    bl                                    # 3091: FE CB
...
L_30AD:
    ret                                          # 30AD: C3
L_30AE:
    mov    al,ds:0x5b                            # 30AE: A0 5B 00
    .byte 0x8A, 0xD8 # 30B1
    mov    al,ds:0x5c                            # 30B3: A0 5C 00
    .byte 0x8A, 0xF8, 0x2A, 0xC3 # 30B6
    jb     L_30AD                                # 30BA: 72 F1
    inc    al                                    # 30BC: FE C0
    push   ax                                    # 30BE: 50
    call   L_3141                                # 30BF: E8 7F 00
    mov    al,ds:0x58                            # 30C2: A0 58 00
    .byte 0x3A, 0xC3 # 30C5
...
L_30E1:
    mov    bx,WORD PTR ds:0x5b                   # 30E1: 8B 1E 5B 00
    mov    al,ds:0x5d                            # 30E5: A0 5D 00
...
L_310B:
    ...
    pop    ax                                    # 3114: 58
    .byte 0x32, 0xC0 # 3115
    mov    ds:0x58,al                            # 3117: A2 58 00
    mov    ds:0x59,al                            # 311A: A2 59 00
    mov    ds:0x5a,al                            # 311D: A2 5A 00
...
L_3180:
    ...
    mov    bx,WORD PTR ds:0x56                   # 3185: 8B 1E 56 00
    mov    WORD PTR ds:0x58,bx                   # 3189: 89 1E 58 00
    mov    al,ds:0x29                            # 318D: A0 29 00
    inc    al                                    # 3190: FE C0
    jmp    L_31B2                                # 3192: EB 1E
L_3194:
    mov    al,0x3f                               # 3194: B0 3F
    call   L_2BA5                                # 3196: E8 0C FA
    mov    al,0x20                               # 3199: B0 20
    call   L_2BA5                                # 319B: E8 07 FA
    .byte 0x32, 0xC0 # 319E
    mov    ds:0x27,al                            # 31A0: A2 27 00
    int    0xa7                                  # 31A3: CD A7
    call   L_32C6                                # 31A5: E8 1E 01
    mov    bx,WORD PTR ds:0x56                   # 31A8: 8B 1E 56 00
    mov    WORD PTR ds:0x58,bx                   # 31AC: 89 1E 58 00
    .byte 0x8A, 0xC7 # 31B0
L_31B2:
    mov    ds:0x5a,al                            # 31B2: A2 5A 00
...
L_31D7:
    push   ax                                    # 31D7: 50
    mov    bx,WORD PTR ds:0x56                   # 31D8: 8B 1E 56 00
    mov    ah,BYTE PTR ds:0x29                   # 31DC: 8A 26 29 00
    inc    ah                                    # 31E0: FE C4
    cmp    bl,BYTE PTR ds:0x58                   # 31E2: 3A 1E 58 00
    jne    L_31FA                                # 31E6: 75 12
    cmp    bh,BYTE PTR ds:0x59                   # 31E8: 3A 3E 59 00
    jae    L_31F2                                # 31EC: 73 04
    mov    BYTE PTR ds:0x59,bh                   # 31EE: 88 3E 59 00
L_31F2:
    cmp    bh,BYTE PTR ds:0x5a                   # 31F2: 3A 3E 5A 00
    jbe    L_31FE                                # 31F6: 76 06
    .byte 0x8A, 0xE7 # 31F8
L_31FA:
    mov    BYTE PTR ds:0x5a,ah                   # 31FA: 88 26 5A 00
L_31FE:
    pop    ax                                    # 31FE: 58
...
L_3252:
    ...
    pop    ax                                    # 326B: 58
    push   dx                                    # 326C: 52
    mov    bx,WORD PTR ds:0x56                   # 326D: 8B 1E 56 00
    ret                                          # 3271: C3
L_3272:
    .byte 0x0A, 0xC0 # 3272
    ret                                          # 3274: C3
...
L_340C:
    push   bx                                    # 340C: 53
    mov    bx,WORD PTR ds:0x56                   # 340D: 8B 1E 56 00
    push   ax                                    # 3411: 50
    mov    al,ds:0x72                            # 3412: A0 72 00
    .byte 0x0A, 0xC0 # 3415
...
L_3450:
    ...
    .byte 0xC3, 0xEB, 0xE2, 0xC6, 0x06, 0x70, 0x00, 0x00, 0xEB, 0x08, 0xE8, 0xE5 # 3522
    ...
    .byte 0x74, 0x04, 0xEB, 0xF1, 0x32, 0xC0, 0xC3, 0x32, 0xC0, 0xA2, 0x70, 0x00 # 3546
...
L_3633:
    push   bx                                    # 3633: 53
    mov    al,ds:0x5c                            # 3634: A0 5C 00
    .byte 0x2A, 0xC3 # 3637
    jb     L_366A                                # 3639: 72 2F
    je     L_365F                                # 363B: 74 22
    mov    bx,WORD PTR ds:0x5b                   # 363D: 8B 1E 5B 00
    pop    si                                    # 3641: 5E
    xchg   si,bx                                 # 3642: 87 DE
    push   si                                    # 3644: 56
    push   bx                                    # 3645: 53
    .byte 0x8A, 0xC3 # 3646
    mov    ds:0x5b,al                            # 3648: A2 5B 00
    mov    al,ds:0x5d                            # 364B: A0 5D 00
    mov    ds:0x5c,al                            # 364E: A2 5C 00
    call   L_30AE                                # 3651: E8 5A FA
    pop    bx                                    # 3654: 5B
    pop    si                                    # 3655: 5E
    xchg   si,bx                                 # 3656: 87 DE
    push   si                                    # 3658: 56
    mov    WORD PTR ds:0x5b,bx                   # 3659: 89 1E 5B 00
    pop    bx                                    # 365D: 5B
    push   bx                                    # 365E: 53
L_365F:
...
L_366A:
    mov    bx,WORD PTR ds:0x56                   # 366A: 8B 1E 56 00
    dec    bl                                    # 366E: FE CB
...
L_36C1:
    mov    ds:0x28,al                            # 36C1: A2 28 00
    mov    bx,WORD PTR ds:0x347                  # 36C4: 8B 1E 47 03
...
L_36D4:
    ...
    pushf                                        # 36DA: 9C
    inc    bx                                    # 36DB: 43
    jmp    L_0954                                # 36DC: E9 75 D2
EDIT:
    call   L_105E                                # 36DF: E8 7C D9
    je     L_36E7                                # 36E2: 74 03
    jmp    L_1059                                # 36E4: E9 72 D9
L_36E7:
    pop    bx                                    # 36E7: 5B
    mov    WORD PTR ds:0x349,dx                  # 36E8: 89 16 49 03
    call   L_0A67                                # 36EC: E8 78 D3
...
L_372B:
    ...
    jmp    L_08D3                                # 3730: E9 A0 D1
L_3733:
    cmp    al,0xa                                # 3733: 3C 0A
    je     L_373A                                # 3735: 74 03
    jmp    L_2BA5                                # 3737: E9 6B F4
L_373A:
    push   bx                                    # 373A: 53
    mov    bx,WORD PTR ds:0x4e9                  # 373B: 8B 1E E9 04
    ...
    call   L_2BA5                                # 374B: E8 57 F4
    pop    ax                                    # 374E: 58
    ret                                          # 374F: C3
L_3750:
    call   L_2BA5                                # 3750: E8 52 F4
    mov    al,0xd                                # 3753: B0 0D
    call   L_2BA5                                # 3755: E8 4D F4
    mov    al,0xa                                # 3758: B0 0A
    ret                                          # 375A: C3
    .byte 0x4B, 0xE8, 0xBE, 0xD7, 0x75, 0x01 # 375B
L_3761:
    ret                                          # 3761: C3
    .byte 0xE8, 0x8F, 0xF6, 0x2C # 3762
DIM:
    mov    cx,0x375b                             # 3766: B9 5B 37
    push   cx                                    # 3769: 51
    mov    al,0xc8                               # 376A: B0 C8
    jmp    L_3770                                # 376C: EB 02
L_376E:
    .byte 0x32, 0xC0 # 376E
L_3770:
    mov    ds:0x2fa,al                           # 3770: A2 FA 02
    mov    cl,BYTE PTR [bx]                      # 3773: 8A 0F
L_3775:
    int    0xb3                                  # 3775: CD B3
    call   L_2F43                                # 3777: E8 C9 F7
    jae    L_377F                                # 377A: 73 03
    jmp    SNERR                                 # 377C: E9 3F D0
L_377F:
    .byte 0x32, 0xC0, 0x8A, 0xE8 # 377F
    mov    ds:0x8e,al                            # 3783: A2 8E 00
    inc    bx                                    # 3786: 43
    mov    al,BYTE PTR [bx]                      # 3787: 8A 07
    cmp    al,0x2e                               # 3789: 3C 2E
    jb     L_37CF                                # 378B: 72 42
    je     L_379C                                # 378D: 74 0D
    cmp    al,0x3a                               # 378F: 3C 3A
    jae    L_3797                                # 3791: 73 04
    cmp    al,0x30                               # 3793: 3C 30
    jae    L_379C                                # 3795: 73 05
L_3797:
    call   L_2F45                                # 3797: E8 AB F7
    jb     L_37CF                                # 379A: 72 33
L_379C:
    .byte 0x8A, 0xE8 # 379C
    push   cx                                    # 379E: 51
    mov    ch,0xff                               # 379F: B5 FF
    mov    dx,0x8e                               # 37A1: BA 8E 00
L_37A4:
...
L_37F1:
    ...
    push   bx                                    # 37F9: 53
    mov    bx,0x31f                              # 37FA: BB 1F 03
    .byte 0x03, 0xDA # 37FD
    mov    dh,BYTE PTR [bx]                      # 37FF: 8A 37
    pop    bx                                    # 3801: 5B
    dec    bx                                    # 3802: 4B
    .byte 0x8A, 0xC6 # 3803
    mov    ds:0x2fb,al                           # 3805: A2 FB 02
    call   L_0F1D                                # 3808: E8 12 D7
    mov    al,ds:0x339                           # 380B: A0 39 03
    dec    al                                    # 380E: FE C8
...
L_382A:
    .byte 0x32, 0xC0 # 382A
    mov    ds:0x339,al                           # 382C: A2 39 03
    push   bx                                    # 382F: 53
    mov    al,ds:0x44d                           # 3830: A0 4D 04
    .byte 0x0A, 0xC0 # 3833
    mov    ds:0x44a,al                           # 3835: A2 4A 04
    je     L_3858                                # 3838: 74 1E
    mov    bx,WORD PTR ds:0x37c                  # 383A: 8B 1E 7C 03
    mov    dx,0x37e                              # 383E: BA 7E 03
    .byte 0x03, 0xDA # 3841
    mov    WORD PTR ds:0x44b,bx                  # 3843: 89 1E 4B 04
    xchg   dx,bx                                 # 3847: 87 DA
    jmp    L_6643                                # 3849: E9 F7 2D
L_384C:
    mov    al,ds:0x44a                           # 384C: A0 4A 04
    .byte 0x0A, 0xC0 # 384F
    je     L_3877                                # 3851: 74 24
    .byte 0x32, 0xC0 # 3853
    mov    ds:0x44a,al                           # 3855: A2 4A 04
L_3858:
    mov    bx,WORD PTR ds:0x35a                  # 3858: 8B 1E 5A 03
    mov    WORD PTR ds:0x44b,bx                  # 385C: 89 1E 4B 04
    mov    bx,WORD PTR ds:0x358                  # 3860: 8B 1E 58 03
    jmp    L_6643                                # 3864: E9 DC 2D
...
L_3877:
    ...
    push   bx                                    # 3890: 53
    push   cx                                    # 3891: 51
    mov    al,ds:0x2fb                           # 3892: A0 FB 02
    .byte 0x8A, 0xE8 # 3895
    mov    al,ds:0x8e                            # 3897: A0 8E 00
    .byte 0x02, 0xC5 # 389A
    inc    al                                    # 389C: FE C0
    .byte 0x8A, 0xC8 # 389E
    push   cx                                    # 38A0: 51
    ...
    inc    cx                                    # 38A4: 41
    inc    cx                                    # 38A5: 41
    mov    bx,WORD PTR ds:0x35c                  # 38A6: 8B 1E 5C 03
    push   bx                                    # 38AA: 53
    .byte 0x03, 0xD9 # 38AB
    pop    cx                                    # 38AD: 59
    push   bx                                    # 38AE: 53
    call   L_64CB                                # 38AF: E8 19 2C
    pop    bx                                    # 38B2: 5B
    mov    WORD PTR ds:0x35c,bx                  # 38B3: 89 1E 5C 03
    .byte 0x8B, 0xD9 # 38B7
    mov    WORD PTR ds:0x35a,bx                  # 38B9: 89 1E 5A 03
L_38BD:
    dec    bx                                    # 38BD: 4B
    ...
    ret                                          # 38D4: C3
L_38D5:
    call   L_7B5E                                # 38D5: E8 86 42
    jmp    L_38E2                                # 38D8: EB 08
L_38DA:
    mov    BYTE PTR ds:0x34f,0x0                 # 38DA: C6 06 4F 03 00
    jmp    L_435A                                # 38DF: E9 78 0A
L_38E2:
    call   L_1B25                                # 38E2: E8 40 E2
    jne    L_38EE                                # 38E5: 75 07
    mov    bx,0x6                                # 38E7: BB 06 00
    mov    WORD PTR ds:0x4a3,bx                  # 38EA: 89 1E A3 04
L_38EE:
    pop    bx                                    # 38EE: 5B
    ret                                          # 38EF: C3
L_38F0:
    push   bx                                    # 38F0: 53
    mov    bx,WORD PTR ds:0x2fa                  # 38F1: 8B 1E FA 02
    pop    si                                    # 38F5: 5E
...
L_3914:
    ...
    push   bx                                    # 391F: 53
    mov    al,ds:0x8e                            # 3920: A0 8E 00
    push   ax                                    # 3923: 50
    xchg   dx,bx                                 # 3924: 87 DA
    call   L_1051                                # 3926: E8 28 D7
    pop    ax                                    # 3929: 58
    mov    WORD PTR ds:0xb5,bx                   # 392A: 89 1E B5 00
    pop    bx                                    # 392E: 5B
...
L_3933:
    ...
    mov    bx,WORD PTR ds:0xb5                   # 393E: 8B 1E B5 00
    jmp    L_394C                                # 3942: EB 08
L_3944:
    call   L_1051                                # 3944: E8 0A D7
    .byte 0x32, 0xC0 # 3947
    mov    ds:0x8e,al                            # 3949: A2 8E 00
L_394C:
    mov    al,ds:0x45c                           # 394C: A0 5C 04
    .byte 0x0A, 0xC0 # 394F
...
L_397E:
    call   L_0F1D                                # 397E: E8 9C D5
    mov    WORD PTR ds:0x352,bx                  # 3981: 89 1E 52 03
    pop    bx                                    # 3985: 5B
    mov    WORD PTR ds:0x2fa,bx                  # 3986: 89 1E FA 02
...
L_3996:
    mov    bx,WORD PTR ds:0x35a                  # 3996: 8B 1E 5A 03
    jmp    L_664C                                # 399A: E9 AF 2C
L_399D:
    mov    al,ds:0x2fa                           # 399D: A0 FA 02
    .byte 0x0A, 0xC0 # 39A0
...
L_39D2:
    ...
    inc    bx                                    # 39DA: 43
    .byte 0x8A, 0xC8 # 39DB
    call   L_2CD5                                # 39DD: E8 F5 F2
    inc    bx                                    # 39E0: 43
    inc    bx                                    # 39E1: 43
    mov    WORD PTR ds:0x331,bx                  # 39E2: 89 1E 31 03
    mov    BYTE PTR [bx],cl                      # 39E6: 88 0F
    inc    bx                                    # 39E8: 43
    mov    al,ds:0x2fa                           # 39E9: A0 FA 02
    rcl    al,1                                  # 39EC: D0 D0
    .byte 0x8A, 0xC1 # 39EE
L_39F0:
...
L_3A25:
    ...
    mov    WORD PTR ds:0x35c,bx                  # 3A28: 89 1E 5C 03
L_3A2C:
    dec    bx                                    # 3A2C: 4B
    .byte 0xC6 # 3A2D
L_3A2E:
    ...
    inc    cx                                    # 3A36: 41
    .byte 0x8A, 0xF0 # 3A37
    mov    bx,WORD PTR ds:0x331                  # 3A39: 8B 1E 31 03
...
L_3A97:
    mov    bx,WORD PTR ds:0x352                  # 3A97: 8B 1E 52 03
    ret                                          # 3A9B: C3
L_3A9C:
    stc                                          # 3A9C: F9
    .byte 0x1A, 0xC0 # 3A9D
...
L_3ABB:
    ...
    ret                                          # 3ACA: C3
L_3ACB:
    call   L_1728                                # 3ACB: E8 5A DC
    call   L_643B                                # 3ACE: E8 6A 29
    call   L_2DF4                                # 3AD1: E8 20 F3
    cmp    ax,WORD PTR [bx-0x7426]               # 3AD4: 3B 87 DA 8B
    push   ds                                    # 3AD8: 1E
    mov    ds:0xeb04,ax                          # 3AD9: A3 04 EB
    .byte 0x0A # 3ADC
L_3ADD:
    .byte 0xA0, 0x3A, 0x03, 0x0A, 0xC0 # 3ADD
    je     L_3AF5                                # 3AE2: 74 11
    pop    dx                                    # 3AE4: 5A
    xchg   dx,bx                                 # 3AE5: 87 DA
    push   bx                                    # 3AE7: 53
    .byte 0x32, 0xC0 # 3AE8
    mov    ds:0x33a,al                           # 3AEA: A2 3A 03
    inc    al                                    # 3AED: FE C0
    pushf                                        # 3AEF: 9C
    push   dx                                    # 3AF0: 52
...
L_3C40:
    pop    bx                                    # 3C40: 5B
    dec    bx                                    # 3C41: 4B
    call   L_0F1D                                # 3C42: E8 D8 D2
    stc                                          # 3C45: F9
    je     L_3C59                                # 3C46: 74 11
    mov    ds:0x33a,al                           # 3C48: A2 3A 03
...
L_3C78:
    ...
    call   L_2BA5                                # 3C7B: E8 27 EF
L_3C7E:
    pop    bx                                    # 3C7E: 5B
    popf                                         # 3C7F: 9D
    je     L_3C85                                # 3C80: 74 03
    jmp    L_3ADD                                # 3C82: E9 58 FE
L_3C85:
    jae    L_3C8A                                # 3C85: 73 03
    call   L_2C71                                # 3C87: E8 E7 EF
L_3C8A:
    pop    si                                    # 3C8A: 5E
...
L_3CAC:
    ...
    push   cx                                    # 3CB5: 51
    call   L_1727                                # 3CB6: E8 6E DA
    call   L_643B                                # 3CB9: E8 7F 27
    pop    cx                                    # 3CBC: 59
    push   cx                                    # 3CBD: 51
    push   bx                                    # 3CBE: 53
    mov    bx,WORD PTR ds:0x4a3                  # 3CBF: 8B 1E A3 04
    .byte 0x8A, 0xE9 # 3CC3
...
L_3CD3:
    ...
    mov    bx,WORD PTR ds:0x4a3                  # 3CD6: 8B 1E A3 04
    pop    ax                                    # 3CDA: 58
    .byte 0x0A, 0xC0 # 3CDB
...
L_3CF6:
    ...
    call   L_2BA5                                # 3CFF: E8 A3 EE
L_3D02:
    pop    ax                                    # 3D02: 58
    ret                                          # 3D03: C3
WHILE:
    mov    WORD PTR ds:0x335,bx                  # 3D04: 89 1E 35 03
    call   L_24F7                                # 3D08: E8 EC E7
    call   L_0F1D                                # 3D0B: E8 0F D2
    ...
    mov    WORD PTR ds:0x345,bx                  # 3D1F: 89 1E 45 03
L_3D23:
    mov    bx,WORD PTR ds:0x2e                   # 3D23: 8B 1E 2E 00
    push   bx                                    # 3D27: 53
    mov    bx,WORD PTR ds:0x335                  # 3D28: 8B 1E 35 03
    push   bx                                    # 3D2C: 53
    push   dx                                    # 3D2D: 52
...
L_3D35:
    ...
    .byte 0x8B, 0xE3 # 3D3C
    mov    WORD PTR ds:0x345,bx                  # 3D3E: 89 1E 45 03
    mov    dx,WORD PTR ds:0x2e                   # 3D42: 8B 16 2E 00
    mov    WORD PTR ds:0x45a,dx                  # 3D46: 89 16 5A 04
    inc    bx                                    # 3D4A: 43
    inc    bx                                    # 3D4B: 43
    ...
    mov    WORD PTR ds:0x2e,bx                   # 3D52: 89 1E 2E 00
    xchg   dx,bx                                 # 3D56: 87 DA
L_3D58:
    call   L_1727                                # 3D58: E8 CC D9
    push   bx                                    # 3D5B: 53
...
L_3D6B:
    mov    bx,WORD PTR ds:0x45a                  # 3D6B: 8B 1E 5A 04
    mov    WORD PTR ds:0x2e,bx                   # 3D6F: 89 1E 2E 00
    pop    bx                                    # 3D73: 5B
    pop    cx                                    # 3D74: 59
    pop    cx                                    # 3D75: 59
...
WRITE:
    ...
    dec    bx                                    # 3DAC: 4B
    call   L_0F1D                                # 3DAD: E8 6D D1
    je     L_3E07                                # 3DB0: 74 55
L_3DB2:
    call   L_1727                                # 3DB2: E8 72 D9
    push   bx                                    # 3DB5: 53
    call   L_1B25                                # 3DB6: E8 6C DD
    je     L_3DF8                                # 3DB9: 74 3D
    call   L_70C8                                # 3DBB: E8 0A 33
    call   L_264C                                # 3DBE: E8 8B E8
    mov    bx,WORD PTR ds:0x4a3                  # 3DC1: 8B 1E A3 04
    inc    bx                                    # 3DC5: 43
...
L_3DDE:
    pop    bx                                    # 3DDE: 5B
    dec    bx                                    # 3DDF: 4B
    call   L_0F1D                                # 3DE0: E8 3A D1
    je     L_3E07                                # 3DE3: 74 22
    cmp    al,0x3b                               # 3DE5: 3C 3B
    je     L_3DEE                                # 3DE7: 74 05
    call   L_2DF4                                # 3DE9: E8 08 F0
    sub    al,0x4b                               # 3DEC: 2C 4B
L_3DEE:
    call   L_0F1D                                # 3DEE: E8 2C D1
    mov    al,0x2c                               # 3DF1: B0 2C
    call   L_2BA5                                # 3DF3: E8 AF ED
    jmp    L_3DB2                                # 3DF6: EB BA
L_3DF8:
    mov    al,0x22                               # 3DF8: B0 22
    call   L_2BA5                                # 3DFA: E8 A8 ED
    call   L_26BA                                # 3DFD: E8 BA E8
    mov    al,0x22                               # 3E00: B0 22
    call   L_2BA5                                # 3E02: E8 A0 ED
    jmp    L_3DDE                                # 3E05: EB D7
L_3E07:
    call   L_2C71                                # 3E07: E8 67 EE
...
L_3FA1:
    ret                                          # 3FA1: C3
L_3FA2:
    call   L_1F1F                                # 3FA2: E8 7A DF
L_3FA5:
    .byte 0x8A, 0xD8 # 3FA5
    mov    al,ds:0x4df                           # 3FA7: A0 DF 04
    .byte 0x3A, 0xC3 # 3FAA
...
L_3FB1:
    ...
    mov    bx,WORD PTR ds:0x4e0                  # 3FB7: 8B 1E E0 04
    .byte 0x03, 0xDA # 3FBB
    mov    bx,WORD PTR [bx]                      # 3FBD: 8B 1F
    mov    al,ds:0x536                           # 3FBF: A0 36 05
    inc    al                                    # 3FC2: FE C0
...
L_3FF7:
    call   L_3FA5                                # 3FF7: E8 AB FF
    jne    L_3FFF                                # 3FFA: 75 03
    jmp    L_079A                                # 3FFC: E9 9B C7
L_3FFF:
    mov    WORD PTR ds:0x4e9,bx                  # 3FFF: 89 1E E9 04
    ret                                          # 4003: C3
OPEN:
    mov    cx,0x1498                             # 4004: B9 98 14
    push   cx                                    # 4007: 51
    call   L_1727                                # 4008: E8 1C D7
...
L_4040:
    pop    bx                                    # 4040: 5B
    push   dx                                    # 4041: 52
    call   L_2DF4                                # 4042: E8 AF ED
    sub    al,0x3c                               # 4045: 2C 3C
    and    si,WORD PTR [di+0x3]                  # 4047: 23 75 03
    call   L_0F1D                                # 404A: E8 D0 CE
    call   L_1F1C                                # 404D: E8 CC DE
    call   L_2DF4                                # 4050: E8 A1 ED
    sub    al,0x8a                               # 4053: 2C 8A
...
L_406A:
    ...
    call   L_2DF4                                # 4086: E8 6B ED
    inc    cx                                    # 4089: 41
    call   L_2DF4                                # 408A: E8 67 ED
    push   ax                                    # 408D: 50
    call   L_2DF4                                # 408E: E8 63 ED
    push   ax                                    # 4091: 50
    call   L_2DF4                                # 4092: E8 5F ED
    inc    bp                                    # 4095: 45
    call   L_2DF4                                # 4096: E8 5B ED
    dec    si                                    # 4099: 4E
    call   L_2DF4                                # 409A: E8 57 ED
    inc    sp                                    # 409D: 44
    mov    dl,0x8                                # 409E: B2 08
    jmp    L_40CE                                # 40A0: EB 2C
L_40A2:
    call   L_0F1D                                # 40A2: E8 78 CE
    call   L_2DF4                                # 40A5: E8 4C ED
    push   bp                                    # 40A8: 55
    call   L_2DF4                                # 40A9: E8 48 ED
    push   sp                                    # 40AC: 54
    call   L_2DF4                                # 40AD: E8 44 ED
    push   ax                                    # 40B0: 50
    call   L_2DF4                                # 40B1: E8 40 ED
    push   bp                                    # 40B4: 55
    call   L_2DF4                                # 40B5: E8 3C ED
    push   sp                                    # 40B8: 54
    mov    dl,0x2                                # 40B9: B2 02
    jmp    L_40CE                                # 40BB: EB 11
L_40BD:
    call   L_0F1D                                # 40BD: E8 5D CE
    call   L_2DF4                                # 40C0: E8 31 ED
    inc    dx                                    # 40C3: 42
    call   L_2DF4                                # 40C4: E8 2D ED
    dec    bp                                    # 40C7: 4D
    mov    dl,0x20                               # 40C8: B2 20
    dec    bx                                    # 40CA: 4B
L_40CB:
    call   L_0F1D                                # 40CB: E8 4F CE
L_40CE:
    call   L_2DF4                                # 40CE: E8 23 ED
    inc    cx                                    # 40D1: 41
    call   L_2DF4                                # 40D2: E8 1F ED
    push   bx                                    # 40D5: 53
    push   dx                                    # 40D6: 52
    mov    al,BYTE PTR [bx]                      # 40D7: 8A 07
    cmp    al,0x23                               # 40D9: 3C 23
    jne    L_40E0                                # 40DB: 75 03
    call   L_0F1D                                # 40DD: E8 3D CE
L_40E0:
    call   L_1F1C                                # 40E0: E8 39 DE
    .byte 0x0A, 0xC0 # 40E3
...
L_4128:
    ...
    mov    al,ds:0x536                           # 412D: A0 36 05
    and    al,0x1                                # 4130: 24 01
    je     L_4137                                # 4132: 74 03
    jmp    L_447D                                # 4134: E9 46 03
L_4137:
    call   L_3FA5                                # 4137: E8 6B FE
    je     L_4151                                # 413A: 74 15
    mov    WORD PTR ds:0x4e9,bx                  # 413C: 89 1E E9 04
    push   bx                                    # 4140: 53
...
L_4151:
    ...
    mov    WORD PTR ds:0x4e9,bx                  # 415D: 89 1E E9 04
    pop    bx                                    # 4161: 5B
...
L_416F:
    ...
    call   L_0F1D                                # 4184: E8 96 CD
    call   L_2DF4                                # 4187: E8 6A EC
    push   dx                                    # 418A: 52
    pop    ax                                    # 418B: 58
    sahf                                         # 418C: 9E
    stc                                          # 418D: F9
...
L_4190:
    ...
    mov    bx,WORD PTR ds:0x4e9                  # 4199: 8B 1E E9 04
    ...
    mov    ds:0x536,al                           # 41AA: A2 36 05
    pop    ax                                    # 41AD: 58
    sahf                                         # 41AE: 9E
    lahf                                         # 41AF: 9F
    push   ax                                    # 41B0: 50
    .byte 0x1A, 0xC0 # 41B1
    mov    ds:0x4ef,al                           # 41B3: A2 EF 04
...
L_41C6:
    ...
    jmp    L_08D3                                # 41CB: E9 05 C7
SAVE:
    call   L_3F13                                # 41CE: E8 42 FD
    int    0xea                                  # 41D1: CD EA
    dec    bx                                    # 41D3: 4B
    call   L_0F1D                                # 41D4: E8 46 CD
    mov    dl,0x80                               # 41D7: B2 80
    stc                                          # 41D9: F9
    jne    L_41DF                                # 41DA: 75 03
    call   L_4758                                # 41DC: E8 79 05
L_41DF:
    je     L_41F9                                # 41DF: 74 18
    call   L_2DF4                                # 41E1: E8 10 EC
    sub    al,0x3c                               # 41E4: 2C 3C
    push   ax                                    # 41E6: 50
    mov    dl,0x92                               # 41E7: B2 92
    jne    L_41F1                                # 41E9: 75 06
    call   L_0F1D                                # 41EB: E8 2F CD
    stc                                          # 41EE: F9
    jmp    L_41F9                                # 41EF: EB 08
L_41F1:
    call   L_2DF4                                # 41F1: E8 00 EC
    inc    cx                                    # 41F4: 41
    .byte 0x0A, 0xC0 # 41F5
...
L_41F9:
    ...
    mov    ds:0x462,al                           # 41FF: A2 62 04
    pop    ax                                    # 4202: 58
    sahf                                         # 4203: 9E
    lahf                                         # 4204: 9F
    push   ax                                    # 4205: 50
    inc    al                                    # 4206: FE C0
    mov    ds:0x5f,al                            # 4208: A2 5F 00
    .byte 0x32, 0xC0 # 420B
    call   L_40ED                                # 420D: E8 DD FE
    pop    ax                                    # 4210: 58
    sahf                                         # 4211: 9E
    push   bx                                    # 4212: 53
    mov    bx,WORD PTR ds:0x4e9                  # 4213: 8B 1E E9 04
...
L_4221:
    ...
    mov    al,ds:0x462                           # 4225: A0 62 04
    .byte 0x0A, 0xC0 # 4228
    je     L_422F                                # 422A: 74 03
    call   L_46A8                                # 422C: E8 79 04
L_422F:
    mov    bx,WORD PTR ds:0x358                  # 422F: 8B 1E 58 03
    mov    WORD PTR ds:0x704,bx                  # 4233: 89 1E 04 07
    mov    bx,WORD PTR ds:0x30                   # 4237: 8B 1E 30 00
    push   bx                                    # 423B: 53
    mov    bx,WORD PTR ds:0x4e9                  # 423C: 8B 1E E9 04
...
L_4275:
    mov    bx,WORD PTR ds:0x30                   # 4275: 8B 1E 30 00
    .byte 0x0A, 0xC0 # 4279
...
L_42A3:
    ...
    mov    al,ds:0x463                           # 42A6: A0 63 04
    mov    ds:0x464,al                           # 42A9: A2 64 04
    call   L_435A                                # 42AC: E8 AB 00
    .byte 0x32, 0xC0 # 42AF
    call   L_3FA5                                # 42B1: E8 F1 FC
    mov    BYTE PTR [bx],0x80                    # 42B4: C6 07 80
    mov    WORD PTR ds:0x4e9,bx                  # 42B7: 89 1E E9 04
...
L_42C7:
    mov    al,ds:0x464                           # 42C7: A0 64 04
    .byte 0x0A, 0xC0 # 42CA
    je     L_42D1                                # 42CC: 74 03
    call   L_46F9                                # 42CE: E8 28 04
L_42D1:
    call   L_09FB                                # 42D1: E8 27 C7
    inc    bx                                    # 42D4: 43
    inc    bx                                    # 42D5: 43
    mov    WORD PTR ds:0x358,bx                  # 42D6: 89 1E 58 03
    call   L_2D37                                # 42DA: E8 5A EA
    .byte 0x32, 0xC0 # 42DD
    mov    ds:0x536,al                           # 42DF: A2 36 05
    call   L_4128                                # 42E2: E8 43 FE
    mov    al,ds:0x4ef                           # 42E5: A0 EF 04
    .byte 0x0A, 0xC0 # 42E8
    je     L_42EF                                # 42EA: 74 03
    jmp    L_0EE8                                # 42EC: E9 F9 CB
L_42EF:
    jmp    L_08B6                                # 42EF: E9 C4 C5
L_42F2:
    xchg   dx,bx                                 # 42F2: 87 DA
    mov    bx,WORD PTR ds:0x32f                  # 42F4: 8B 1E 2F 03
    xchg   dx,bx                                 # 42F8: 87 DA
    .byte 0x3B, 0xDA # 42FA
    jb     L_4296                                # 42FC: 72 98
    call   L_2D1D                                # 42FE: E8 1C EA
    .byte 0x32, 0xC0 # 4301
    mov    ds:0x536,al                           # 4303: A2 36 05
    jmp    L_2CF4                                # 4306: E9 EB E9
L_4309:
    push   bx                                    # 4309: 53
    push   dx                                    # 430A: 52
    mov    bx,WORD PTR ds:0x4e9                  # 430B: 8B 1E E9 04
...
L_4339:
    ...
    call   L_0F1D                                # 4340: E8 DA CB
L_4343:
    call   L_1F1C                                # 4343: E8 D6 DB
    pop    si                                    # 4346: 5E
...
CLOSE:
    ...
    mov    al,ds:0x4df                           # 4355: A0 DF 04
    jmp    L_4319                                # 4358: EB BF
L_435A:
    mov    al,ds:0x536                           # 435A: A0 36 05
    .byte 0x0A, 0xC0 # 435D
    js     L_432D                                # 435F: 78 CC
    mov    cx,0x4128                             # 4361: B9 28 41
    .byte 0x32, 0xC0 # 4364
    mov    al,ds:0x4df                           # 4366: A0 DF 04
    jmp    L_4319                                # 4369: EB AE
L_436B:
    .byte 0x32, 0xC0, 0x8A, 0xE8 # 436B
L_436F:
    .byte 0x8A, 0xC5 # 436F
    call   L_3FA5                                # 4371: E8 31 FC
    mov    BYTE PTR [bx],0x0                     # 4374: C6 07 00
    mov    al,ds:0x4df                           # 4377: A0 DF 04
    inc    ch                                    # 437A: FE C5
    .byte 0x2A, 0xC5 # 437C
    jae    L_436F                                # 437E: 73 EF
    .byte 0x32, 0xC0 # 4380
    mov    ds:0x536,al                           # 4382: A2 36 05
    call   L_2D1D                                # 4385: E8 95 E9
    mov    bx,WORD PTR ds:0x30                   # 4388: 8B 1E 30 00
    dec    bx                                    # 438C: 4B
...
L_4393:
    ...
    mov    bx,WORD PTR ds:0x4e9                  # 43A1: 8B 1E E9 04
...
L_43D5:
    ...
    push   bx                                    # 43D6: 53
    push   dx                                    # 43D7: 52
    mov    bx,WORD PTR ds:0x4e9                  # 43D8: 8B 1E E9 04
...
L_43EA:
    call   L_0F1D                                # 43EA: E8 30 CB
    call   L_2DF4                                # 43ED: E8 04 EA
    and    al,0xe8                               # 43F0: 24 E8
    add    dl,ch                                 # 43F2: 00 EA
    sub    BYTE PTR [bp+di-0x75],dl              # 43F4: 28 53 8B
    push   ds                                    # 43F7: 1E
    ...
    .byte 0xCB, 0xE8, 0xCD, 0xFB, 0x5B, 0x32, 0xC0, 0x8A, 0x07, 0x9F, 0x50, 0xE8 # 4413
    .byte 0xD3, 0xE9, 0x29, 0x58, 0x9E, 0x5E, 0x87, 0xDE, 0x56, 0x9F, 0x50, 0x8A # 441F
...
L_44E6:
    ...
    call   L_1F19                                # 44EA: E8 2C DA
    call   L_2DF4                                # 44ED: E8 04 E9
    sub    al,0x8a                               # 44F0: 2C 8A
...
L_45C7:
    mov    bx,WORD PTR ds:0x4e9                  # 45C7: 8B 1E E9 04
    .byte 0x8A, 0xC8 # 45CB
...
L_466A:
    push   dx                                    # 466A: 52
    call   L_2DF4                                # 466B: E8 86 E7
    sub    al,0xe8                               # 466E: 2C E8
    sub    ax,WORD PTR [bx+si]                   # 4670: 2B 00
    push   dx                                    # 4672: 52
    dec    bx                                    # 4673: 4B
    call   L_0F1D                                # 4674: E8 A6 C8
    ...
    ret                                          # 467D: C3
L_467E:
    call   L_2DF4                                # 467E: E8 73 E7
    sub    al,0xe8                               # 4681: 2C E8
    sbb    BYTE PTR [bx+si],al                   # 4683: 18 00
    pop    cx                                    # 4685: 59
    xchg   dx,bx                                 # 4686: 87 DA
    .byte 0x03, 0xD9 # 4688
    mov    WORD PTR ds:0x704,bx                  # 468A: 89 1E 04 07
    xchg   dx,bx                                 # 468E: 87 DA
    dec    bx                                    # 4690: 4B
    call   L_0F1D                                # 4691: E8 89 C8
...
L_46A8:
    ...
    mov    bx,WORD PTR ds:0x30                   # 46AB: 8B 1E 30 00
    xchg   dx,bx                                 # 46AF: 87 DA
L_46B1:
    mov    bx,WORD PTR ds:0x358                  # 46B1: 8B 1E 58 03
    .byte 0x3B, 0xDA # 46B5
...
L_46F9:
    ...
    mov    bx,WORD PTR ds:0x30                   # 46FC: 8B 1E 30 00
    xchg   dx,bx                                 # 4700: 87 DA
L_4702:
    mov    bx,WORD PTR ds:0x358                  # 4702: 8B 1E 58 03
    .byte 0x3B, 0xDA # 4706
...
L_4749:
    push   bx                                    # 4749: 53
    mov    bx,WORD PTR ds:0x2e                   # 474A: 8B 1E 2E 00
    .byte 0x8A, 0xC7, 0x22, 0xC3 # 474E
    pop    bx                                    # 4752: 5B
    inc    al                                    # 4753: FE C0
    je     L_4758                                # 4755: 74 01
    ret                                          # 4757: C3
L_4758:
    lahf                                         # 4758: 9F
    push   ax                                    # 4759: 50
    mov    al,ds:0x464                           # 475A: A0 64 04
    .byte 0x0A, 0xC0 # 475D
...
L_477B:
    ...
    call   L_0F1D                                # 4782: E8 98 C7
L_4785:
    call   L_2DF4                                # 4785: E8 6C E6
    sub    al,ch                                 # 4788: 28 E8
    jle    L_4763                                # 478A: 7E D7
    push   dx                                    # 478C: 52
    call   L_2DF4                                # 478D: E8 64 E6
    sub    al,0xe8                               # 4790: 2C E8
    jbe    L_476B                                # 4792: 76 D7
    call   L_2DF4                                # 4794: E8 5D E6
    sub    WORD PTR [bx+di-0x63],bx              # 4797: 29 59 9D
L_479A:
    push   bx                                    # 479A: 53
    mov    bx,WORD PTR ds:0x53d                  # 479B: 8B 1E 3D 05
...
L_47A4:
    ...
    sahf                                         # 47A9: 9E
    rcl    si,1                                  # 47AA: D1 D6
    mov    WORD PTR ds:0x53d,bx                  # 47AC: 89 1E 3D 05
    mov    WORD PTR ds:0x537,bx                  # 47B0: 89 1E 37 05
    .byte 0x8B, 0xCB # 47B4
    mov    bx,WORD PTR ds:0x53b                  # 47B6: 8B 1E 3B 05
    je     L_47BF                                # 47BA: 74 03
    mov    bx,0x0                                # 47BC: BB 00 00
L_47BF:
    .byte 0x03, 0xDA # 47BF
    mov    WORD PTR ds:0x53b,bx                  # 47C1: 89 1E 3B 05
    mov    WORD PTR ds:0x539,bx                  # 47C5: 89 1E 39 05
...
L_47D3:
    ...
    push   bx                                    # 47DB: 53
    call   L_4B07                                # 47DC: E8 28 03
    jae    L_47E7                                # 47DF: 73 06
    call   L_4A63                                # 47E1: E8 7F 02
    call   L_4A3C                                # 47E4: E8 55 02
L_47E7:
    pop    bx                                    # 47E7: 5B
    ret                                          # 47E8: C3
L_47E9:
    call   L_0F1D                                # 47E9: E8 31 C7
    call   L_477B                                # 47EC: E8 8C FF
    push   bx                                    # 47EF: 53
    call   L_4B07                                # 47F0: E8 14 03
    mov    bx,0xffff                             # 47F3: BB FF FF
    jae    L_4802                                # 47F6: 73 0A
    call   L_4A63                                # 47F8: E8 68 02
    call   L_4A19                                # 47FB: E8 1B 02
    .byte 0x8A, 0xD8 # 47FE
    mov    bh,0x0                                # 4800: B7 00
L_4802:
    call   L_650C                                # 4802: E8 07 1D
    pop    bx                                    # 4805: 5B
    ret                                          # 4806: C3
    .byte 0xB0, 0x03 # 4807
L_4809:
    ...
    .byte 0x8A, 0xD0 # 480B
    dec    bx                                    # 480D: 4B
    call   L_0F1D                                # 480E: E8 0C C7
    je     L_481E                                # 4811: 74 0B
    call   L_2DF4                                # 4813: E8 DE E5
    sub    al,0x3c                               # 4816: 2C 3C
    sub    al,0x74                               # 4818: 2C 74
    .byte 0x03, 0xE8, 0xFE, 0xD6 # 481A
L_481E:
    .byte 0x8A, 0xC2 # 481E
    push   bx                                    # 4820: 53
    call   L_4AE5                                # 4821: E8 C1 02
    jae    L_4829                                # 4824: 73 03
    jmp    L_1059                                # 4826: E9 30 C8
L_4829:
    pop    bx                                    # 4829: 5B
    pop    dx                                    # 482A: 5A
    pop    cx                                    # 482B: 59
    jmp    L_0F1E                                # 482C: E9 EF C6
...
L_4882:
    ...
    push   cx                                    # 4885: 51
    push   dx                                    # 4886: 52
    call   L_2DF4                                # 4887: E8 6A E5
    jmp    0xe8fe:0xede8                         # 488A: EA E8 ED FE E8
    .byte 0x76, 0xFF, 0x5A, 0x59, 0x74, 0x53, 0xE8, 0x5C, 0xE5, 0x2C, 0xE8, 0x58 # 488F
    .byte 0xE5, 0x42, 0x75, 0x03, 0xE9, 0x60, 0x00, 0xE8, 0x4F, 0xE5, 0x46, 0x53 # 489B
    ...
    .byte 0xC1, 0x75, 0xE3, 0x5B, 0xC3, 0x51, 0x52, 0x53, 0xE8, 0x45, 0x00, 0x8B # 48E3
...
L_4A19:
    ...
    mov    bx,WORD PTR ds:0x6f3                  # 4A20: 8B 1E F3 06
    mov    al,BYTE PTR es:[bx]                   # 4A24: 26 8A 07
    mov    dl,BYTE PTR ds:0x6f5                  # 4A27: 8A 16 F5 06
    .byte 0x22, 0xC2 # 4A2B
    mov    cl,BYTE PTR ds:0x55                   # 4A2D: 8A 0E 55 00
L_4A31:
...
L_4A3C:
    ...
    mov    bx,WORD PTR ds:0x6f3                  # 4A43: 8B 1E F3 06
    .byte 0x8B, 0xE9 # 4A47
    mov    al,ds:0x6f5                           # 4A49: A0 F5 06
    not    al                                    # 4A4C: F6 D0
    and    al,BYTE PTR es:[bx]                   # 4A4E: 26 22 07
    mov    cl,BYTE PTR ds:0x6f6                  # 4A51: 8A 0E F6 06
    and    cl,BYTE PTR ds:0x6f5                  # 4A55: 22 0E F5 06
    .byte 0x0A, 0xC1 # 4A59
...
L_4A7B:
    mov    WORD PTR ds:0x6f3,dx                  # 4A7B: 89 16 F3 06
    .byte 0x8B, 0xD5, 0x8A, 0xCA # 4A7F
    test   BYTE PTR ds:0x55,0x1                  # 4A83: F6 06 55 00 01
    je     L_4A9E                                # 4A88: 74 14
    mov    al,0x7                                # 4A8A: B0 07
    .byte 0x22, 0xC8 # 4A8C
    mov    al,0x80                               # 4A8E: B0 80
    shr    al,cl                                 # 4A90: D2 E8
    mov    ds:0x6f5,al                           # 4A92: A2 F5 06
    mov    cl,0x3                                # 4A95: B1 03
    shr    dx,cl                                 # 4A97: D3 EA
    add    WORD PTR ds:0x6f3,dx                  # 4A99: 01 16 F3 06
    ret                                          # 4A9D: C3
L_4A9E:
    ...
    mov    ds:0x6f5,al                           # 4AA8: A2 F5 06
    mov    cl,0x2                                # 4AAB: B1 02
    shr    dx,cl                                 # 4AAD: D3 EA
    add    WORD PTR ds:0x6f3,dx                  # 4AAF: 01 16 F3 06
    ret                                          # 4AB3: C3
L_4AB4:
    mov    al,ds:0x48                            # 4AB4: A0 48 00
    mov    WORD PTR ds:0x53b,0x64                # 4AB7: C7 06 3B 05 64 00
    cmp    al,0x6                                # 4ABD: 3C 06
    je     L_4AD3                                # 4ABF: 74 12
    jae    L_4ADF                                # 4AC1: 73 1C
    cmp    al,0x4                                # 4AC3: 3C 04
    jb     L_4ADF                                # 4AC5: 72 18
    mov    BYTE PTR ds:0x55,0x2                  # 4AC7: C6 06 55 00 02
    mov    WORD PTR ds:0x53d,0xa0                # 4ACC: C7 06 3D 05 A0 00
    ret                                          # 4AD2: C3
L_4AD3:
    mov    BYTE PTR ds:0x55,0x1                  # 4AD3: C6 06 55 00 01
    mov    WORD PTR ds:0x53d,0x140               # 4AD8: C7 06 3D 05 40 01
    ret                                          # 4ADE: C3
L_4ADF:
    mov    BYTE PTR ds:0x55,0x0                  # 4ADF: C6 06 55 00 00
    ret                                          # 4AE4: C3
L_4AE5:
    cmp    al,0x4                                # 4AE5: 3C 04
    jae    L_4AF8                                # 4AE7: 73 0F
    test   BYTE PTR ds:0x55,0x1                  # 4AE9: F6 06 55 00 01
    je     L_4AFC                                # 4AEE: 74 0C
    and    al,0x1                                # 4AF0: 24 01
    neg    al                                    # 4AF2: F6 D8
    mov    ds:0x6f6,al                           # 4AF4: A2 F6 06
    clc                                          # 4AF7: F8
L_4AF8:
    ret                                          # 4AF8: C3
L_4AF9:
    jmp    L_1059                                # 4AF9: E9 5D C5
L_4AFC:
    and    al,0x3                                # 4AFC: 24 03
    mov    cl,0x55                               # 4AFE: B1 55
    mul    cl                                    # 4B00: F6 E1
    mov    ds:0x6f6,al                           # 4B02: A2 F6 06
    clc                                          # 4B05: F8
    ret                                          # 4B06: C3
L_4B07:
    mov    al,ds:0x55                            # 4B07: A0 55 00
    .byte 0x0A, 0xC0 # 4B0A
    je     L_4AF9                                # 4B0C: 74 EB
    .byte 0x0A, 0xED # 4B0E
    js     L_4B39                                # 4B10: 78 27
    mov    bx,0x280                              # 4B12: BB 80 02
    test   BYTE PTR ds:0x1,al                    # 4B15: 84 06 01 00
...
L_4BDE:
    push   bx                                    # 4BDE: 53
    call   L_6509                                # 4BDF: E8 27 19
    pop    bx                                    # 4BE2: 5B
    ret                                          # 4BE3: C3
    .byte 0xF6 # 4BE4
L_4BE5:
    cmp    BYTE PTR ds:0x71,0x0                  # 4BE5: 80 3E 71 00 00
    je     L_4BEF                                # 4BEA: 74 03
    jmp    L_50E8                                # 4BEC: E9 F9 04
L_4BEF:
    ret                                          # 4BEF: C3
L_4BF0:
    mov    al,ds:0x29                            # 4BF0: A0 29 00
    .byte 0x8A, 0xD0 # 4BF3
    call   L_1EF7                                # 4BF5: E8 FF D2
    jmp    L_50E8                                # 4BF8: E9 ED 04
    .byte 0x00, 0x00, 0x00 # 4BFB
L_4BFE:
    mov    ah,0xf                                # 4BFE: B4 0F
    int    0x10                                  # 4C00: CD 10
    mov    ds:0x48,al                            # 4C02: A2 48 00
    ...
    mov    WORD PTR ds:0x68,cx                   # 4C14: 89 0E 68 00
L_4C18:
    mov    BYTE PTR ds:0x29,ah                   # 4C18: 88 26 29 00
    cli                                          # 4C1C: FA
    mov    bx,ds                                 # 4C1D: 8C DB
    mov    WORD PTR ds:0x350,bx                  # 4C1F: 89 1E 50 03
    push   ds                                    # 4C23: 1E
    mov    dx,0x0                                # 4C24: BA 00 00
    mov    ds,dx                                 # 4C27: 8E DA
    mov    WORD PTR ds:0x510,bx                  # 4C29: 89 1E 10 05
    mov    bx,0x4d34                             # 4C2D: BB 34 4D
    mov    WORD PTR ds:0x6c,bx                   # 4C30: 89 1E 6C 00
    mov    bx,0x5744                             # 4C34: BB 44 57
    mov    WORD PTR ds:0x70,bx                   # 4C37: 89 1E 70 00
    mov    WORD PTR ds:0x6e,cs                   # 4C3B: 8C 0E 6E 00
    mov    WORD PTR ds:0x72,cs                   # 4C3F: 8C 0E 72 00
    pop    ds                                    # 4C43: 1F
...
L_4D53:
    push   si                                    # 4D53: 56
    mov    al,ds:0x5e                            # 4D54: A0 5E 00
    .byte 0x0A, 0xC0 # 4D57
    jne    L_4D6C                                # 4D59: 75 11
    mov    al,ds:0x6a                            # 4D5B: A0 6A 00
    .byte 0x0A, 0xC0 # 4D5E
...
L_4D6C:
    ...
    ret                                          # 4D6D: C3
L_4D6E:
    mov    al,ds:0x5e                            # 4D6E: A0 5E 00
    .byte 0x0A, 0xC0 # 4D71
    je     L_4D7D                                # 4D73: 74 08
    .byte 0x32, 0xC0 # 4D75
    mov    ds:0x5e,al                            # 4D77: A2 5E 00
    mov    al,0x3                                # 4D7A: B0 03
    ret                                          # 4D7C: C3
L_4D7D:
    push   si                                    # 4D7D: 56
    push   di                                    # 4D7E: 57
    mov    al,ds:0x6a                            # 4D7F: A0 6A 00
    .byte 0x0A, 0xC0 # 4D82
...
L_4D9C:
    mov    bx,WORD PTR ds:0x2e                   # 4D9C: 8B 1E 2E 00
    inc    bx                                    # 4DA0: 43
    .byte 0x0B, 0xDB # 4DA1
...
L_4DBB:
    ...
    mov    WORD PTR ds:0x6b,bx                   # 4DC6: 89 1E 6B 00
    dec    BYTE PTR ds:0x6a                      # 4DCA: FE 0E 6A 00
    shr    al,1                                  # 4DCE: D0 E8
    add    al,0x41                               # 4DD0: 04 41
    mov    WORD PTR ds:0x6d,cs                   # 4DD2: 8C 0E 6D 00
...
L_4DD8:
    ...
    mov    WORD PTR ds:0x6b,bx                   # 4DEC: 89 1E 6B 00
    mov    WORD PTR ds:0x6d,ds                   # 4DF0: 8C 1E 6D 00
    dec    BYTE PTR ds:0x6a                      # 4DF4: FE 0E 6A 00
    jmp    L_4E06                                # 4DF8: EB 0C
L_4DFA:
    push   bx                                    # 4DFA: 53
    dec    al                                    # 4DFB: FE C8
    jne    L_4E06                                # 4DFD: 75 07
    mov    ds:0x6a,al                            # 4DFF: A2 6A 00
    mov    al,0x20                               # 4E02: B0 20
    jmp    L_4DB8                                # 4E04: EB B2
L_4E06:
    push   ds                                    # 4E06: 1E
    lds    bx,DWORD PTR ds:0x6b                  # 4E07: C5 1E 6B 00
    mov    al,BYTE PTR [bx]                      # 4E0B: 8A 07
    pop    ds                                    # 4E0D: 1F
    inc    WORD PTR ds:0x6b                      # 4E0E: FF 06 6B 00
    .byte 0x0A, 0xC0 # 4E12
...
L_4E18:
    ...
    mov    bl,BYTE PTR ds:0x6e                   # 4E1C: 8A 1E 6E 00
    .byte 0x3A, 0xDF # 4E20
    jb     L_4E28                                # 4E22: 72 04
    inc    ah                                    # 4E24: FE C4
    and    al,0x7f                               # 4E26: 24 7F
L_4E28:
    mov    BYTE PTR ds:0x6a,ah                   # 4E28: 88 26 6A 00
    .byte 0x0A, 0xC0 # 4E2C
...
L_4E90:
    ...
    test   BYTE PTR ds:0x6f,0xff                 # 4E9D: F6 06 6F 00 FF
...
L_4EBA:
    ...
    mov    bx,WORD PTR ds:0x56                   # 4ED1: 8B 1E 56 00
    ret                                          # 4ED5: C3
L_4ED6:
...
L_4EEF:
    push   ax                                    # 4EEF: 50
    mov    bh,BYTE PTR ds:0x49                   # 4EF0: 8A 3E 49 00
    mov    bl,BYTE PTR ds:0x4e                   # 4EF4: 8A 1E 4E 00
...
L_4F1C:
    mov    bx,WORD PTR ds:0x56                   # 4F1C: 8B 1E 56 00
L_4F20:
    mov    WORD PTR ds:0x56,bx                   # 4F20: 89 1E 56 00
    pushf                                        # 4F24: 9C
    push   bx                                    # 4F25: 53
    ...
    ret                                          # 4F2B: C3
L_4F2C:
    mov    al,ds:0x57                            # 4F2C: A0 57 00
    dec    al                                    # 4F2F: FE C8
L_4F31:
    ret                                          # 4F31: C3
L_4F32:
    push   ax                                    # 4F32: 50
    mov    cl,BYTE PTR ds:0x29                   # 4F33: 8A 0E 29 00
    sub    cl,BYTE PTR ds:0x57                   # 4F37: 2A 0E 57 00
    inc    cl                                    # 4F3B: FE C1
    mov    ch,0x0                                # 4F3D: B5 00
    mov    bh,BYTE PTR ds:0x49                   # 4F3F: 8A 3E 49 00
    mov    bl,BYTE PTR ds:0x4f                   # 4F43: 8A 1E 4F 00
    mov    al,0x20                               # 4F47: B0 20
    mov    ah,0x9                                # 4F49: B4 09
    int    0x10                                  # 4F4B: CD 10
    mov    dx,WORD PTR ds:0x56                   # 4F4D: 8B 16 56 00
...
L_4F5D:
    ...
    mov    bh,BYTE PTR ds:0x49                   # 4F61: 8A 3E 49 00
    mov    bl,BYTE PTR ds:0x4f                   # 4F65: 8A 1E 4F 00
    mov    cl,BYTE PTR ds:0x29                   # 4F69: 8A 0E 29 00
...
L_4F76:
    ...
    dec    dh                                    # 4F7C: FE CE
    dec    dl                                    # 4F7E: FE CA
    mov    bh,BYTE PTR ds:0x49                   # 4F80: 8A 3E 49 00
...
L_4FB1:
    ...
    mov    dl,BYTE PTR ds:0x29                   # 4FB4: 8A 16 29 00
    dec    dl                                    # 4FB8: FE CA
    dec    dh                                    # 4FBA: FE CE
    dec    ch                                    # 4FBC: FE CD
    mov    al,0x1                                # 4FBE: B0 01
    mov    bh,BYTE PTR ds:0x4f                   # 4FC0: 8A 3E 4F 00
    ret                                          # 4FC4: C3
L_4FC5:
    mov    al,ds:0x49                            # 4FC5: A0 49 00
    jmp    L_4FCD                                # 4FC8: EB 03
L_4FCA:
    mov    al,ds:0x4a                            # 4FCA: A0 4A 00
L_4FCD:
    call   L_50D6                                # 4FCD: E8 06 01
    jne    L_4FF2                                # 4FD0: 75 20
    mov    ah,BYTE PTR ds:0x48                   # 4FD2: 8A 26 48 00
...
KEYS:
    ...
    push   dx                                    # 504E: 52
    call   L_2DF4                                # 504F: E8 A2 DD
    sub    al,0xe8                               # 5052: 2C E8
    rol    si,1                                  # 5054: D1 C6
    push   bx                                    # 5056: 53
...
L_507E:
    cmp    al,BYTE PTR ds:0x71                   # 507E: 3A 06 71 00
    mov    ds:0x71,al                            # 5082: A2 71 00
    je     L_508A                                # 5085: 74 03
    call   L_50E8                                # 5087: E8 5E 00
L_508A:
    call   L_0F1D                                # 508A: E8 90 BE
    ret                                          # 508D: C3
L_508E:
    push   bx                                    # 508E: 53
...
L_5095:
    ...
    call   L_2BA5                                # 509A: E8 08 DB
    push   cx                                    # 509D: 51
    .byte 0x8A, 0xDD # 509E
    mov    bh,0x0                                # 50A0: B7 00
    call   L_6550                                # 50A2: E8 AB 14
    mov    al,0x20                               # 50A5: B0 20
    call   L_2BA5                                # 50A7: E8 FB DA
    pop    cx                                    # 50AA: 59
    pop    si                                    # 50AB: 5E
    push   si                                    # 50AC: 56
    push   cx                                    # 50AD: 51
...
L_50D1:
    call   L_2BA5                                # 50D1: E8 D1 DA
    pop    si                                    # 50D4: 5E
    ret                                          # 50D5: C3
L_50D6:
    push   ax                                    # 50D6: 50
    mov    al,ds:0x48                            # 50D7: A0 48 00
...
L_50E8:
    ...
    mov    bh,BYTE PTR ds:0x49                   # 50EF: 8A 3E 49 00
    mov    ah,0x2                                # 50F3: B4 02
    int    0x10                                  # 50F5: CD 10
    mov    al,ds:0x71                            # 50F7: A0 71 00
    .byte 0x0A, 0xC0 # 50FA
    jne    L_5111                                # 50FC: 75 13
    mov    bl,BYTE PTR ds:0x4f                   # 50FE: 8A 1E 4F 00
    mov    cl,BYTE PTR ds:0x29                   # 5102: 8A 0E 29 00
...
L_5131:
    push   ax                                    # 5131: 50
    push   bx                                    # 5132: 53
    mov    bl,BYTE PTR ds:0x4e                   # 5133: 8A 1E 4E 00
...
L_5171:
    ...
    mov    bl,BYTE PTR ds:0x4f                   # 5178: 8A 1E 4F 00
L_517C:
...
L_5182:
    ...
    ret                                          # 5192: C3
SCREEN:
    mov    cl,BYTE PTR ds:0x49                   # 5193: 8A 0E 49 00
    mov    ch,0x0                                # 5197: B5 00
    mov    ah,BYTE PTR ds:0x48                   # 5199: 8A 26 48 00
...
L_51B3:
    ...
    call   L_1F1C                                # 51B8: E8 61 CD
    pop    cx                                    # 51BB: 59
    .byte 0x8A, 0xE8 # 51BC
    push   cx                                    # 51BE: 51
    call   L_0F1E                                # 51BF: E8 5C BD
    je     L_5204                                # 51C2: 74 40
L_51C4:
    call   L_2DF4                                # 51C4: E8 2D DC
    sub    al,0x3c                               # 51C7: 2C 3C
    ...
    call   L_2DF4                                # 51E1: E8 10 DC
    sub    al,0x3c                               # 51E4: 2C 3C
    ...
    .byte 0x8A, 0xC8 # 51ED
    push   cx                                    # 51EF: 51
    call   L_0F1E                                # 51F0: E8 2B BD
    je     L_5204                                # 51F3: 74 0F
    call   L_2DF4                                # 51F5: E8 FC DB
    sub    al,0xe8                               # 51F8: 2C E8
    and    ch,cl                                 # 51FA: 20 CD
    .byte 0x8A, 0xF0 # 51FC
    pop    cx                                    # 51FE: 59
    jmp    L_5207                                # 51FF: EB 06
L_5201:
    jmp    L_1059                                # 5201: E9 55 BE
L_5204:
    pop    cx                                    # 5204: 59
    .byte 0x8A, 0xF1 # 5205
L_5207:
    mov    ah,BYTE PTR ds:0x29                   # 5207: 8A 26 29 00
    .byte 0x8A, 0xC5 # 520B
...
L_5238:
    ...
    cmp    BYTE PTR ds:0x48,0x7                  # 523E: 80 3E 48 00 07
...
L_526E:
    ...
    dec    cl                                    # 5275: FE C9
L_5277:
    mov    BYTE PTR ds:0x29,ah                   # 5277: 88 26 29 00
    mov    ax,ds:0x48                            # 527B: A1 48 00
    mov    BYTE PTR ds:0x48,cl                   # 527E: 88 0E 48 00
    mov    WORD PTR ds:0x49,dx                   # 5282: 89 16 49 00
    .byte 0x3A, 0xC1 # 5286
    je     L_52A4                                # 5288: 74 1A
    mov    ax,0x7                                # 528A: B8 07 00
    mov    ds:0x4b,ax                            # 528D: A3 4B 00
    xchg   ah,al                                 # 5290: 86 C4
    mov    ds:0x4d,ax                            # 5292: A3 4D 00
    mov    BYTE PTR ds:0x4f,ah                   # 5295: 88 26 4F 00
    call   L_50D6                                # 5299: E8 3A FE
    je     L_52A1                                # 529C: 74 03
    mov    ds:0x4f,al                            # 529E: A2 4F 00
L_52A1:
    call   L_5312                                # 52A1: E8 6E 00
L_52A4:
    mov    al,ds:0x4a                            # 52A4: A0 4A 00
    mov    ah,0x5                                # 52A7: B4 05
    int    0x10                                  # 52A9: CD 10
    ret                                          # 52AB: C3
L_52AC:
    cmp    al,BYTE PTR ds:0x29                   # 52AC: 3A 06 29 00
    je     L_52E6                                # 52B0: 74 34
    mov    ah,BYTE PTR ds:0x48                   # 52B2: 8A 26 48 00
    cmp    al,0x50                               # 52B6: 3C 50
    je     L_52C1                                # 52B8: 74 07
    cmp    al,0x28                               # 52BA: 3C 28
    je     L_52C1                                # 52BC: 74 03
    jmp    L_1059                                # 52BE: E9 98 BD
L_52C1:
...
L_52D4:
    push   ax                                    # 52D4: 50
    mov    ds:0x29,al                            # 52D5: A2 29 00
    mov    BYTE PTR ds:0x48,ah                   # 52D8: 88 26 48 00
    mov    WORD PTR ds:0x49,0x0                  # 52DC: C7 06 49 00 00 00
...
L_5312:
    ...
    mov    WORD PTR ds:0x49,cx                   # 5316: 89 0E 49 00
    mov    al,ds:0x48                            # 531A: A0 48 00
    mov    ah,0x0                                # 531D: B4 00
    int    0x10                                  # 531F: CD 10
L_5321:
    call   L_30E1                                # 5321: E8 BD DD
    call   L_4BF0                                # 5324: E8 C9 F8
    call   L_4AB4                                # 5327: E8 8A F7
...
COLOR:
    ...
    cmp    BYTE PTR ds:0x48,0x6                  # 5339: 80 3E 48 00 06
    jne    L_5343                                # 533E: 75 03
    jmp    L_1059                                # 5340: E9 16 BD
L_5343:
    mov    ch,BYTE PTR [si]                      # 5343: 8A 2C
    push   si                                    # 5345: 56
    push   cx                                    # 5346: 51
    call   L_0F1E                                # 5347: E8 D4 BB
    je     L_538C                                # 534A: 74 40
    cmp    al,0x2c                               # 534C: 3C 2C
    je     L_5357                                # 534E: 74 07
    call   L_1F1C                                # 5350: E8 C9 CB
    pop    cx                                    # 5353: 59
    .byte 0x8A, 0xE8 # 5354
    push   cx                                    # 5356: 51
L_5357:
...
L_536B:
    ...
    int    0x10                                  # 536D: CD 10
    pop    bx                                    # 536F: 5B
    call   L_0F1E                                # 5370: E8 AB BB
    je     L_5378                                # 5373: 74 03
    call   L_0F1D                                # 5375: E8 A5 BB
L_5378:
    pop    cx                                    # 5378: 59
    pop    si                                    # 5379: 5E
...
L_5386:
    mov    BYTE PTR ds:0x4f,0x0                  # 5386: C6 06 4F 00 00
    ret                                          # 538B: C3
L_538C:
    pop    cx                                    # 538C: 59
    pop    si                                    # 538D: 5E
    ret                                          # 538E: C3
L_538F:
    push   WORD PTR ds:0x4d                      # 538F: FF 36 4D 00
    push   WORD PTR ds:0x4b                      # 5393: FF 36 4B 00
    cmp    al,0x2c                               # 5397: 3C 2C
    je     L_53AB                                # 5399: 74 10
    call   L_1F1C                                # 539B: E8 7E CB
    cmp    al,0x20                               # 539E: 3C 20
    jae    L_53BA                                # 53A0: 73 18
    pop    cx                                    # 53A2: 59
    .byte 0x8A, 0xC8 # 53A3
    push   cx                                    # 53A5: 51
    call   L_0F1E                                # 53A6: E8 75 BB
    je     L_53D7                                # 53A9: 74 2C
L_53AB:
    call   L_2DF4                                # 53AB: E8 46 DA
    sub    al,0x3c                               # 53AE: 2C 3C
...
L_53BA:
    jmp    L_1059                                # 53BA: E9 9C BC
L_53BD:
    pop    cx                                    # 53BD: 59
    .byte 0x8A, 0xE8 # 53BE
    push   cx                                    # 53C0: 51
    call   L_0F1E                                # 53C1: E8 5A BB
    je     L_53D7                                # 53C4: 74 11
    call   L_2DF4                                # 53C6: E8 2B DA
    sub    al,0xe8                               # 53C9: 2C E8
    dec    di                                    # 53CB: 4F
    retf                                         # 53CC: CB
...
L_53D7:
    ...
    mov    WORD PTR ds:0x4b,cx                   # 53DE: 89 0E 4B 00
    .byte 0x8A, 0xC5 # 53E2
    shl    al,1                                  # 53E4: D0 E0
...
L_53FD:
    ...
    mov    ds:0x4d,al                            # 5406: A2 4D 00
    mov    BYTE PTR ds:0x4e,ch                   # 5409: 88 2E 4E 00
    mov    BYTE PTR ds:0x4f,ch                   # 540D: 88 2E 4F 00
    mov    ah,0xb                                # 5411: B4 0B
    int    0x10                                  # 5413: CD 10
    pop    bx                                    # 5415: 5B
    ret                                          # 5416: C3
LOCATE:
    push   WORD PTR ds:0x56                      # 5417: FF 36 56 00
    cmp    al,0x2c                               # 541B: 3C 2C
    je     L_543F                                # 541D: 74 20
    call   L_1F1C                                # 541F: E8 FA CA
    .byte 0x0A, 0xC0 # 5422
    je     L_5481                                # 5424: 74 5B
    cmp    al,0x1a                               # 5426: 3C 1A
    jae    L_5481                                # 5428: 73 57
    mov    ah,BYTE PTR ds:0x71                   # 542A: 8A 26 71 00
    .byte 0x0A, 0xE4 # 542E
...
L_5436:
    ...
    .byte 0x8A, 0xD0 # 5437
    push   dx                                    # 5439: 52
    call   L_0F1E                                # 543A: E8 E1 BA
    je     L_54BA                                # 543D: 74 7B
L_543F:
    call   L_2DF4                                # 543F: E8 B2 D9
    sub    al,0x3c                               # 5442: 2C 3C
    sub    al,0x74                               # 5444: 2C 74
    sbb    al,ch                                 # 5446: 18 E8
    ror    dl,cl                                 # 5448: D2 CA
    .byte 0x0A, 0xC0 # 544A
    je     L_5481                                # 544C: 74 33
    mov    ah,BYTE PTR ds:0x29                   # 544E: 8A 26 29 00
    .byte 0x3A, 0xE0 # 5452
    jb     L_5481                                # 5454: 72 2B
    pop    dx                                    # 5456: 5A
    .byte 0x8A, 0xF0 # 5457
    push   dx                                    # 5459: 52
    call   L_0F1E                                # 545A: E8 C1 BA
    je     L_54BA                                # 545D: 74 5B
    push   WORD PTR ds:0x68                      # 545F: FF 36 68 00
    call   L_2DF4                                # 5463: E8 8E D9
    sub    al,0x3c                               # 5466: 2C 3C
...
L_5481:
    jmp    L_1059                                # 5481: E9 D5 BB
    .byte 0xE8, 0x6D, 0xD9, 0x2C, 0xE8, 0x91, 0xCA, 0x3C, 0x20, 0x73, 0xF2, 0x59 # 5484
    .byte 0x80, 0xE5, 0x20, 0x0A, 0xE8, 0x8A, 0xC8, 0x51, 0xE8, 0x83, 0xBA, 0x74 # 5490
    .byte 0x0F, 0xE8, 0x54, 0xD9, 0x2C, 0xE8, 0x78, 0xCA, 0x3C, 0x20, 0x73, 0xD9 # 549C
    .byte 0x59, 0x8A, 0xC8, 0x51, 0x59, 0x51, 0x80, 0xE5, 0x0F, 0x89, 0x0E, 0x68 # 54A8
    .byte 0x00, 0x59, 0xB4, 0x01, 0xCD, 0x10 # 54B4
L_54BA:
    pop    dx                                    # 54BA: 5A
    mov    WORD PTR ds:0x56,dx                   # 54BB: 89 16 56 00
    xchg   dl,dh                                 # 54BF: 86 F2
    dec    dh                                    # 54C1: FE CE
    dec    dl                                    # 54C3: FE CA
    push   bx                                    # 54C5: 53
    mov    bh,BYTE PTR ds:0x49                   # 54C6: 8A 3E 49 00
...
L_54D8:
    ...
    pop    ax                                    # 54DF: 58
    pop    bx                                    # 54E0: 5B
    mov    cx,WORD PTR ds:0x68                   # 54E1: 8B 0E 68 00
    test   BYTE PTR ds:0x72,0xff                 # 54E5: F6 06 72 00 FF
...
L_5508:
    ...
    add    al,BYTE PTR ds:0x72                   # 5533: 02 06 72 00
    mov    bl,0x83                               # 5537: B3 83
    mov    bh,BYTE PTR ds:0x49                   # 5539: 8A 3E 49 00
...
L_558F:
    ...
    dec    dh                                    # 5592: FE CE
    dec    dl                                    # 5594: FE CA
    mov    bh,BYTE PTR ds:0x49                   # 5596: 8A 3E 49 00
    ...
    pop    bx                                    # 55A2: 5B
    push   ax                                    # 55A3: 50
    call   L_0F1E                                # 55A4: E8 77 B9
    cmp    al,0x2c                               # 55A7: 3C 2C
    je     L_55AF                                # 55A9: 74 04
    mov    al,0x0                                # 55AB: B0 00
    jmp    L_55B6                                # 55AD: EB 07
L_55AF:
    call   L_2DF4                                # 55AF: E8 42 D8
    sub    al,0xe8                               # 55B2: 2C E8
    leaved                                       # 55B4: 66 C9
L_55B6:
    push   ax                                    # 55B6: 50
    call   L_2DF4                                # 55B7: E8 3A D8
    sub    WORD PTR [bx+si+0xa],bx               # 55BA: 29 58 0A
    rcr    BYTE PTR [bx+si+0x74],0x2             # 55BD: C0 58 74 02
    .byte 0x8A, 0xC4 # 55C1
    jmp    L_4BD8                                # 55C3: E9 12 F6
L_55C6:
    jmp    L_1059                                # 55C6: E9 90 BA
    .byte 0xE8, 0x05, 0x00, 0xE8, 0x25, 0xD8, 0x29, 0xC3 # 55C9
L_55D1:
    call   L_2DF4                                # 55D1: E8 20 D8
    sub    al,ch                                 # 55D4: 28 E8
    .byte 0x32, 0xC9 # 55D6
    push   dx                                    # 55D8: 52
    call   L_2DF4                                # 55D9: E8 18 D8
    sub    al,0xe8                               # 55DC: 2C E8
    .byte 0x2A, 0xC9 # 55DE
    pop    cx                                    # 55E0: 59
    ret                                          # 55E1: C3
L_55E2:
    call   L_0F1D                                # 55E2: E8 38 B9
    cmp    al,0x95                               # 55E5: 3C 95
    je     L_55F1                                # 55E7: 74 08
    call   L_2DF4                                # 55E9: E8 08 D8
    fnsave [bp+si]                               # 55EC: DD 32
    shr    bl,0x5                                # 55EE: C0 EB 05
L_55F1:
    call   L_0F1D                                # 55F1: E8 29 B9
    mov    al,0xff                               # 55F4: B0 FF
    mov    ds:0x34,al                            # 55F6: A2 34 00
    ret                                          # 55F9: C3
L_55FA:
    mov    al,ds:0x34                            # 55FA: A0 34 00
    .byte 0x0A, 0xC0 # 55FD
    je     L_5631                                # 55FF: 74 30
    call   L_1F1F                                # 5601: E8 1B C9
...
L_56EF:
    sti                                          # 56EF: FB
    pop    bx                                    # 56F0: 5B
    mov    al,ds:0x41                            # 56F1: A0 41 00
    jmp    L_4BD8                                # 56F4: E9 E1 F4
L_56F7:
    jmp    L_1059                                # 56F7: E9 5F B9
L_56FA:
    call   L_0F1D                                # 56FA: E8 20 B8
    cmp    al,0x95                               # 56FD: 3C 95
    je     L_5709                                # 56FF: 74 08
    call   L_2DF4                                # 5701: E8 F0 D6
    fnsave [bp+si]                               # 5704: DD 32
    shr    bl,0x5                                # 5706: C0 EB 05
L_5709:
    call   L_0F1D                                # 5709: E8 11 B8
    mov    al,0xff                               # 570C: B0 FF
    mov    ds:0x45,al                            # 570E: A2 45 00
    ret                                          # 5711: C3
L_5712:
    mov    al,ds:0x45                            # 5712: A0 45 00
    .byte 0x0A, 0xC0 # 5715
    je     L_56F7                                # 5717: 74 DE
    call   L_1F1F                                # 5719: E8 03 C8
...
L_577E:
    mov    BYTE PTR ds:0x65,0x0                  # 577E: C6 06 65 00 00
    mov    ax,ds:0x66                            # 5783: A1 66 00
    .byte 0x0B, 0xC0 # 5786
    je     L_57A2                                # 5788: 74 18
    push   dx                                    # 578A: 52
    cli                                          # 578B: FA
    test   BYTE PTR ds:0x65,0xff                 # 578C: F6 06 65 00 FF
    ...
    out    dx,al                                 # 5799: EE
L_579A:
    mov    WORD PTR ds:0x66,0x0                  # 579A: C7 06 66 00 00 00
    sti                                          # 57A0: FB
    pop    dx                                    # 57A1: 5A
L_57A2:
    ret                                          # 57A2: C3
...
L_5819:
    mov    dx,WORD PTR ds:0x66                   # 5819: 8B 16 66 00
    .byte 0x0A, 0xF2 # 581D
    je     L_5828                                # 581F: 74 07
    mov    BYTE PTR ds:0x65,0xff                 # 5821: C6 06 65 00 FF
    jmp    L_5819                                # 5826: EB F1
L_5828:
    ret                                          # 5828: C3
SOUNDS:
    call   L_1F0A                                # 5829: E8 DE C6
    cmp    dx,0x25                               # 582C: 83 FA 25
    jb     L_5843                                # 582F: 72 12
    push   dx                                    # 5831: 52
    call   L_2DF4                                # 5832: E8 BF D5
    sub    al,0xe8                               # 5835: 2C E8
...
L_5846:
    ...
    div    cx                                    # 584F: F7 F1
L_5851:
    test   BYTE PTR ds:0x65,0xff                 # 5851: F6 06 65 00 FF
...
L_5870:
    pop    dx                                    # 5870: 5A
    mov    WORD PTR ds:0x66,dx                   # 5871: 89 16 66 00
    mov    BYTE PTR ds:0x65,0x0                  # 5875: C6 06 65 00 00
    ret                                          # 587A: C3
...
L_5923:
    mov    bx,WORD PTR ds:0x4e9                  # 5923: 8B 1E E9 04
    add    bx,0x32                               # 5927: 83 C3 32
    ret                                          # 592A: C3
L_592B:
    mov    bx,WORD PTR ds:0x4e9                  # 592B: 8B 1E E9 04
...
L_5B42:
    ...
    mov    ah,0x3                                # 5B48: B4 03
    int    0x15                                  # 5B4A: CD 15
    ret                                          # 5B4C: C3
    .byte 0xBB, 0x53, 0x05, 0xB9, 0x11, 0x00, 0x53, 0xB4, 0x02, 0xCD, 0x15, 0x73 # 5B4D
    ...
    .byte 0xC3, 0xBB, 0x53, 0x05, 0xB9, 0x00, 0x01, 0xB4, 0x02, 0xCD, 0x15, 0x72 # 5C3D
...
L_5C7D:
    mov    BYTE PTR ds:0x5f,0x0                  # 5C7D: C6 06 5F 00 00
    push   bx                                    # 5C82: 53
    mov    WORD PTR ds:0x54d,bx                  # 5C83: 89 1E 4D 05
    mov    dx,WORD PTR ds:0x350                  # 5C87: 8B 16 50 03
    mov    WORD PTR ds:0x54b,dx                  # 5C8B: 89 16 4B 05
    mov    cx,WORD PTR ds:0x704                  # 5C8F: 8B 0E 04 07
    .byte 0x2B, 0xCB # 5C93
    mov    WORD PTR ds:0x549,cx                  # 5C95: 89 0E 49 05
    push   cx                                    # 5C99: 51
    push   dx                                    # 5C9A: 52
    call   L_5B42                                # 5C9B: E8 A4 FE
    pop    dx                                    # 5C9E: 5A
    pop    cx                                    # 5C9F: 59
    pop    bx                                    # 5CA0: 5B
    mov    al,ds:0x60                            # 5CA1: A0 60 00
    .byte 0x0A, 0xC0 # 5CA4
    push   es                                    # 5CA6: 06
    je     L_5CAB                                # 5CA7: 74 02
    mov    es,dx                                 # 5CA9: 8E C2
L_5CAB:
    mov    ah,0x3                                # 5CAB: B4 03
    int    0x15                                  # 5CAD: CD 15
    pop    es                                    # 5CAF: 07
...
L_5CE8:
    ...
    mov    dx,WORD PTR ds:0x350                  # 5CF5: 8B 16 50 03
L_5CF9:
    mov    es,dx                                 # 5CF9: 8E C2
L_5CFB:
    mov    ah,0x2                                # 5CFB: B4 02
    int    0x15                                  # 5CFD: CD 15
    pop    es                                    # 5CFF: 07
    ...
    mov    bx,WORD PTR ds:0x30                   # 5D06: 8B 1E 30 00
    .byte 0x03, 0xD9 # 5D0A
    inc    bx                                    # 5D0C: 43
    mov    WORD PTR ds:0x358,bx                  # 5D0D: 89 1E 58 03
L_5D11:
...
MOTOR:
    dec    bx                                    # 5D26: 4B
    call   L_0F1D                                # 5D27: E8 F3 B1
    jne    L_5D31                                # 5D2A: 75 05
    mov    al,ds:0x64                            # 5D2C: A0 64 00
    jmp    L_5D34                                # 5D2F: EB 03
L_5D31:
    call   L_1F1C                                # 5D31: E8 E8 C1
L_5D34:
    .byte 0x0A, 0xC0 # 5D34
...
L_5D48:
    stc                                          # 5D48: F9
    jmp    L_5D4C                                # 5D49: EB 01
L_5D4B:
    clc                                          # 5D4B: F8
L_5D4C:
    .byte 0x8B, 0xF3 # 5D4C
    pushf                                        # 5D4E: 9C
    mov    cx,WORD PTR ds:0x4a5                  # 5D4F: 8B 0E A5 04
    .byte 0x8A, 0xC3, 0x32, 0xC1 # 5D53
    mov    ds:0x4a7,al                           # 5D57: A2 A7 04
...
L_5D7F:
    ...
    jmp    L_7B6B                                # 5D89: E9 DF 1D
L_5D8C:
    add    ax,0x80                               # 5D8C: 05 80 00
L_5D8F:
    mov    ds:0x4a6,al                           # 5D8F: A2 A6 04
    mov    bx,0x4a5                              # 5D92: BB A5 04
    or     BYTE PTR [bx],0x80                    # 5D95: 80 0F 80
    .byte 0x8B, 0xDE, 0x32, 0xFF # 5D98
    or     bl,0x80                               # 5D9C: 80 CB 80
    ret                                          # 5D9F: C3
CALLS:
    mov    BYTE PTR ds:0x339,0x80                # 5DA0: C6 06 39 03 80
    call   L_376E                                # 5DA5: E8 C6 D9
    push   bx                                    # 5DA8: 53
    .byte 0x8B, 0xDA # 5DA9
    call   L_6498                                # 5DAB: E8 EA 06
    call   L_22B5                                # 5DAE: E8 04 C5
    mov    WORD PTR ds:0x45e,bx                  # 5DB1: 89 1E 5E 04
    mov    cl,0x20                               # 5DB5: B1 20
    call   L_2CD5                                # 5DB7: E8 1B CF
    pop    bx                                    # 5DBA: 5B
    call   L_0F1E                                # 5DBB: E8 60 B1
    je     L_5DD7                                # 5DBE: 74 17
    call   L_2DF4                                # 5DC0: E8 31 D0
    .byte 0x28 # 5DC3
L_5DC4:
    .byte 0xE8, 0xA7, 0xD9, 0x52, 0x8A, 0x07 # 5DC4
    cmp    al,0x2c                               # 5DCA: 3C 2C
    jne    L_5DD3                                # 5DCC: 75 05
    call   L_0F1D                                # 5DCE: E8 4C B1
    jmp    L_5DC4                                # 5DD1: EB F1
L_5DD3:
    call   L_2DF4                                # 5DD3: E8 1E D0
    .byte 0x29 # 5DD6
L_5DD7:
    .byte 0x89, 0x1E, 0x3B, 0x03, 0x0E, 0xB8, 0xE9, 0x5D # 5DD7
    push   ax                                    # 5DDF: 50
    push   WORD PTR ds:0x350                     # 5DE0: FF 36 50 03
    push   WORD PTR ds:0x45e                     # 5DE4: FF 36 5E 04
    retf                                         # 5DE8: CB
...
L_5F0E:
    push   bx                                    # 5F0E: 53
    call   L_7BA2                                # 5F0F: E8 90 1C
    pushf                                        # 5F12: 9C
    jae    L_5F18                                # 5F13: 73 03
    call   L_6B82                                # 5F15: E8 6A 0C
L_5F18:
    .byte 0x0B, 0xD2 # 5F18
...
L_5F2B:
    ...
    call   L_5F4E                                # 5F38: E8 13 00
    mov    dx,0xffda                             # 5F3B: BA DA FF
L_5F3E:
    call   L_5F4E                                # 5F3E: E8 0D 00
L_5F41:
    popf                                         # 5F41: 9D
    jae    L_5F47                                # 5F42: 73 03
    call   L_6B64                                # 5F44: E8 1D 0C
L_5F47:
    pop    bx                                    # 5F47: 5B
L_5F48:
    ret                                          # 5F48: C3
L_5F49:
    call   L_7B6B                                # 5F49: E8 1F 1C
...
L_5F55:
    ...
    add    dx,0x6032                             # 5F5A: 81 C2 32 60
    xchg   dx,bx                                 # 5F5E: 87 DA
    call   L_7C88                                # 5F60: E8 25 1D
    popf                                         # 5F63: 9D
    js     L_5F69                                # 5F64: 78 03
    jmp    L_6C55                                # 5F66: E9 EC 0C
L_5F69:
    call   L_7C58                                # 5F69: E8 EC 1C
...
L_5F8F:
    cmp    BYTE PTR ds:0x6a,0x0                  # 5F8F: 80 3E 6A 00 00
    je     L_5FA8                                # 5F94: 74 12
    push   ds                                    # 5F96: 1E
    push   bx                                    # 5F97: 53
    lds    bx,DWORD PTR ds:0x6b                  # 5F98: C5 1E 6B 00
    cmp    BYTE PTR [bx],0x0                     # 5F9C: 80 3F 00
    pop    bx                                    # 5F9F: 5B
    pop    ds                                    # 5FA0: 1F
    jne    L_5FA8                                # 5FA1: 75 05
    mov    BYTE PTR ds:0x6a,0x0                  # 5FA3: C6 06 6A 00 00
L_5FA8:
    jmp    L_0F1D                                # 5FA8: E9 72 AF
L_5FAB:
    pop    di                                    # 5FAB: 5F
    pop    si                                    # 5FAC: 5E
...
L_5FB0:
    ...
    pop    bx                                    # 5FB2: 5B
    mov    BYTE PTR ds:0x4a7,dh                  # 5FB3: 88 36 A7 04
    mov    bx,0x1000                             # 5FB7: BB 00 10
    mov    BYTE PTR ds:0x2fb,0x4                 # 5FBA: C6 06 FB 02 04
    jmp    L_74EA                                # 5FBF: E9 28 15
L_5FC2:
    mov    WORD PTR ds:0x4a5,0x0                 # 5FC2: C7 06 A5 04 00 00
    ret                                          # 5FC8: C3
    .byte 0x10, 0x5B, 0x88, 0x36, 0xA7, 0x04, 0xBB, 0x00, 0x10, 0xC6, 0x06, 0xFB # 5FC9
    .byte 0x02, 0x04, 0xE9, 0x10, 0x15, 0xC7, 0x06, 0xA5, 0x04, 0x00, 0x00, 0xC3 # 5FD5
    .byte 0x5C, 0xD6, 0xED, 0xBD, 0xCE, 0xFE, 0xE6, 0x5B, 0x5F, 0xA6, 0xB4, 0x36 # 5FE1
    .byte 0x41, 0x5F, 0x70, 0x09, 0x63, 0xCF, 0x61, 0x84, 0x11, 0x77, 0xCC, 0x2B # 5FED
    .byte 0x66, 0x43, 0x7A, 0xE5, 0xD5, 0x94, 0xBF, 0x56, 0x69, 0x6A, 0x6C, 0xAF # 5FF9
    .byte 0x05, 0xBD, 0x37, 0x06, 0x6D, 0x85, 0x47, 0x1B, 0x47, 0xAC, 0xC5, 0x27 # 6005
    .byte 0x70, 0x66, 0x19, 0xE2, 0x58, 0x17, 0xB7, 0x51, 0x73, 0xE0, 0x4F, 0x8D # 6011
    .byte 0x97, 0x6E, 0x12, 0x03, 0x77, 0xD8, 0xA3, 0x70, 0x3D, 0x0A, 0xD7, 0x23 # 601D
    .byte 0x7A, 0xCD, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x4C, 0x7D, 0x00, 0x00, 0x00 # 6029
    .byte 0x00, 0x00, 0x00, 0x00, 0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20 # 6035
    .byte 0x84, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x48, 0x87, 0x00, 0x00, 0x00 # 6041
    .byte 0x00, 0x00, 0x00, 0x7A, 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x1C # 604D
    .byte 0x8E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x43, 0x91, 0x00, 0x00, 0x00 # 6059
    .byte 0x00, 0x00, 0x24, 0x74, 0x94, 0x00, 0x00, 0x00, 0x00, 0x80, 0x96, 0x18 # 6065
    .byte 0x98, 0x00, 0x00, 0x00, 0x00, 0x20, 0xBC, 0x3E, 0x9B, 0x00, 0x00, 0x00 # 6071
    .byte 0x00, 0x28, 0x6B, 0x6E, 0x9E, 0x00, 0x00, 0x00, 0x00, 0xF9, 0x02, 0x15 # 607D
    .byte 0xA2, 0x00, 0x00, 0x00, 0x40, 0xB7, 0x43, 0x3A, 0xA5, 0x00, 0x00, 0x00 # 6089
    .byte 0x10, 0xA5, 0xD4, 0x68, 0xA8, 0x00, 0x00, 0x00, 0x2A, 0xE7, 0x84, 0x11 # 6095
    .byte 0xAC, 0x00, 0x00, 0x80, 0xF4, 0x20, 0xE6, 0x35, 0xAF, 0x00, 0x00, 0xA0 # 60A1
    .byte 0x31, 0xA9, 0x5F, 0x63, 0xB2, 0x00, 0x00, 0x04, 0xBF, 0xC9, 0x1B, 0x0E # 60AD
    .byte 0xB6, 0x00, 0x00, 0xC5, 0x2E, 0xBC, 0xA2, 0x31, 0xB9, 0x00, 0x40, 0x76 # 60B9
    .byte 0x3A, 0x6B, 0x0B, 0x5E, 0xBC, 0x00, 0xE8, 0x89, 0x04, 0x23, 0xC7, 0x0A # 60C5
    .byte 0xC0, 0x00, 0x62, 0xAC, 0xC5, 0xEB, 0x78, 0x2D, 0xC3, 0x80, 0x7A, 0x17 # 60D1
    .byte 0xB7, 0x26, 0xD7, 0x58, 0xC6, 0x90, 0xAC, 0x6E, 0x32, 0x78, 0x86, 0x07 # 60DD
    .byte 0xCA, 0xB5, 0x57, 0x0A, 0x3F, 0x16, 0x68, 0x29, 0xCD, 0xA2, 0xED, 0xCC # 60E9
    .byte 0xCE, 0x1B, 0xC2, 0x53, 0xD0, 0x85, 0x14, 0x40, 0x61, 0x51, 0x59, 0x04 # 60F5
    .byte 0xD4, 0xA6, 0x19, 0x90, 0xB9, 0xA5, 0x6F, 0x25, 0xD7, 0x10, 0x20, 0xF4 # 6101
    .byte 0x27, 0x8F, 0xCB, 0x4E, 0xDA, 0x0A, 0x94, 0xF8, 0x78, 0x39, 0x3F, 0x01 # 610D
    .byte 0xDE, 0x0C, 0xB9, 0x36, 0xD7, 0x07, 0x8F, 0x21, 0xE1, 0x4F, 0x67, 0x04 # 6119
    .byte 0xCD, 0xC9, 0xF2, 0x49, 0xE4, 0x23, 0x81, 0x45, 0x40, 0x7C, 0x6F, 0x7C # 6125
    .byte 0xE7, 0xB6, 0x70, 0x2B, 0xA8, 0xAD, 0xC5, 0x1D, 0xEB, 0xE4, 0x4C, 0x36 # 6131
    .byte 0x12, 0x19, 0x37, 0x45, 0xEE, 0x1C, 0xE0, 0xC3, 0x56, 0xDF, 0x84, 0x76 # 613D
    .byte 0xF1, 0x12, 0x6C, 0x3A, 0x96, 0x0B, 0x13, 0x1A, 0xF5, 0x16, 0x07, 0xC9 # 6149
    .byte 0x7B, 0xCE, 0x97, 0x40, 0xF8, 0xDC, 0x48, 0xBB, 0x1A, 0xC2, 0xBD, 0x70 # 6155
    .byte 0xFB, 0x89, 0x0D, 0xB5, 0x50, 0x99, 0x76, 0x16, 0xFF, 0x00, 0x00, 0x00 # 6161
    .byte 0x00, 0x00, 0x00, 0x00, 0x80, 0xF1, 0x04, 0x35, 0x80, 0x04, 0x9A, 0xF7 # 616D
    ...
    .byte 0x01, 0x00, 0x00, 0x00, 0x80, 0x90, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF # 61FD
...
TOKH_ERR:
    ...
    call   L_6CFF                                # 628A: E8 72 0A
    mov    al,ds:0x4a6                           # 628D: A0 A6 04
    cmp    al,0x88                               # 6290: 3C 88
    jae    L_62D0                                # 6292: 73 3C
    cmp    al,0x68                               # 6294: 3C 68
    jb     L_62E3                                # 6296: 72 4B
    push   WORD PTR ds:0x4a3                     # 6298: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 629C: FF 36 A5 04
    call   L_7303                                # 62A0: E8 60 10
    .byte 0x8A, 0xE2 # 62A3
    add    ah,0x81                               # 62A5: 80 C4 81
    je     L_62CD                                # 62A8: 74 23
    push   ax                                    # 62AA: 50
    test   BYTE PTR ds:0x4a7,0x80                # 62AB: F6 06 A7 04 80
    ...
    jmp    L_6CFF                                # 62CA: E9 32 0A
L_62CD:
    add    sp,0x4                                # 62CD: 83 C4 04
L_62D0:
    and    BYTE PTR ds:0x4a5,0x80                # 62D0: 80 26 A5 04 80
    je     L_62DA                                # 62D5: 74 03
    jmp    L_7B6B                                # 62D7: E9 91 18
L_62DA:
    .byte 0x32, 0xE4 # 62DA
    mov    BYTE PTR ds:0x4a7,ah                  # 62DC: 88 26 A7 04
...
L_6312:
    ...
    .byte 0x04, 0xC3 # 63F1
L_63F3:
    mov    dx,WORD PTR ds:0x4a3                  # 63F3: 8B 16 A3 04
    mov    cx,WORD PTR ds:0x4a5                  # 63F7: 8B 0E A5 04
    ret                                          # 63FB: C3
L_63FC:
    pushf                                        # 63FC: 9C
    push   bx                                    # 63FD: 53
    call   L_7E1A                                # 63FE: E8 19 1A
    pop    bx                                    # 6401: 5B
...
L_6407:
    ...
    mov    WORD PTR ds:0x4a3,bx                  # 640A: 89 1E A3 04
    jmp    L_6E78                                # 640E: E9 67 0A
L_6411:
    call   L_22B5                                # 6411: E8 A1 BE
    mov    WORD PTR ds:0x4a3,bx                  # 6414: 89 1E A3 04
...
L_6426:
    pop    si                                    # 6426: 5E
    push   WORD PTR ds:0x4a3                     # 6427: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 642B: FF 36 A5 04
    jmp    si                                    # 642F: FF E6
L_6431:
    int    0xc5                                  # 6431: CD C5
    xchg   cx,bx                                 # 6433: 87 D9
    call   L_7CD8                                # 6435: E8 A0 18
    xchg   cx,bx                                 # 6438: 87 D9
    ret                                          # 643A: C3
L_643B:
    call   L_7BA2                                # 643B: E8 64 17
...
L_646E:
    push   bx                                    # 646E: 53
    .byte 0x33, 0xDB # 646F
    mov    WORD PTR ds:0x4a3,bx                  # 6471: 89 1E A3 04
    mov    bh,0x81                               # 6475: B7 81
    mov    WORD PTR ds:0x4a5,bx                  # 6477: 89 1E A5 04
    mov    BYTE PTR ds:0x2fb,0x4                 # 647B: C6 06 FB 02 04
    call   TOKH_SPC                              # 6480: E8 04 14
    pop    bx                                    # 6483: 5B
    mov    BYTE PTR ds:0x2fb,0x4                 # 6484: C6 06 FB 02 04
    ret                                          # 6489: C3
L_648A:
    .byte 0x8B, 0xC1 # 648A
    mul    dx                                    # 648C: F7 E2
...
L_64A4:
    ...
    call   L_7BA2                                # 64A8: E8 F7 16
    jb     L_64B0                                # 64AB: 72 03
    mov    dx,0x49f                              # 64AD: BA 9F 04
L_64B0:
    ret                                          # 64B0: C3
L_64B1:
...
L_64DF:
    ...
    ret                                          # 64E2: C3
L_64E3:
    call   L_7BA2                                # 64E3: E8 BC 16
    jne    L_64EB                                # 64E6: 75 03
    jmp    L_07D6                                # 64E8: E9 EB A2
L_64EB:
    int    0xc8                                  # 64EB: CD C8
    js     L_64F2                                # 64ED: 78 03
    jmp    L_7B75                                # 64EF: E9 83 16
L_64F2:
    mov    ax,ds:0x4a3                           # 64F2: A1 A3 04
    .byte 0x0B, 0xC0 # 64F5
...
L_6509:
    ...
    .byte 0x8B, 0xD8 # 650A
L_650C:
    mov    BYTE PTR ds:0x2fb,0x2                 # 650C: C6 06 FB 02 02
    mov    WORD PTR ds:0x4a3,bx                  # 6511: 89 1E A3 04
    ret                                          # 6515: C3
L_6516:
    mov    BYTE PTR ds:0x2fb,0x4                 # 6516: C6 06 FB 02 04
    ret                                          # 651B: C3
TOKH_TAB:
...
L_6548:
    ...
    call   L_7B55                                # 654C: E8 06 16
    pop    bx                                    # 654F: 5B
L_6550:
    mov    cx,0x26b6                             # 6550: B9 B6 26
    push   cx                                    # 6553: 51
    call   L_650C                                # 6554: E8 B5 FF
    .byte 0x32, 0xC0 # 6557
    int    0xca                                  # 6559: CD CA
    mov    ds:0x331,al                           # 655B: A2 31 03
...
L_6584:
    int    0xcd                                  # 6584: CD CD
    xor    BYTE PTR ds:0x4a7,0x80                # 6586: 80 36 A7 04 80
    .byte 0x33, 0xDB # 658B
    neg    ch                                    # 658D: F6 DD
...
L_659B:
    ret                                          # 659B: C3
L_659C:
    call   L_7BA2                                # 659C: E8 03 16
    js     L_659B                                # 659F: 78 FA
    int    0xce                                  # 65A1: CD CE
    call   L_7B75                                # 65A3: E8 CF 15
    js     L_65AB                                # 65A6: 78 03
    jmp    TOKH_STEP                             # 65A8: E9 D5 18
L_65AB:
    call   L_7DB0                                # 65AB: E8 02 18
    call   TOKH_STEP                             # 65AE: E8 CF 18
    jmp    L_7DB0                                # 65B1: E9 FC 17
    .byte 0x8B, 0xC3 # 65B4
L_65B6:
    .byte 0x2B, 0xC2 # 65B6
    je     L_65C8                                # 65B8: 74 0E
    jo     L_65C3                                # 65BA: 70 07
    js     L_65C5                                # 65BC: 78 07
L_65BE:
    .byte 0x32, 0xC0 # 65BE
    inc    al                                    # 65C0: FE C0
    ret                                          # 65C2: C3
L_65C3:
    js     L_65BE                                # 65C3: 78 F9
L_65C5:
    stc                                          # 65C5: F9
    .byte 0x1A, 0xC0 # 65C6
L_65C8:
...
L_65C9:
    .byte 0x3B, 0xDA # 65C9
    jne    L_65D2                                # 65CB: 75 05
    .byte 0x33, 0xDB, 0xE9, 0x26, 0x00 # 65CD
L_65D2:
    .byte 0x8B, 0xC2 # 65D2
    mov    WORD PTR ds:0x4a3,bx                  # 65D4: 89 1E A3 04
    .byte 0x0B, 0xDB # 65D8
    ...
    mov    WORD PTR ds:0x4a5,0xffff              # 65E2: C7 06 A5 04 FF FF
L_65E8:
    .byte 0x0B, 0xC0 # 65E8
...
L_65F2:
    idiv   WORD PTR ds:0x4a3                     # 65F2: F7 3E A3 04
    .byte 0x8B, 0xDA # 65F6
L_65F8:
    mov    WORD PTR ds:0x4a3,bx                  # 65F8: 89 1E A3 04
    ret                                          # 65FC: C3
L_65FD:
    lods   ax,WORD PTR ds:[si]                   # 65FD: AD
    .byte 0x3A, 0xE1 # 65FE
    je     L_6613                                # 6600: 74 11
L_6602:
    inc    si                                    # 6602: 46
...
L_660A:
    .byte 0x3B, 0xF5 # 660A
    jne    L_65FD                                # 660C: 75 EF
    .byte 0x8B, 0xD6 # 660E
    jmp    L_384C                                # 6610: E9 39 D2
L_6613:
    cmp    al,BYTE PTR ds:0x2fb                  # 6613: 3A 06 FB 02
    jne    L_6602                                # 6617: 75 E9
    cmp    ch,BYTE PTR [si]                      # 6619: 3A 2C
    jne    L_6602                                # 661B: 75 E5
    inc    si                                    # 661D: 46
    .byte 0x8A, 0xD0 # 661E
    lods   al,BYTE PTR ds:[si]                   # 6620: AC
    cmp    al,BYTE PTR ds:0x8e                   # 6621: 3A 06 8E 00
    je     L_662B                                # 6625: 74 04
    .byte 0x02, 0xC2 # 6627
    jmp    L_6607                                # 6629: EB DC
L_662B:
    .byte 0x0A, 0xC0 # 662B
    je     L_663F                                # 662D: 74 10
    cbw                                          # 662F: 98
    xchg   cx,ax                                 # 6630: 91
    mov    di,0x8f                               # 6631: BF 8F 00
    repz cmps BYTE PTR ds:[si],BYTE PTR es:[di]  # 6634: F3 A6
    xchg   cx,ax                                 # 6636: 91
    je     L_663F                                # 6637: 74 06
    .byte 0x03, 0xF0, 0x8A, 0xC2 # 6639
    jmp    L_6607                                # 663D: EB C8
L_663F:
    .byte 0x8B, 0xD6 # 663F
    pop    bx                                    # 6641: 5B
    ret                                          # 6642: C3
L_6643:
    .byte 0x8B, 0xF3 # 6643
    mov    bp,WORD PTR ds:0x44b                  # 6645: 8B 2E 4B 04
    cld                                          # 6649: FC
    jmp    L_660A                                # 664A: EB BE
L_664C:
    .byte 0x8B, 0xF3 # 664C
    mov    bp,WORD PTR ds:0x35c                  # 664E: 8B 2E 5C 03
    cld                                          # 6652: FC
    .byte 0xE9, 0x0D, 0x00 # 6653
L_6656:
    lods   ax,WORD PTR ds:[si]                   # 6656: AD
    .byte 0x3A, 0xE1 # 6657
    je     L_666C                                # 6659: 74 11
L_665B:
    inc    si                                    # 665B: 46
...
L_6663:
    .byte 0x3B, 0xEE # 6663
    jne    L_6656                                # 6665: 75 EF
    .byte 0x8B, 0xDE # 6667
    jmp    L_39BF                                # 6669: E9 53 D3
L_666C:
    cmp    al,BYTE PTR ds:0x2fb                  # 666C: 3A 06 FB 02
    jne    L_665B                                # 6670: 75 E9
    cmp    ch,BYTE PTR [si]                      # 6672: 3A 2C
    jne    L_665B                                # 6674: 75 E5
    inc    si                                    # 6676: 46
    lods   al,BYTE PTR ds:[si]                   # 6677: AC
    cmp    al,BYTE PTR ds:0x8e                   # 6678: 3A 06 8E 00
    jne    L_665D                                # 667C: 75 DF
    .byte 0x0A, 0xC0 # 667E
    je     L_6690                                # 6680: 74 0E
    cbw                                          # 6682: 98
    xchg   cx,ax                                 # 6683: 91
    mov    di,0x8f                               # 6684: BF 8F 00
    repz cmps BYTE PTR ds:[si],BYTE PTR es:[di]  # 6687: F3 A6
    xchg   cx,ax                                 # 6689: 91
    je     L_6690                                # 668A: 74 04
    .byte 0x03, 0xF0 # 668C
    jmp    L_6660                                # 668E: EB D0
L_6690:
    lods   ax,WORD PTR ds:[si]                   # 6690: AD
    .byte 0x8B, 0xD0, 0x8B, 0xDE # 6691
    jmp    L_399D                                # 6695: E9 05 D3
L_6698:
    call   L_7CB3                                # 6698: E8 18 16
L_669B:
    ret                                          # 669B: C3
L_669C:
    mov    ax,ds:0x4a5                           # 669C: A1 A5 04
    .byte 0x0A, 0xE4 # 669F
    je     L_6698                                # 66A1: 74 F5
    xor    BYTE PTR ds:0x4a5,0x80                # 66A3: 80 36 A5 04 80
    int    0xd7                                  # 66A8: CD D7
L_66AA:
    mov    al,0x0                                # 66AA: B0 00
    mov    ds:0x49e,al                           # 66AC: A2 9E 04
    mov    ds:0x4aa,al                           # 66AF: A2 AA 04
    mov    al,ds:0x4b2                           # 66B2: A0 B2 04
    .byte 0x0A, 0xC0 # 66B5
    je     L_669B                                # 66B7: 74 E2
    mov    ax,ds:0x4a5                           # 66B9: A1 A5 04
    .byte 0x0A, 0xE4 # 66BC
    je     L_6698                                # 66BE: 74 D8
    mov    bx,WORD PTR ds:0x4b1                  # 66C0: 8B 1E B1 04
    or     BYTE PTR ds:0x4a5,0x80                # 66C4: 80 0E A5 04 80
    or     BYTE PTR ds:0x4b1,0x80                # 66C9: 80 0E B1 04 80
    .byte 0x8A, 0xCC, 0x2A, 0xCF # 66CE
    mov    ds:0x4a7,al                           # 66D2: A2 A7 04
    je     L_66F9                                # 66D5: 74 22
    jae    L_66EB                                # 66D7: 73 12
    xchg   bl,al                                 # 66D9: 86 C3
    neg    cl                                    # 66DB: F6 D9
    mov    ds:0x4a7,al                           # 66DD: A2 A7 04
    mov    BYTE PTR ds:0x4a6,bh                  # 66E0: 88 3E A6 04
    push   ax                                    # 66E4: 50
    push   cx                                    # 66E5: 51
    call   L_7C58                                # 66E6: E8 6F 15
    pop    cx                                    # 66E9: 59
    pop    ax                                    # 66EA: 58
L_66EB:
    ...
    mov    al,ds:0x4a7                           # 66F5: A0 A7 04
    pop    bx                                    # 66F8: 5B
L_66F9:
    .byte 0x32, 0xC3 # 66F9
    mov    bx,0x49e                              # 66FB: BB 9E 04
    mov    si,0x4aa                              # 66FE: BE AA 04
...
L_674F:
    mov    al,ds:0x4a7                           # 674F: A0 A7 04
    and    al,0x80                               # 6752: 24 80
    and    BYTE PTR ds:0x4a5,0x7f                # 6754: 80 26 A5 04 7F
    or     BYTE PTR ds:0x4a5,al                  # 6759: 08 06 A5 04
    ret                                          # 675D: C3
L_675E:
    mov    WORD PTR ds:0x4a5,bx                  # 675E: 89 1E A5 04
    mov    WORD PTR ds:0x4a3,dx                  # 6762: 89 16 A3 04
L_6766:
    ret                                          # 6766: C3
L_6767:
    mov    ax,ds:0x4a5                           # 6767: A1 A5 04
    .byte 0x0A, 0xE4 # 676A
    je     L_675E                                # 676C: 74 F0
    xor    BYTE PTR ds:0x4a5,0x80                # 676E: 80 36 A5 04 80
L_6773:
    .byte 0x0A, 0xFF # 6773
    je     L_6766                                # 6775: 74 EF
    mov    ax,ds:0x4a5                           # 6777: A1 A5 04
    .byte 0x0A, 0xE4 # 677A
    je     L_675E                                # 677C: 74 E0
    .byte 0x33, 0xC9 # 677E
    mov    si,WORD PTR ds:0x4a3                  # 6780: 8B 36 A3 04
    mov    ds:0x4a7,al                           # 6784: A2 A7 04
    .byte 0x8A, 0xCC, 0x2A, 0xCF # 6787
    jae    L_679A                                # 678B: 73 0D
    neg    cl                                    # 678D: F6 D9
    xchg   bh,bl                                 # 678F: 86 DF
    mov    WORD PTR ds:0x4a6,bx                  # 6791: 89 1E A6 04
...
L_67A9:
    ...
    popf                                         # 67B2: 9D
    mov    WORD PTR ds:0x4a3,si                  # 67B3: 89 36 A3 04
    mov    ah,BYTE PTR ds:0x4a7                  # 67B7: 8A 26 A7 04
    and    ax,0x807f                             # 67BB: 25 7F 80
    .byte 0x0A, 0xC4 # 67BE
    mov    ds:0x4a5,al                           # 67C0: A2 A5 04
    ret                                          # 67C3: C3
L_67C4:
...
L_67F3:
    ...
    not    BYTE PTR ds:0x4a7                     # 6804: F6 16 A7 04
    not    ah                                    # 6808: F6 D4
    not    dx                                    # 680A: F7 D2
    not    bl                                    # 680C: F6 D3
    inc    ah                                    # 680E: FE C4
...
L_6821:
    inc    BYTE PTR ds:0x4a6                     # 6821: FE 06 A6 04
...
L_6836:
    call   L_7B5E                                # 6836: E8 25 13
    ret                                          # 6839: C3
L_683A:
    mov    al,ds:0x4b1                           # 683A: A0 B1 04
    mov    ds:0x4a7,al                           # 683D: A2 A7 04
    jmp    L_74EA                                # 6840: E9 A7 0C
L_6843:
    test   BYTE PTR ds:0x4a6,0xff                # 6843: F6 06 A6 04 FF
    je     L_683A                                # 6848: 74 F0
    test   BYTE PTR ds:0x4b2,0xff                # 684A: F6 06 B2 04 FF
    je     L_6836                                # 684F: 74 E5
    mov    bx,WORD PTR ds:0x4b1                  # 6851: 8B 1E B1 04
    call   L_5D4B                                # 6855: E8 F3 F4
    mov    WORD PTR ds:0x4b1,bx                  # 6858: 89 1E B1 04
    ...
    push   WORD PTR ds:0x4a6                     # 686A: FF 36 A6 04
    call   L_7DCF                                # 686E: E8 5E 15
    pop    WORD PTR ds:0x4a6                     # 6871: 8F 06 A6 04
...
L_6883:
    ...
    mov    si,0x478                              # 6894: BE 78 04
    mov    cx,0x4                                # 6897: B9 04 00
    mov    bx,0x4aa                              # 689A: BB AA 04
    clc                                          # 689D: F8
    cld                                          # 689E: FC
L_689F:
...
L_68B8:
    ...
    stc                                          # 68BB: F9
L_68BC:
    mov    bx,0x49e                              # 68BC: BB 9E 04
    call   L_7BFA                                # 68BF: E8 38 13
    pop    cx                                    # 68C2: 59
    loop   L_687B                                # 68C3: E2 B6
    test   BYTE PTR ds:0x4a5,0x80                # 68C5: F6 06 A5 04 80
    je     L_68D5                                # 68CA: 74 09
    inc    WORD PTR ds:0x4a6                     # 68CC: FF 06 A6 04
    jne    L_68DB                                # 68D0: 75 09
    jmp    L_74DC                                # 68D2: E9 07 0C
L_68D5:
    mov    bx,0x49e                              # 68D5: BB 9E 04
    call   L_7BFA                                # 68D8: E8 1F 13
L_68DB:
    jmp    L_790F                                # 68DB: E9 31 10
L_68DE:
    call   L_7B75                                # 68DE: E8 94 12
    jne    L_68EA                                # 68E1: 75 07
    mov    BYTE PTR ds:0x4a7,bl                  # 68E3: 88 1E A7 04
    jmp    L_74EA                                # 68E7: E9 00 0C
L_68EA:
    .byte 0x0A, 0xFF # 68EA
    jne    L_68F1                                # 68EC: 75 03
    jmp    L_7B6B                                # 68EE: E9 7A 12
L_68F1:
    call   L_5D4B                                # 68F1: E8 57 F4
    .byte 0x8B, 0xFA, 0x33, 0xD2, 0x8A, 0xFE, 0x8B, 0xF3, 0x8A, 0xDF # 68F4
    mov    cx,0x20                               # 68FE: B9 20 00
    push   bp                                    # 6901: 55
    mov    bp,WORD PTR ds:0x4a3                  # 6902: 8B 2E A3 04
    mov    al,ds:0x4a5                           # 6906: A0 A5 04
    .byte 0x8A, 0xE7 # 6909
...
L_6922:
    ...
    inc    BYTE PTR ds:0x4a6                     # 692D: FE 06 A6 04
...
L_6947:
    ...
    push   ax                                    # 694E: 50
    call   L_7BA2                                # 694F: E8 50 12
    pop    ax                                    # 6952: 58
    cbw                                          # 6953: 98
    jns    L_6974                                # 6954: 79 1E
    mov    bx,WORD PTR ds:0x4a3                  # 6956: 8B 1E A3 04
    ...
    mov    WORD PTR ds:0x4a3,bx                  # 696E: 89 1E A3 04
...
L_6979:
    push   ax                                    # 6979: 50
    call   L_6BA1                                # 697A: E8 24 02
    jmp    L_6993                                # 697D: EB 14
L_697F:
    mov    WORD PTR ds:0x47c,0x2400              # 697F: C7 06 7C 04 00 24
    mov    WORD PTR ds:0x47e,0x9474              # 6985: C7 06 7E 04 74 94
    mov    bx,0x47e                              # 698B: BB 7E 04
    call   L_7D14                                # 698E: E8 83 13
    jns    L_69A9                                # 6991: 79 16
L_6993:
    call   L_7BD2                                # 6993: E8 3C 12
    pop    dx                                    # 6996: 5A
    push   WORD PTR ds:0x4a3                     # 6997: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 699B: FF 36 A5 04
    call   L_6C2D                                # 699F: E8 8B 02
    pop    bx                                    # 69A2: 5B
    pop    dx                                    # 69A3: 5A
...
L_69AC:
    call   L_7BD2                                # 69AC: E8 23 12
    call   L_7CA0                                # 69AF: E8 EE 12
    pop    dx                                    # 69B2: 5A
    call   L_6C2D                                # 69B3: E8 77 02
...
L_69C7:
    ...
    mov    BYTE PTR ds:0x2fb,0x8                 # 69CB: C6 06 FB 02 08
L_69D0:
    mov    BYTE PTR ds:0x4a8,0x1                 # 69D0: C6 06 A8 04 01
    mov    si,0x25b4                             # 69D5: BE B4 25
    push   si                                    # 69D8: 56
    .byte 0x33, 0xFF, 0x8B, 0xCF, 0x8B, 0xF7 # 69D9
    not    cx                                    # 69DF: F7 D1
    push   ax                                    # 69E1: 50
    call   L_7B6B                                # 69E2: E8 86 11
    pop    ax                                    # 69E5: 58
    .byte 0x0A, 0xC0 # 69E6
    jne    L_69EF                                # 69E8: 75 05
    mov    BYTE PTR ds:0x2fb,0x2                 # 69EA: C6 06 FB 02 02
L_69EF:
...
L_6A78:
    ...
    call   L_7DAB                                # 6A7B: E8 2D 13
    call   L_7BA2                                # 6A7E: E8 21 11
    jp     L_6A88                                # 6A81: 7A 05
    push   bx                                    # 6A83: 53
    call   L_7D74                                # 6A84: E8 ED 12
    pop    bx                                    # 6A87: 5B
L_6A88:
    ret                                          # 6A88: C3
L_6A89:
...
L_6A8C:
    mov    BYTE PTR ds:0x455,0xff                # 6A8C: C6 06 55 04 FF
    call   L_0F1D                                # 6A91: E8 89 A4
    .byte 0x8B, 0xD4 # 6A94
    jmp    L_737C                                # 6A96: E9 E3 08
L_6A99:
    .byte 0x0A, 0xFF # 6A99
    jne    L_6AA2                                # 6A9B: 75 05
    call   L_7B88                                # 6A9D: E8 E8 10
    stc                                          # 6AA0: F9
    ret                                          # 6AA1: C3
L_6AA2:
    mov    al,ds:0x4a6                           # 6AA2: A0 A6 04
    .byte 0x0A, 0xC0 # 6AA5
    jne    L_6AB1                                # 6AA7: 75 08
    .byte 0x8A, 0xC3 # 6AA9
    not    al                                    # 6AAB: F6 D0
    call   L_7B94                                # 6AAD: E8 E4 10
    stc                                          # 6AB0: F9
L_6AB1:
    ret                                          # 6AB1: C3
L_6AB2:
    call   L_6A99                                # 6AB2: E8 E4 FF
    pop    bp                                    # 6AB5: 5D
    jb     L_6ACC                                # 6AB6: 72 14
    jmp    L_6ACA                                # 6AB8: EB 10
L_6ABA:
    push   bx                                    # 6ABA: 53
    mov    bx,WORD PTR [bx]                      # 6ABB: 8B 1F
    call   L_6A99                                # 6ABD: E8 D9 FF
    pop    bx                                    # 6AC0: 5B
    pop    bp                                    # 6AC1: 5D
    jb     L_6ACC                                # 6AC2: 72 08
    push   bx                                    # 6AC4: 53
    push   di                                    # 6AC5: 57
    mov    di,0x4a5                              # 6AC6: BF A5 04
    nop                                          # 6AC9: 90
L_6ACA:
    push   bp                                    # 6ACA: 55
    ret                                          # 6ACB: C3
...
L_6B51:
    call   L_7BA2                                # 6B51: E8 4E 10
    jnp    L_6BAC                                # 6B54: 7B 56
    jne    L_6B5B                                # 6B56: 75 03
    jmp    L_07D6                                # 6B58: E9 7B 9C
L_6B5B:
    int    0xcf                                  # 6B5B: CD CF
    jns    L_6B64                                # 6B5D: 79 05
    call   L_6BA1                                # 6B5F: E8 3F 00
    jmp    L_6BAC                                # 6B62: EB 48
L_6B64:
    mov    al,0x4                                # 6B64: B0 04
    mov    ds:0x2fb,al                           # 6B66: A2 FB 02
    mov    bl,BYTE PTR ds:0x4a5                  # 6B69: 8A 1E A5 04
    mov    BYTE PTR ds:0x4a7,bl                  # 6B6D: 88 1E A7 04
    mov    dx,WORD PTR ds:0x4a3                  # 6B71: 8B 16 A3 04
    mov    ah,BYTE PTR ds:0x4a2                  # 6B75: 8A 26 A2 04
    or     ah,0x40                               # 6B79: 80 CC 40
    or     bl,0x80                               # 6B7C: 80 CB 80
    jmp    L_7957                                # 6B7F: E9 D5 0D
L_6B82:
    call   L_7BA2                                # 6B82: E8 1D 10
...
L_6B8C:
    ...
    call   L_6BA1                                # 6B90: E8 0E 00
L_6B93:
    mov    al,0x8                                # 6B93: B0 08
    mov    ds:0x2fb,al                           # 6B95: A2 FB 02
    .byte 0x33, 0xC0 # 6B98
    mov    ds:0x49f,ax                           # 6B9A: A3 9F 04
    mov    ds:0x4a1,ax                           # 6B9D: A3 A1 04
    ret                                          # 6BA0: C3
L_6BA1:
    push   dx                                    # 6BA1: 52
    push   si                                    # 6BA2: 56
    mov    dx,WORD PTR ds:0x4a3                  # 6BA3: 8B 16 A3 04
    call   L_6C2D                                # 6BA7: E8 83 00
    pop    si                                    # 6BAA: 5E
    pop    dx                                    # 6BAB: 5A
L_6BAC:
    ret                                          # 6BAC: C3
L_6BAD:
    call   L_7BA2                                # 6BAD: E8 F2 0F
    jns    L_6BB7                                # 6BB0: 79 05
    mov    bx,WORD PTR ds:0x4a3                  # 6BB2: 8B 1E A3 04
    ret                                          # 6BB6: C3
L_6BB7:
    int    0xd1                                  # 6BB7: CD D1
...
L_6C19:
    ...
    neg    bx                                    # 6C21: F7 DB
L_6C23:
    mov    WORD PTR ds:0x4a3,bx                  # 6C23: 89 1E A3 04
    mov    BYTE PTR ds:0x2fb,0x2                 # 6C27: C6 06 FB 02 02
    ret                                          # 6C2C: C3
L_6C2D:
    .byte 0x33, 0xDB, 0x32, 0xE4 # 6C2D
    mov    si,0x4a7                              # 6C31: BE A7 04
...
L_6C45:
    ...
    mov    BYTE PTR ds:0x2fb,0x4                 # 6C4B: C6 06 FB 02 04
    jmp    L_749E                                # 6C50: E9 4B 08
    .byte 0xCD, 0xD6 # 6C53
L_6C55:
    mov    al,ds:0x4a6                           # 6C55: A0 A6 04
    .byte 0x0A, 0xC0 # 6C58
    je     L_6C66                                # 6C5A: 74 0A
    mov    al,ds:0x4b2                           # 6C5C: A0 B2 04
    .byte 0x0A, 0xC0 # 6C5F
    jne    L_6C67                                # 6C61: 75 04
    jmp    L_7B5E                                # 6C63: E9 F8 0E
L_6C66:
    ret                                          # 6C66: C3
L_6C67:
    mov    bx,WORD PTR ds:0x4b1                  # 6C67: 8B 1E B1 04
    call   L_5D48                                # 6C6B: E8 DA F0
    push   WORD PTR ds:0x4a6                     # 6C6E: FF 36 A6 04
    mov    WORD PTR ds:0x4b1,bx                  # 6C72: 89 1E B1 04
    call   L_7DCF                                # 6C76: E8 56 11
    .byte 0x8B, 0xF0 # 6C79
    mov    ds:0x4a6,ax                           # 6C7B: A3 A6 04
    mov    bx,0x478                              # 6C7E: BB 78 04
    mov    ds:0x4b2,ax                           # 6C81: A3 B2 04
    mov    bp,0x4ab                              # 6C84: BD AB 04
L_6C87:
...
L_6CD0:
    ...
    or     BYTE PTR ds:0x49e,0x20                # 6CD7: 80 0E 9E 04 20
L_6CDC:
    mov    al,ds:0x4a5                           # 6CDC: A0 A5 04
    .byte 0x0A, 0xC0 # 6CDF
    pop    WORD PTR ds:0x4a6                     # 6CE1: 8F 06 A6 04
    js     L_6CF6                                # 6CE5: 78 0F
    mov    bx,0x49e                              # 6CE7: BB 9E 04
...
L_6CF6:
    inc    BYTE PTR ds:0x4a6                     # 6CF6: FE 06 A6 04
    jne    L_6CF3                                # 6CFA: 75 F7
    jmp    L_74DC                                # 6CFC: E9 DD 07
L_6CFF:
    call   L_7B75                                # 6CFF: E8 73 0E
    je     L_6D08                                # 6D02: 74 04
    .byte 0x0A, 0xFF # 6D04
    jne    L_6D0B                                # 6D06: 75 03
L_6D08:
    jmp    L_7B6B                                # 6D08: E9 60 0E
L_6D0B:
    call   L_5D48                                # 6D0B: E8 3A F0
    mov    cx,WORD PTR ds:0x4a5                  # 6D0E: 8B 0E A5 04
    .byte 0x32, 0xED # 6D12
    mov    ax,ds:0x4a3                           # 6D14: A1 A3 04
    .byte 0x8A, 0xFD # 6D17
    push   bx                                    # 6D19: 53
    push   cx                                    # 6D1A: 51
    push   dx                                    # 6D1B: 52
...
L_6D35:
    ...
    rcr    bx,1                                  # 6D3F: D1 DB
    rcr    cx,1                                  # 6D41: D1 D9
    inc    BYTE PTR ds:0x4a6                     # 6D43: FE 06 A6 04
    jne    L_6D4C                                # 6D47: 75 03
    jmp    L_74DC                                # 6D49: E9 90 07
L_6D4C:
    .byte 0x0A, 0xFF # 6D4C
    jns    L_6D59                                # 6D4E: 79 09
    inc    BYTE PTR ds:0x4a6                     # 6D50: FE 06 A6 04
...
L_6E12:
    ...
    mov    WORD PTR ds:0x352,bx                  # 6E16: 89 1E 52 03
...
L_6E2C:
    ...
    mov    WORD PTR ds:0x352,bx                  # 6E31: 89 1E 52 03
    inc    bx                                    # 6E35: 43
    .byte 0x33, 0xC9 # 6E36
...
L_6E44:
    mov    WORD PTR ds:0x481,cx                  # 6E44: 89 0E 81 04
    ret                                          # 6E48: C3
L_6E49:
...
L_6E4E:
    ...
    inc    bp                                    # 6E56: 45
    inc    bp                                    # 6E57: 45
    mov    si,WORD PTR ds:0x4a3                  # 6E58: 8B 36 A3 04
...
L_6E5E:
    ...
    inc    bx                                    # 6E68: 43
    mov    WORD PTR ds:0x4a3,si                  # 6E69: 89 36 A3 04
    dec    ah                                    # 6E6D: FE CC
...
L_6E86:
    ...
    mov    dx,WORD PTR ds:0x4a3                  # 6E8D: 8B 16 A3 04
    push   si                                    # 6E91: 56
L_6E92:
...
L_6EB5:
    ret                                          # 6EB5: C3
L_6EB6:
    call   L_7BA2                                # 6EB6: E8 E9 0C
    jnp    L_6F32                                # 6EB9: 7B 77
    push   cx                                    # 6EBB: 51
    push   bx                                    # 6EBC: 53
    mov    si,0x49f                              # 6EBD: BE 9F 04
    mov    di,0x4ab                              # 6EC0: BF AB 04
    mov    cx,0x4                                # 6EC3: B9 04 00
    cld                                          # 6EC6: FC
    rep movs WORD PTR es:[di],WORD PTR ds:[si]   # 6EC7: F3 A5
    call   L_7241                                # 6EC9: E8 75 03
    push   bx                                    # 6ECC: 53
    mov    bx,0x4b1                              # 6ECD: BB B1 04
    call   L_7CD0                                # 6ED0: E8 FD 0D
    pop    bx                                    # 6ED3: 5B
    mov    si,0x4ab                              # 6ED4: BE AB 04
    mov    di,0x49f                              # 6ED7: BF 9F 04
    mov    cx,0x4                                # 6EDA: B9 04 00
    cld                                          # 6EDD: FC
    rep movs WORD PTR es:[di],WORD PTR ds:[si]   # 6EDE: F3 A5
    je     L_6EE5                                # 6EE0: 74 03
    call   L_7BB3                                # 6EE2: E8 CE 0C
L_6EE5:
    mov    cl,BYTE PTR ds:0x4a6                  # 6EE5: 8A 0E A6 04
...
L_6F32:
    push   bx                                    # 6F32: 53
    push   cx                                    # 6F33: 51
    call   L_7E4F                                # 6F34: E8 18 0F
    call   L_72AB                                # 6F37: E8 71 03
    pop    dx                                    # 6F3A: 5A
    pop    bx                                    # 6F3B: 5B
    call   L_7CD8                                # 6F3C: E8 99 0D
    je     L_6F4C                                # 6F3F: 74 0B
    mov    WORD PTR ds:0x4a5,bx                  # 6F41: 89 1E A5 04
    mov    WORD PTR ds:0x4a3,dx                  # 6F45: 89 16 A3 04
    call   L_7BBF                                # 6F49: E8 73 0C
L_6F4C:
    mov    al,0x1                                # 6F4C: B0 01
    call   L_7303                                # 6F4E: E8 B2 03
    mov    WORD PTR ds:0x4a5,bx                  # 6F51: 89 1E A5 04
    mov    WORD PTR ds:0x4a3,dx                  # 6F55: 89 16 A3 04
    pop    cx                                    # 6F59: 59
    pop    bx                                    # 6F5A: 5B
L_6F5B:
...
L_6FDE:
    ...
    call   L_7C6C                                # 6FE1: E8 88 0C
    call   L_7D14                                # 6FE4: E8 2D 0D
    jae    L_6FEF                                # 6FE7: 73 06
    call   L_7BD2                                # 6FE9: E8 E6 0B
    pop    di                                    # 6FEC: 5F
    dec    di                                    # 6FED: 4F
    push   di                                    # 6FEE: 57
L_6FEF:
    call   L_7BA2                                # 6FEF: E8 B0 0B
    jb     L_7013                                # 6FF2: 72 1F
    mov    bx,0x607a                             # 6FF4: BB 7A 60
    call   L_7C88                                # 6FF7: E8 8E 0C
    call   L_6C55                                # 6FFA: E8 58 FC
    pop    ax                                    # 6FFD: 58
    sub    al,0x9                                # 6FFE: 2C 09
    push   ax                                    # 7000: 50
    mov    bx,0x7ff6                             # 7001: BB F6 7F
    call   L_7C74                                # 7004: E8 6D 0C
    call   L_7D61                                # 7007: E8 57 0D
    jbe    L_7013                                # 700A: 76 07
    call   L_7BC8                                # 700C: E8 B9 0B
    pop    ax                                    # 700F: 58
    inc    al                                    # 7010: FE C0
    push   ax                                    # 7012: 50
L_7013:
...
L_701F:
    ...
    mov    ah,BYTE PTR ds:0x483                  # 7026: 8A 26 83 04
...
L_7079:
    mov    ah,BYTE PTR ds:0x483                  # 7079: 8A 26 83 04
...
L_70CA:
    ...
    ret                                          # 70D6: C3
L_70D7:
    call   L_7BA2                                # 70D7: E8 C8 0A
    jns    L_70EE                                # 70DA: 79 12
    mov    cx,0x700                              # 70DC: B9 00 07
    .byte 0x33, 0xC0 # 70DF
    mov    ds:0x483,ax                           # 70E1: A3 83 04
    mov    WORD PTR ds:0x481,cx                  # 70E4: 89 0E 81 04
    call   L_6E49                                # 70E8: E8 5E FD
    jmp    L_701F                                # 70EB: E9 31 FF
L_70EE:
    jmp    L_6D69                                # 70EE: E9 78 FC
TOKH_FN:
    call   L_7B75                                # 70F1: E8 81 0A
    jns    L_70F9                                # 70F4: 79 03
    jmp    L_1059                                # 70F6: E9 60 9F
L_70F9:
    jne    L_70FC                                # 70F9: 75 01
    ret                                          # 70FB: C3
L_70FC:
    mov    al,ds:0x4a6                           # 70FC: A0 A6 04
    shr    al,1                                  # 70FF: D0 E8
    push   ax                                    # 7101: 50
    mov    BYTE PTR ds:0x4a6,0x40                # 7102: C6 06 A6 04 40
    rcl    BYTE PTR ds:0x4a6,1                   # 7107: D0 16 A6 04
    mov    bx,0x4ab                              # 710B: BB AB 04
    call   L_7E1A                                # 710E: E8 09 0D
    mov    cx,0x4                                # 7111: B9 04 00
L_7114:
    push   cx                                    # 7114: 51
    call   L_7E4F                                # 7115: E8 37 0D
    mov    dx,WORD PTR ds:0x4ab                  # 7118: 8B 16 AB 04
    mov    bx,WORD PTR ds:0x4ad                  # 711C: 8B 1E AD 04
    call   L_68DE                                # 7120: E8 BB F7
    pop    dx                                    # 7123: 5A
    pop    bx                                    # 7124: 5B
    call   L_6773                                # 7125: E8 4B F6
    dec    BYTE PTR ds:0x4a6                     # 7128: FE 0E A6 04
    pop    cx                                    # 712C: 59
    je     L_7139                                # 712D: 74 0A
    loop   L_7114                                # 712F: E2 E3
    pop    ax                                    # 7131: 58
    add    al,0xc0                               # 7132: 04 C0
    add    BYTE PTR ds:0x4a6,al                  # 7134: 00 06 A6 04
    ret                                          # 7138: C3
L_7139:
    jmp    L_7B6B                                # 7139: E9 2F 0A
...
L_7241:
    mov    cl,BYTE PTR ds:0x4a6                  # 7241: 8A 0E A6 04
...
L_7278:
    mov    BYTE PTR ds:0x49e,0x0                 # 7278: C6 06 9E 04 00
    popf                                         # 727D: 9D
...
L_72A9:
    ...
    ret                                          # 72AA: C3
L_72AB:
    mov    cl,BYTE PTR ds:0x4a6                  # 72AB: 8A 0E A6 04
    sub    cl,0x98                               # 72AF: 80 E9 98
    jae    L_72F5                                # 72B2: 73 41
    neg    cl                                    # 72B4: F6 D9
L_72B6:
    pushf                                        # 72B6: 9C
    mov    dx,WORD PTR ds:0x4a3                  # 72B7: 8B 16 A3 04
    mov    bx,WORD PTR ds:0x4a5                  # 72BB: 8B 1E A5 04
    .byte 0x0A, 0xDB # 72BF
    pushf                                        # 72C1: 9C
    mov    BYTE PTR ds:0x4a7,bl                  # 72C2: 88 1E A7 04
    mov    BYTE PTR ds:0x4a6,0x98                # 72C6: C6 06 A6 04 98
...
L_7303:
    ...
    sub    cl,BYTE PTR ds:0x4a6                  # 7305: 2A 0E A6 04
    clc                                          # 7309: F8
    jmp    L_72B6                                # 730A: EB AA
TOKH_ERL:
    call   L_7B75                                # 730C: E8 66 08
    jle    L_7362                                # 730F: 7E 51
    mov    dx,0x0                                # 7311: BA 00 00
    mov    bx,0x8100                             # 7314: BB 00 81
    call   L_7CD8                                # 7317: E8 BE 09
    jne    L_7325                                # 731A: 75 09
    mov    WORD PTR ds:0x4a3,dx                  # 731C: 89 16 A3 04
    mov    WORD PTR ds:0x4a5,dx                  # 7320: 89 16 A5 04
    ret                                          # 7324: C3
L_7325:
    mov    al,ds:0x4a6                           # 7325: A0 A6 04
    sub    al,0x80                               # 7328: 2C 80
    cbw                                          # 732A: 98
    push   ax                                    # 732B: 50
    mov    BYTE PTR ds:0x4a6,0x80                # 732C: C6 06 A6 04 80
    call   L_7E4F                                # 7331: E8 1B 0B
    mov    bx,0x6176                             # 7334: BB 76 61
    call   L_7552                                # 7337: E8 18 02
    pop    dx                                    # 733A: 5A
    pop    bx                                    # 733B: 5B
    call   L_7E4F                                # 733C: E8 10 0B
    call   L_7CBE                                # 733F: E8 7C 09
    ...
    pop    dx                                    # 734D: 5A
    call   L_7E4F                                # 734E: E8 FE 0A
    call   L_6C2D                                # 7351: E8 D9 F8
    pop    dx                                    # 7354: 5A
    pop    bx                                    # 7355: 5B
    call   L_6773                                # 7356: E8 1A F4
    mov    bx,0x8031                             # 7359: BB 31 80
    mov    dx,0x7218                             # 735C: BA 18 72
    jmp    L_6CFF                                # 735F: E9 9D F9
L_7362:
    jmp    L_1059                                # 7362: E9 F4 9C
L_7365:
...
L_7370:
    .byte 0x32, 0xC0 # 7370
L_7372:
    mov    ds:0x455,al                           # 7372: A2 55 04
    pop    ax                                    # 7375: 58
    xchg   ah,al                                 # 7376: 86 C4
    sahf                                         # 7378: 9E
    mov    dx,0x0                                # 7379: BA 00 00
L_737C:
    mov    WORD PTR ds:0x453,bx                  # 737C: 89 1E 53 04
    je     L_7385                                # 7380: 74 03
    call   L_376E                                # 7382: E8 E9 C3
L_7385:
    mov    WORD PTR ds:0x33b,bx                  # 7385: 89 1E 3B 03
    call   CODE_BODY_START                       # 7389: E8 AC 93
    jne    L_7365                                # 738C: 75 D7
    .byte 0x8B, 0xE3 # 738E
    mov    si,WORD PTR ds:0x453                  # 7390: 8B 36 53 04
    ...
    push   si                                    # 73B5: 56
    push   bx                                    # 73B6: 53
    test   BYTE PTR ds:0x455,0xff                # 73B7: F6 06 55 04 FF
...
L_73EA:
    ...
    test   BYTE PTR ds:0x455,0xff                # 73F4: F6 06 55 04 FF
    jne    L_7401                                # 73F9: 75 06
    mov    dx,WORD PTR ds:0x456                  # 73FB: 8B 16 56 04
...
L_7411:
    ...
    mov    WORD PTR ds:0x2e,dx                   # 741A: 89 16 2E 00
    .byte 0x8B, 0xD1 # 741E
    xchg   bx,dx                                 # 7420: 87 D3
    jmp    L_0EA1                                # 7422: E9 7C 9A
L_7425:
    .byte 0x8B, 0xE3 # 7425
    mov    WORD PTR ds:0x345,bx                  # 7427: 89 1E 45 03
    mov    bx,WORD PTR ds:0x33b                  # 742B: 8B 1E 3B 03
...
L_7440:
    ...
    mov    bx,0x49e                              # 7447: BB 9E 04
L_744A:
    mov    di,0x4a5                              # 744A: BF A5 04
...
L_746B:
    ...
    and    BYTE PTR ds:0x49e,0x20                # 7485: 80 26 9E 04 20
...
L_749B:
    jmp    L_7B5E                                # 749B: E9 C0 06
L_749E:
    mov    bh,BYTE PTR ds:0x4a6                  # 749E: 8A 3E A6 04
...
L_74C7:
    jmp    L_7B6B                                # 74C7: E9 A1 06
L_74CA:
    mov    BYTE PTR ds:0x4a6,bh                  # 74CA: 88 3E A6 04
...
L_74F6:
    cmp    BYTE PTR ds:0x4a8,0x1                 # 74F6: 80 3E A8 04 01
    js     L_7504                                # 74FB: 78 07
    jne    L_7511                                # 74FD: 75 12
    mov    BYTE PTR ds:0x4a8,0x2                 # 74FF: C6 06 A8 04 02
L_7504:
...
L_7512:
    ...
    test   BYTE PTR ds:0x4a7,0x80                # 751A: F6 06 A7 04 80
    jns    L_7524                                # 751F: 79 03
    mov    si,0x620b                             # 7521: BE 0B 62
L_7524:
    call   L_7BA2                                # 7524: E8 7B 06
    jb     L_7531                                # 7527: 72 08
    mov    di,0x49f                              # 7529: BF 9F 04
...
L_753A:
    ...
    ret                                          # 753E: C3
L_753F:
    call   L_7E4F                                # 753F: E8 0D 09
    push   bx                                    # 7542: 53
    call   L_7CC7                                # 7543: E8 81 07
    call   L_6CFF                                # 7546: E8 B6 F7
    pop    bx                                    # 7549: 5B
    call   L_7552                                # 754A: E8 05 00
    pop    dx                                    # 754D: 5A
    pop    bx                                    # 754E: 5B
    jmp    L_6CFF                                # 754F: E9 AD F7
L_7552:
    mov    al,BYTE PTR cs:[bx]                   # 7552: 2E 8A 07
    cbw                                          # 7555: 98
    call   L_7E4F                                # 7556: E8 F6 08
    push   ax                                    # 7559: 50
    inc    bx                                    # 755A: 43
    mov    ax,WORD PTR cs:[bx]                   # 755B: 2E 8B 07
    mov    ds:0x4a3,ax                           # 755E: A3 A3 04
    add    bx,0x2                                # 7561: 83 C3 02
    mov    ax,WORD PTR cs:[bx]                   # 7564: 2E 8B 07
    mov    ds:0x4a5,ax                           # 7567: A3 A5 04
...
L_7598:
    ...
    call   L_7C74                                # 759B: E8 D6 06
    call   L_7CD0                                # 759E: E8 2F 07
...
L_75BD:
    ...
    sub    al,BYTE PTR ds:0x482                  # 75C4: 2A 06 82 04
...
L_75CF:
    ...
    push   WORD PTR ds:0x481                     # 75D4: FF 36 81 04
    push   dx                                    # 75D8: 52
    call   L_6EB6                                # 75D9: E8 DA F8
    pop    dx                                    # 75DC: 5A
    pop    WORD PTR ds:0x481                     # 75DD: 8F 06 81 04
    push   WORD PTR ds:0x481                     # 75E1: FF 36 81 04
    .byte 0x32, 0xC0, 0x0A, 0xC2 # 75E5
    je     L_75F1                                # 75E9: 74 06
    call   L_70A1                                # 75EB: E8 B3 FA
    call   L_6E2A                                # 75EE: E8 39 F8
L_75F1:
    pop    WORD PTR ds:0x481                     # 75F1: 8F 06 81 04
    push   WORD PTR ds:0x481                     # 75F5: FF 36 81 04
    mov    al,ds:0x481                           # 75F9: A0 81 04
    jmp    L_7871                                # 75FC: E9 72 02
L_75FF:
    .byte 0x8A, 0xD0 # 75FF
    mov    al,ds:0x481                           # 7601: A0 81 04
    .byte 0x0A, 0xC0 # 7604
...
L_7629:
    ...
    mov    al,ds:0x482                           # 7631: A0 82 04
    call   L_7091                                # 7634: E8 5A FA
    mov    BYTE PTR [bx],0x2e                    # 7637: C6 07 2E
    mov    WORD PTR ds:0x352,bx                  # 763A: 89 1E 52 03
    inc    bx                                    # 763E: 43
    .byte 0x32, 0xC9, 0x8A, 0xC6, 0x2A, 0xC5 # 763F
    jmp    L_7FE9                                # 7645: E9 A1 09
L_7648:
    mov    al,ds:0x482                           # 7648: A0 82 04
    push   dx                                    # 764B: 52
    push   WORD PTR ds:0x481                     # 764C: FF 36 81 04
...
L_765E:
    push   WORD PTR ds:0x481                     # 765E: FF 36 81 04
    call   L_6EB6                                # 7662: E8 51 F8
    mov    al,ds:0x482                           # 7665: A0 82 04
    pop    WORD PTR ds:0x481                     # 7668: 8F 06 81 04
    .byte 0x0A, 0xC0 # 766C
    pop    ax                                    # 766E: 58
    pop    dx                                    # 766F: 5A
    jne    L_7679                                # 7670: 75 07
    mov    bx,WORD PTR ds:0x352                  # 7672: 8B 1E 52 03
...
L_76BA:
    pushf                                        # 76BA: 9C
    push   ax                                    # 76BB: 50
    mov    dx,WORD PTR ds:0x481                  # 76BC: 8B 16 81 04
    .byte 0x0A, 0xF6 # 76C0
    pushf                                        # 76C2: 9C
    .byte 0x0A, 0xD2 # 76C3
...
L_76C9:
    ...
    test   BYTE PTR ds:0x483,0x4                 # 76CE: F6 06 83 04 04
...
L_76E3:
    push   ax                                    # 76E3: 50
    call   L_7BC8                                # 76E4: E8 E1 04
    pop    ax                                    # 76E7: 58
    inc    ah                                    # 76E8: FE C4
    jne    L_76E3                                # 76EA: 75 F7
    call   L_7BAE                                # 76EC: E8 BF 04
    call   TOKH_STEP                             # 76EF: E8 8E 07
    pop    ax                                    # 76F2: 58
    push   ax                                    # 76F3: 50
    mov    cx,0x3                                # 76F4: B9 03 00
    shl    ah,cl                                 # 76F7: D2 E4
    call   L_7BA2                                # 76F9: E8 A6 04
    jb     L_770E                                # 76FC: 72 10
    .byte 0x8A, 0xC4 # 76FE
    cbw                                          # 7700: 98
    mov    bx,0x60b2                             # 7701: BB B2 60
    .byte 0x03, 0xD8 # 7704
    call   L_7C74                                # 7706: E8 6B 05
    call   L_7D61                                # 7709: E8 55 06
...
L_770E:
    ...
    cbw                                          # 7713: 98
    .byte 0x03, 0xD8 # 7714
    call   L_7C6C                                # 7716: E8 53 05
    call   L_7D14                                # 7719: E8 F8 05
L_771C:
    pop    ax                                    # 771C: 58
    pop    bx                                    # 771D: 5B
...
L_7731:
    neg    ah                                    # 7731: F6 DC
    mov    al,ds:0x482                           # 7733: A0 82 04
    .byte 0x02, 0xE0 # 7736
    inc    ah                                    # 7738: FE C4
    .byte 0x0A, 0xC0 # 773A
    je     L_7747                                # 773C: 74 09
    test   BYTE PTR ds:0x483,0x4                 # 773E: F6 06 83 04 04
    jne    L_7747                                # 7743: 75 02
    dec    ah                                    # 7745: FE CC
L_7747:
    .byte 0x8A, 0xEC, 0x32, 0xC9 # 7747
    pop    ax                                    # 774B: 58
    push   WORD PTR ds:0x481                     # 774C: FF 36 81 04
    push   ax                                    # 7750: 50
    mov    BYTE PTR ds:0x482,ch                  # 7751: 88 2E 82 04
...
L_7762:
    ...
    inc    bx                                    # 7771: 43
L_7772:
    mov    WORD PTR ds:0x352,bx                  # 7772: 89 1E 52 03
L_7776:
    pop    ax                                    # 7776: 58
    popf                                         # 7777: 9D
    jb     L_778F                                # 7778: 72 15
    .byte 0x02, 0xC4 # 777A
    mov    ah,BYTE PTR ds:0x482                  # 777C: 8A 26 82 04
    .byte 0x2A, 0xC4, 0x0A, 0xE4 # 7780
    je     L_778F                                # 7784: 74 09
    test   BYTE PTR ds:0x483,0x4                 # 7786: F6 06 83 04 04
...
L_7799:
    ...
    .byte 0x32, 0xE4 # 77A2
L_77A4:
    mov    ds:0x483,ax                           # 77A4: A3 83 04
    mov    WORD PTR ds:0x481,cx                  # 77A7: 89 0E 81 04
    .byte 0x8A, 0xE0 # 77AB
...
L_77BB:
    push   bx                                    # 77BB: 53
    call   L_7B75                                # 77BC: E8 B6 03
    pop    bx                                    # 77BF: 5B
    jns    L_77CA                                # 77C0: 79 08
    mov    BYTE PTR [bx],0x2d                    # 77C2: C6 07 2D
    push   bx                                    # 77C5: 53
    call   L_7DAB                                # 77C6: E8 E2 05
    pop    bx                                    # 77C9: 5B
L_77CA:
    inc    bx                                    # 77CA: 43
    mov    BYTE PTR [bx],0x30                    # 77CB: C6 07 30
    call   L_7BA2                                # 77CE: E8 D1 03
    mov    ax,ds:0x483                           # 77D1: A1 83 04
    mov    cx,WORD PTR ds:0x481                  # 77D4: 8B 0E 81 04
...
L_77F0:
    inc    bx                                    # 77F0: 43
L_77F1:
    mov    di,WORD PTR ds:0x352                  # 77F1: 8B 3E 52 03
    mov    dx,WORD PTR ds:0x481                  # 77F5: 8B 16 81 04
    mov    al,ds:0x482                           # 77F9: A0 82 04
...
L_7847:
    ret                                          # 7847: C3
L_7848:
    mov    ax,ds:0x483                           # 7848: A1 83 04
    .byte 0x8A, 0xCC # 784B
    mov    ch,0x6                                # 784D: B5 06
    shr    al,1                                  # 784F: D0 E8
    mov    dx,WORD PTR ds:0x481                  # 7851: 8B 16 81 04
    jae    L_7862                                # 7855: 73 0B
    push   bx                                    # 7857: 53
    push   dx                                    # 7858: 52
    call   L_6BA1                                # 7859: E8 45 F3
    .byte 0x32, 0xC0 # 785C
    pop    dx                                    # 785E: 5A
...
L_7880:
    pop    WORD PTR ds:0x481                     # 7880: 8F 06 81 04
    jmp    L_77E0                                # 7884: E9 59 FF
TOKH_SPC:
    call   L_7B75                                # 7887: E8 EB 02
    je     L_78F9                                # 788A: 74 6D
    jns    L_789A                                # 788C: 79 0C
    mov    ax,ds:0x4a3                           # 788E: A1 A3 04
    mov    ds:0xb,ax                             # 7891: A3 0B 00
    mov    al,ds:0x4a5                           # 7894: A0 A5 04
    mov    ds:0xd,al                             # 7897: A2 0D 00
L_789A:
    mov    ax,ds:0xb                             # 789A: A1 0B 00
    mul    WORD PTR cs:0x626b                    # 789D: 2E F7 26 6B 62
    .byte 0x8B, 0xF8, 0x8A, 0xCA # 78A2
    mov    al,cs:0x626d                          # 78A6: 2E A0 6D 62
    mul    BYTE PTR ds:0xb                       # 78AA: F6 26 0B 00
    .byte 0x02, 0xC8 # 78AE
    ...
    .byte 0x12, 0xD9 # 78C9
    mov    ds:0x4a7,al                           # 78CB: A2 A7 04
    mov    al,0x80                               # 78CE: B0 80
    mov    ds:0x4a6,al                           # 78D0: A2 A6 04
    mov    WORD PTR ds:0xb,dx                    # 78D3: 89 16 0B 00
    mov    BYTE PTR ds:0xd,bl                    # 78D7: 88 1E 0D 00
    mov    al,0x4                                # 78DB: B0 04
    mov    ds:0x2fb,al                           # 78DD: A2 FB 02
...
L_78F9:
    mov    dx,WORD PTR ds:0xb                    # 78F9: 8B 16 0B 00
    mov    bl,BYTE PTR ds:0xd                    # 78FD: 8A 1E 0D 00
    .byte 0x33, 0xC0 # 7901
    mov    al,0x80                               # 7903: B0 80
    mov    ds:0x4a6,al                           # 7905: A2 A6 04
    mov    BYTE PTR ds:0x4a7,ah                  # 7908: 88 26 A7 04
    jmp    L_749E                                # 790C: E9 8F FB
L_790F:
    push   bx                                    # 790F: 53
    push   cx                                    # 7910: 51
    mov    bx,0x49e                              # 7911: BB 9E 04
...
L_791D:
    ...
    inc    BYTE PTR ds:0x4a6                     # 7925: FE 06 A6 04
    rcr    WORD PTR [bx],1                       # 7929: D1 1F
L_792B:
    pop    cx                                    # 792B: 59
    je     L_794E                                # 792C: 74 20
    test   BYTE PTR ds:0x49e,0xff                # 792E: F6 06 9E 04 FF
    jne    L_793A                                # 7933: 75 05
    and    BYTE PTR ds:0x49f,0xfe                # 7935: 80 26 9F 04 FE
L_793A:
    mov    bx,0x4a5                              # 793A: BB A5 04
...
L_7957:
    ...
    stc                                          # 7965: F9
    rcr    bl,1                                  # 7966: D0 DB
    inc    BYTE PTR ds:0x4a6                     # 7968: FE 06 A6 04
...
L_7978:
    ...
    inc    si                                    # 797E: 46
    inc    si                                    # 797F: 46
    mov    bh,BYTE PTR ds:0x4a7                  # 7980: 8A 3E A7 04
...
L_798E:
    .byte 0x8B, 0xF1 # 798E
    call   L_7E47                                # 7990: E8 B4 04
    .byte 0x8B, 0xCE # 7993
    push   cx                                    # 7995: 51
    call   L_7BA2                                # 7996: E8 09 02
    jb     L_79A4                                # 7999: 72 09
    cmp    BYTE PTR ds:0x4a6,0xb8                # 799B: 80 3E A6 04 B8
    jns    L_79B1                                # 79A0: 79 0F
    jmp    L_79AB                                # 79A2: EB 07
L_79A4:
    cmp    BYTE PTR ds:0x4a6,0x98                # 79A4: 80 3E A6 04 98
    jns    L_79B1                                # 79A9: 79 06
L_79AB:
    call   L_7BAE                                # 79AB: E8 00 02
    call   TOKH_STEP                             # 79AE: E8 CF 04
L_79B1:
    mov    bx,0x486                              # 79B1: BB 86 04
    call   L_7E08                                # 79B4: E8 51 04
    pop    cx                                    # 79B7: 59
L_79B8:
    push   cx                                    # 79B8: 51
    mov    di,0x48e                              # 79B9: BF 8E 04
    mov    bx,0x486                              # 79BC: BB 86 04
    call   L_7DF7                                # 79BF: E8 35 04
    mov    bx,0x486                              # 79C2: BB 86 04
    call   L_7E25                                # 79C5: E8 5D 04
    call   L_7BC8                                # 79C8: E8 FD 01
    call   TOKH_STEP                             # 79CB: E8 B2 04
    mov    bx,0x486                              # 79CE: BB 86 04
    call   L_7E08                                # 79D1: E8 34 04
    call   L_7BD2                                # 79D4: E8 FB 01
    mov    bx,0x494                              # 79D7: BB 94 04
    call   L_7BA2                                # 79DA: E8 C5 01
    jae    L_79E2                                # 79DD: 73 03
    sub    bx,0x4                                # 79DF: 83 EB 04
L_79E2:
    call   L_7E3C                                # 79E2: E8 57 04
    pop    cx                                    # 79E5: 59
...
L_79EC:
    .byte 0x8B, 0xE9 # 79EC
    call   L_7E66                                # 79EE: E8 75 04
    .byte 0x8B, 0xCD # 79F1
    ret                                          # 79F3: C3
TOKH_STRING:
    and    BYTE PTR ds:0x4a5,0x7f                # 79F4: 80 26 A5 04 7F
    call   L_7A82                                # 79F9: E8 86 00
    call   L_7AA4                                # 79FC: E8 A5 00
    mov    BYTE PTR ds:0x4b2,0x7f                # 79FF: C6 06 B2 04 7F
    call   L_66AA                                # 7A04: E8 A3 EC
    call   L_7A8E                                # 7A07: E8 84 00
    jmp    L_7A27                                # 7A0A: EB 1B
    .byte 0x65, 0xED # 7A0C
TOKH_NOT:
    mov    ax,ds:0x4a5                           # 7A0E: A1 A5 04
...
L_7A17:
    ...
    mov    ds:0x4a5,al                           # 7A1D: A2 A5 04
    mov    ax,0x7db0                             # 7A20: B8 B0 7D
    push   ax                                    # 7A23: 50
L_7A24:
    call   L_7A82                                # 7A24: E8 5B 00
L_7A27:
    mov    al,ds:0x4a6                           # 7A27: A0 A6 04
    .byte 0x0A, 0xC0 # 7A2A
    je     L_7A33                                # 7A2C: 74 05
    add    BYTE PTR ds:0x4a6,0x2                 # 7A2E: 80 06 A6 04 02
L_7A33:
    call   L_7A97                                # 7A33: E8 61 00
    mov    ax,ds:0x4b1                           # 7A36: A1 B1 04
...
L_7A44:
    ...
    call   L_7C88                                # 7A4E: E8 37 02
    call   L_669C                                # 7A51: E8 48 EC
L_7A54:
    sub    BYTE PTR ds:0x4a6,0x2                 # 7A54: 80 2E A6 04 02
    jae    L_7A5E                                # 7A59: 73 03
    call   L_7B5E                                # 7A5B: E8 00 01
L_7A5E:
    call   L_6B64                                # 7A5E: E8 03 F1
    mov    al,ds:0x4a6                           # 7A61: A0 A6 04
    cmp    al,0x74                               # 7A64: 3C 74
    jae    L_7A73                                # 7A66: 73 0B
    mov    dx,0xfdb                              # 7A68: BA DB 0F
    mov    bx,0x8349                             # 7A6B: BB 49 83
    call   L_6CFF                                # 7A6E: E8 8E F2
...
L_7A79:
    ...
    xor    BYTE PTR ds:0x4a5,0x80                # 7A7C: 80 36 A5 04 80
L_7A81:
    ret                                          # 7A81: C3
L_7A82:
    mov    bx,0x6263                             # 7A82: BB 63 62
    call   L_7C88                                # 7A85: E8 00 02
    call   L_6B93                                # 7A88: E8 08 F1
    call   L_6C55                                # 7A8B: E8 C7 F1
L_7A8E:
    call   L_7A97                                # 7A8E: E8 06 00
L_7A91:
    call   L_669C                                # 7A91: E8 08 EC
    jmp    L_7DB0                                # 7A94: E9 19 03
L_7A97:
    call   L_7E47                                # 7A97: E8 AD 03
    call   L_7241                                # 7A9A: E8 A4 F7
    call   L_7CA0                                # 7A9D: E8 00 02
    call   L_7E66                                # 7AA0: E8 C3 03
    ret                                          # 7AA3: C3
L_7AA4:
    mov    bx,0x6032                             # 7AA4: BB 32 60
    jmp    L_7C88                                # 7AA7: E9 DE 01
    .byte 0xB8, 0xF0, 0xC3 # 7AAA
TOKH_USING:
    push   WORD PTR ds:0x4a5                     # 7AAD: FF 36 A5 04
    push   WORD PTR ds:0x4a3                     # 7AB1: FF 36 A3 04
    call   TOKH_NOT                              # 7AB5: E8 56 FF
    pop    dx                                    # 7AB8: 5A
    pop    bx                                    # 7AB9: 5B
    push   WORD PTR ds:0x4a3                     # 7ABA: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 7ABE: FF 36 A5 04
    call   L_7CBE                                # 7AC2: E8 F9 01
    call   TOKH_STRING                           # 7AC5: E8 2C FF
    pop    bx                                    # 7AC8: 5B
    pop    dx                                    # 7AC9: 5A
    jmp    L_68DE                                # 7ACA: E9 11 EE
TOKH_INSTR:
    mov    ax,ds:0x4a5                           # 7ACD: A1 A5 04
    .byte 0x0A, 0xC0 # 7AD0
    jns    L_7ADD                                # 7AD2: 79 09
    mov    di,0x7db0                             # 7AD4: BF B0 7D
    push   di                                    # 7AD7: 57
    and    al,0x7f                               # 7AD8: 24 7F
    mov    ds:0x4a5,al                           # 7ADA: A2 A5 04
L_7ADD:
...
L_7AEE:
    ...
    call   L_7CD8                                # 7AF4: E8 E1 01
    js     L_7B33                                # 7AF7: 78 3A
    mov    di,0x7b42                             # 7AF9: BF 42 7B
    push   di                                    # 7AFC: 57
    push   WORD PTR ds:0x4a3                     # 7AFD: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 7B01: FF 36 A5 04
    mov    dx,0xb3d7                             # 7B05: BA D7 B3
    mov    bx,0x815d                             # 7B08: BB 5D 81
    call   L_6773                                # 7B0B: E8 65 EC
    pop    bx                                    # 7B0E: 5B
    pop    dx                                    # 7B0F: 5A
    push   WORD PTR ds:0x4a3                     # 7B10: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 7B14: FF 36 A5 04
    call   L_7CBE                                # 7B18: E8 A3 01
    mov    bx,0x6249                             # 7B1B: BB 49 62
    call   L_7552                                # 7B1E: E8 31 FA
    pop    bx                                    # 7B21: 5B
    pop    dx                                    # 7B22: 5A
    push   WORD PTR ds:0x4a3                     # 7B23: FF 36 A3 04
    push   WORD PTR ds:0x4a5                     # 7B27: FF 36 A5 04
    call   L_7CBE                                # 7B2B: E8 90 01
    pop    bx                                    # 7B2E: 5B
    pop    dx                                    # 7B2F: 5A
...
L_7B4B:
    call   L_2BA5                                # 7B4B: E8 57 B0
    cmp    al,0xd                                # 7B4E: 3C 0D
    jne    L_7B55                                # 7B50: 75 03
...
L_7B6B:
    ...
    mov    ds:0x4a3,ax                           # 7B6E: A3 A3 04
    mov    ds:0x4a5,ax                           # 7B71: A3 A5 04
    ret                                          # 7B74: C3
L_7B75:
    call   L_62F0                                # 7B75: E8 78 E7
    jns    L_7B88                                # 7B78: 79 0E
    mov    ax,ds:0x4a3                           # 7B7A: A1 A3 04
    .byte 0x0B, 0xC0 # 7B7D
    je     L_7BA1                                # 7B7F: 74 20
    mov    al,0x1                                # 7B81: B0 01
    jns    L_7BA1                                # 7B83: 79 1C
    neg    al                                    # 7B85: F6 D8
    ret                                          # 7B87: C3
L_7B88:
    int    0xd4                                  # 7B88: CD D4
    mov    al,ds:0x4a6                           # 7B8A: A0 A6 04
    .byte 0x0A, 0xC0 # 7B8D
    je     L_7BA1                                # 7B8F: 74 10
    mov    al,ds:0x4a5                           # 7B91: A0 A5 04
L_7B94:
    .byte 0x0A, 0xC0 # 7B94
    je     L_7B9F                                # 7B96: 74 07
    mov    al,0x1                                # 7B98: B0 01
    jns    L_7BA1                                # 7B9A: 79 05
    neg    al                                    # 7B9C: F6 D8
    ret                                          # 7B9E: C3
L_7B9F:
...
L_7BA2:
    ...
    ret                                          # 7BAD: C3
L_7BAE:
    call   L_7BA2                                # 7BAE: E8 F1 FF
    jb     L_7BBF                                # 7BB1: 72 0C
L_7BB3:
    push   bx                                    # 7BB3: 53
    mov    bx,0x616a                             # 7BB4: BB 6A 61
    call   L_7C88                                # 7BB7: E8 CE 00
...
L_7BBF:
    ...
    ret                                          # 7BC7: C3
L_7BC8:
    call   L_7BA2                                # 7BC8: E8 D7 FF
    mov    bx,0x602a                             # 7BCB: BB 2A 60
    jb     L_7BE1                                # 7BCE: 72 11
    jmp    L_7BDA                                # 7BD0: EB 08
L_7BD2:
    call   L_7BA2                                # 7BD2: E8 CD FF
    mov    bx,0x603a                             # 7BD5: BB 3A 60
    jb     L_7BE1                                # 7BD8: 72 07
L_7BDA:
    call   L_7C88                                # 7BDA: E8 AB 00
    call   L_6C55                                # 7BDD: E8 75 F0
    ret                                          # 7BE0: C3
L_7BE1:
    push   WORD PTR ds:0x4a5                     # 7BE1: FF 36 A5 04
    push   WORD PTR ds:0x4a3                     # 7BE5: FF 36 A3 04
    mov    BYTE PTR ds:0x2fb,0x8                 # 7BE9: C6 06 FB 02 08
    call   L_7C8D                                # 7BEE: E8 9C 00
    call   L_6B64                                # 7BF1: E8 70 EF
    pop    dx                                    # 7BF4: 5A
    pop    bx                                    # 7BF5: 5B
    call   L_6CFF                                # 7BF6: E8 06 F1
    ret                                          # 7BF9: C3
L_7BFA:
...
L_7C27:
    ...
    or     BYTE PTR ds:0x4aa,ah                  # 7C3D: 08 26 AA 04
...
L_7C57:
    ret                                          # 7C57: C3
L_7C58:
    mov    si,0x49f                              # 7C58: BE 9F 04
    mov    di,0x4ab                              # 7C5B: BF AB 04
    cld                                          # 7C5E: FC
...
L_7C62:
    ...
    loop   L_7C62                                # 7C69: E2 F7
    ret                                          # 7C6B: C3
L_7C6C:
    mov    di,0x47c                              # 7C6C: BF 7C 04
    mov    cx,0x2                                # 7C6F: B9 02 00
    jmp    L_7C7A                                # 7C72: EB 06
L_7C74:
    mov    di,0x478                              # 7C74: BF 78 04
L_7C77:
...
L_7C7B:
    ...
    inc    bx                                    # 7C7F: 43
    inc    bx                                    # 7C80: 43
    loop   L_7C7B                                # 7C81: E2 F8
    .byte 0x8B, 0xDF # 7C83
    dec    bx                                    # 7C85: 4B
    dec    bx                                    # 7C86: 4B
    ret                                          # 7C87: C3
L_7C88:
    mov    di,0x4ab                              # 7C88: BF AB 04
    jmp    L_7C77                                # 7C8B: EB EA
L_7C8D:
    mov    di,0x49f                              # 7C8D: BF 9F 04
    jmp    L_7C77                                # 7C90: EB E5
...
L_7CA0:
    ...
    push   bx                                    # 7CA1: 53
    push   di                                    # 7CA2: 57
    mov    bx,0x49f                              # 7CA3: BB 9F 04
    mov    di,0x4ab                              # 7CA6: BF AB 04
L_7CA9:
    mov    cx,0x4                                # 7CA9: B9 04 00
    call   L_7C98                                # 7CAC: E8 E9 FF
    pop    di                                    # 7CAF: 5F
    pop    bx                                    # 7CB0: 5B
    pop    cx                                    # 7CB1: 59
    ret                                          # 7CB2: C3
L_7CB3:
    ...
    push   bx                                    # 7CB4: 53
    push   di                                    # 7CB5: 57
    mov    bx,0x4ab                              # 7CB6: BB AB 04
    mov    di,0x49f                              # 7CB9: BF 9F 04
    jmp    L_7CA9                                # 7CBC: EB EB
L_7CBE:
    mov    WORD PTR ds:0x4a3,dx                  # 7CBE: 89 16 A3 04
    mov    WORD PTR ds:0x4a5,bx                  # 7CC2: 89 1E A5 04
    ret                                          # 7CC6: C3
L_7CC7:
    mov    dx,WORD PTR ds:0x4a3                  # 7CC7: 8B 16 A3 04
    mov    bx,WORD PTR ds:0x4a5                  # 7CCB: 8B 1E A5 04
    ret                                          # 7CCF: C3
L_7CD0:
    call   L_7BA2                                # 7CD0: E8 CF FE
    jb     L_7D14                                # 7CD3: 72 3F
    jmp    L_7D61                                # 7CD5: E9 89 00
L_7CD8:
    call   L_6AB2                                # 7CD8: E8 D7 ED
    push   bx                                    # 7CDB: 53
    push   di                                    # 7CDC: 57
    .byte 0x8A, 0xC3 # 7CDD
    xor    al,BYTE PTR ds:0x4a5                  # 7CDF: 32 06 A5 04
    js     L_7D21                                # 7CE3: 78 3C
    .byte 0x0A, 0xDB # 7CE5
    js     L_7CF9                                # 7CE7: 78 10
    mov    ax,ds:0x4a5                           # 7CE9: A1 A5 04
    .byte 0x2B, 0xC3 # 7CEC
    jb     L_7D2F                                # 7CEE: 72 3F
    jne    L_7D29                                # 7CF0: 75 37
    mov    ax,ds:0x4a3                           # 7CF2: A1 A3 04
    .byte 0x2B, 0xC2 # 7CF5
    jmp    L_7D09                                # 7CF7: EB 10
L_7CF9:
    .byte 0x8B, 0xC3 # 7CF9
    sub    ax,WORD PTR ds:0x4a5                  # 7CFB: 2B 06 A5 04
    jb     L_7D2F                                # 7CFF: 72 2E
    jne    L_7D29                                # 7D01: 75 26
    .byte 0x8B, 0xC2 # 7D03
    sub    ax,WORD PTR ds:0x4a3                  # 7D05: 2B 06 A3 04
L_7D09:
    jb     L_7D2F                                # 7D09: 72 24
    jne    L_7D29                                # 7D0B: 75 1C
    .byte 0x32, 0xC0 # 7D0D
    jmp    L_7D5B                                # 7D0F: EB 4A
...
L_7D14:
    ...
    xor    al,BYTE PTR ds:0x4a5                  # 7D1B: 32 06 A5 04
    jns    L_7D34                                # 7D1F: 79 13
L_7D21:
    mov    ah,BYTE PTR ds:0x4a5                  # 7D21: 8A 26 A5 04
    .byte 0x0A, 0xE4 # 7D25
    js     L_7D2F                                # 7D27: 78 06
L_7D29:
    mov    al,0x1                                # 7D29: B0 01
    .byte 0x0A, 0xC0 # 7D2B
    jmp    L_7D5B                                # 7D2D: EB 2C
L_7D2F:
    mov    al,0xff                               # 7D2F: B0 FF
    stc                                          # 7D31: F9
    jmp    L_7D5B                                # 7D32: EB 27
L_7D34:
    push   cx                                    # 7D34: 51
    mov    cx,0x2                                # 7D35: B9 02 00
L_7D38:
    xchg   si,bx                                 # 7D38: 87 DE
    mov    al,ds:0x4a5                           # 7D3A: A0 A5 04
    .byte 0x0A, 0xC0 # 7D3D
    jns    L_7D43                                # 7D3F: 79 02
    xchg   di,si                                 # 7D41: 87 F7
L_7D43:
    std                                          # 7D43: FD
L_7D44:
    cmps   WORD PTR ds:[si],WORD PTR es:[di]     # 7D44: A7
    jne    L_7D4D                                # 7D45: 75 06
    loop   L_7D44                                # 7D47: E2 FB
    mov    al,0x0                                # 7D49: B0 00
    jmp    L_7D5A                                # 7D4B: EB 0D
L_7D4D:
    jae    L_7D55                                # 7D4D: 73 06
    mov    al,0x1                                # 7D4F: B0 01
    .byte 0x0A, 0xC0 # 7D51
    jmp    L_7D5A                                # 7D53: EB 05
L_7D55:
...
L_7D61:
    ...
    jns    L_7D6E                                # 7D6A: 79 02
    jmp    L_7D21                                # 7D6C: EB B3
L_7D6E:
    push   cx                                    # 7D6E: 51
    mov    cx,0x4                                # 7D6F: B9 04 00
    jmp    L_7D38                                # 7D72: EB C4
L_7D74:
    mov    bx,0x61ff                             # 7D74: BB FF 61
    call   L_7C6C                                # 7D77: E8 F2 FE
    call   L_7D14                                # 7D7A: E8 97 FF
    jne    L_7D8A                                # 7D7D: 75 0B
    mov    BYTE PTR ds:0x2fb,0x2                 # 7D7F: C6 06 FB 02 02
    mov    WORD PTR ds:0x4a3,0x8000              # 7D84: C7 06 A3 04 00 80
L_7D8A:
    ret                                          # 7D8A: C3
L_7D8B:
    ...
    ret                                          # 7D95: C3
TOKH_USR:
    call   L_7BA2                                # 7D96: E8 09 FE
    js     L_7DA3                                # 7D99: 78 08
    mov    al,ds:0x4a5                           # 7D9B: A0 A5 04
    .byte 0x0A, 0xC0 # 7D9E
    js     L_7DB0                                # 7DA0: 78 0E
    ret                                          # 7DA2: C3
L_7DA3:
    mov    ax,ds:0x4a3                           # 7DA3: A1 A3 04
    .byte 0x0B, 0xC0 # 7DA6
    js     L_7DBB                                # 7DA8: 78 11
    ret                                          # 7DAA: C3
L_7DAB:
    call   L_7BA2                                # 7DAB: E8 F4 FD
    js     L_7DB8                                # 7DAE: 78 08
L_7DB0:
    int    0xd2                                  # 7DB0: CD D2
    xor    BYTE PTR ds:0x4a5,0x80                # 7DB2: 80 36 A5 04 80
    ret                                          # 7DB7: C3
L_7DB8:
    mov    ax,ds:0x4a3                           # 7DB8: A1 A3 04
L_7DBB:
    cmp    ax,0x8000                             # 7DBB: 3D 00 80
    jne    L_7DCA                                # 7DBE: 75 0A
    int    0xd3                                  # 7DC0: CD D3
    push   bx                                    # 7DC2: 53
    call   L_6BA1                                # 7DC3: E8 DB ED
    pop    bx                                    # 7DC6: 5B
    .byte 0xE9, 0xE6, 0xFF # 7DC7
L_7DCA:
    neg    WORD PTR ds:0x4a3                     # 7DCA: F7 1E A3 04
    ret                                          # 7DCE: C3
L_7DCF:
    mov    bx,0x479                              # 7DCF: BB 79 04
    call   L_7E08                                # 7DD2: E8 33 00
    mov    di,0x497                              # 7DD5: BF 97 04
    mov    cx,0x8                                # 7DD8: B9 08 00
    mov    ax,0x0                                # 7DDB: B8 00 00
    cld                                          # 7DDE: FC
    rep stos WORD PTR es:[di],ax                 # 7DDF: F3 AB
    mov    ds:0x478,al                           # 7DE1: A2 78 04
    mov    ds:0x4aa,al                           # 7DE4: A2 AA 04
    ret                                          # 7DE7: C3
    .byte 0xE8, 0xB7, 0xFD, 0x72, 0x03, 0xE9, 0xA2, 0xFE, 0x8B, 0x17, 0x8B, 0x9F # 7DE8
    .byte 0x02, 0x00, 0xC3 # 7DF4
L_7DF7:
    mov    cx,0x4                                # 7DF7: B9 04 00
    call   L_7BA2                                # 7DFA: E8 A5 FD
    jb     L_7E02                                # 7DFD: 72 03
    jmp    L_7C98                                # 7DFF: E9 96 FE
L_7E02:
    mov    cx,0x2                                # 7E02: B9 02 00
    jmp    L_7C98                                # 7E05: E9 90 FE
L_7E08:
    mov    cx,0x4                                # 7E08: B9 04 00
    xchg   bx,di                                 # 7E0B: 87 FB
    mov    bx,0x49f                              # 7E0D: BB 9F 04
    call   L_7BA2                                # 7E10: E8 8F FD
    jb     L_7E18                                # 7E13: 72 03
    jmp    L_7C98                                # 7E15: E9 80 FE
L_7E18:
...
L_7E1A:
    ...
    jmp    L_7C98                                # 7E22: E9 73 FE
L_7E25:
    mov    cx,0x4                                # 7E25: B9 04 00
    mov    di,0x49f                              # 7E28: BF 9F 04
    call   L_7BA2                                # 7E2B: E8 74 FD
    jb     L_7E33                                # 7E2E: 72 03
    jmp    L_7C98                                # 7E30: E9 65 FE
L_7E33:
    mov    cx,0x2                                # 7E33: B9 02 00
    mov    di,0x4a3                              # 7E36: BF A3 04
    jmp    L_7C98                                # 7E39: E9 5C FE
L_7E3C:
    call   L_7BA2                                # 7E3C: E8 63 FD
    jb     L_7E44                                # 7E3F: 72 03
    jmp    L_7D61                                # 7E41: E9 1D FF
L_7E44:
    jmp    L_7D14                                # 7E44: E9 CD FE
L_7E47:
    call   L_7BA2                                # 7E47: E8 58 FD
    mov    cx,0x4                                # 7E4A: B9 04 00
    jae    L_7E52                                # 7E4D: 73 03
L_7E4F:
    mov    cx,0x2                                # 7E4F: B9 02 00
L_7E52:
    pop    bp                                    # 7E52: 5D
    mov    di,0x4a5                              # 7E53: BF A5 04
L_7E56:
...
L_7E66:
    call   L_7BA2                                # 7E66: E8 39 FD
    mov    di,0x49f                              # 7E69: BF 9F 04
    mov    cx,0x4                                # 7E6C: B9 04 00
    jae    L_7E77                                # 7E6F: 73 06
...
L_7E78:
    ...
    inc    di                                    # 7E7A: 47
    inc    di                                    # 7E7B: 47
    loop   L_7E78                                # 7E7C: E2 FA
    push   ax                                    # 7E7E: 50
    ret                                          # 7E7F: C3
TOKH_STEP:
    call   L_7BA2                                # 7E80: E8 1F FD
...
L_7ED2:
    dec    bx                                    # 7ED2: 4B
    mov    WORD PTR ds:0x2c,bx                   # 7ED3: 89 1E 2C 00
    .byte 0x8B, 0xE3 # 7ED7
    jmp    L_4BFE                                # 7ED9: E9 22 CD
L_7EDC:
    mov    al,0x2c                               # 7EDC: B0 2C
    mov    ds:0x1f6,al                           # 7EDE: A2 F6 01
    mov    bx,0xb7                               # 7EE1: BB B7 00
    mov    BYTE PTR [bx],0x3a                    # 7EE4: C6 07 3A
    .byte 0x32, 0xC0 # 7EE7
    mov    ds:0x2f9,al                           # 7EE9: A2 F9 02
    mov    ds:0x6,al                             # 7EEC: A2 06 00
    mov    ds:0x46b,al                           # 7EEF: A2 6B 04
    mov    ds:0x465,al                           # 7EF2: A2 65 04
    mov    ds:0x28,al                            # 7EF5: A2 28 00
    mov    bx,0x30e                              # 7EF8: BB 0E 03
    mov    WORD PTR ds:0x30c,bx                  # 7EFB: 89 1E 0C 03
    mov    bx,0x37a                              # 7EFF: BB 7A 03
    mov    WORD PTR ds:0x3e2,bx                  # 7F02: 89 1E E2 03
    mov    bx,WORD PTR ds:0x2c                   # 7F06: 8B 1E 2C 00
    dec    bx                                    # 7F0A: 4B
    mov    WORD PTR ds:0x30a,bx                  # 7F0B: 89 1E 0A 03
    dec    bx                                    # 7F0F: 4B
    push   bx                                    # 7F10: 53
    mov    bx,0x70e                              # 7F11: BB 0E 07
    mov    al,0x4                                # 7F14: B0 04
    mov    ds:0x4df,al                           # 7F16: A2 DF 04
    push   bx                                    # 7F19: 53
    mov    WORD PTR ds:0x4e0,bx                  # 7F1A: 89 1E E0 04
    mov    al,ds:0x4df                           # 7F1E: A0 DF 04
    inc    al                                    # 7F21: FE C0
    ...
    mov    bx,WORD PTR ds:0x4e0                  # 7F2E: 8B 1E E0 04
    mov    BYTE PTR [bx],dl                      # 7F32: 88 17
    inc    bx                                    # 7F34: 43
    mov    BYTE PTR [bx],dh                      # 7F35: 88 37
    inc    bx                                    # 7F37: 43
    mov    al,ds:0x4df                           # 7F38: A0 DF 04
...
L_7F50:
    ...
    push   bx                                    # 7F55: 53
    dec    al                                    # 7F56: FE C8
    mov    ds:0x536,al                           # 7F58: A2 36 05
    mov    bx,WORD PTR ds:0x4e0                  # 7F5B: 8B 1E E0 04
    mov    dx,WORD PTR [bx]                      # 7F5F: 8B 17
    mov    bx,0x33                               # 7F61: BB 33 00
    .byte 0x03, 0xDA # 7F64
    mov    WORD PTR ds:0x4e4,bx                  # 7F66: 89 1E E4 04
    pop    bx                                    # 7F6A: 5B
    inc    bx                                    # 7F6B: 43
    mov    WORD PTR ds:0x30,bx                   # 7F6C: 89 1E 30 00
    mov    WORD PTR ds:0x345,bx                  # 7F70: 89 1E 45 03
    pop    dx                                    # 7F74: 5A
    .byte 0x8A, 0xC2 # 7F75
...
L_7FAA:
    mov    WORD PTR ds:0x30a,bx                  # 7FAA: 89 1E 0A 03
    xchg   dx,bx                                 # 7FAE: 87 DA
    mov    WORD PTR ds:0x2c,bx                   # 7FB0: 89 1E 2C 00
    mov    WORD PTR ds:0x32f,bx                  # 7FB4: 89 1E 2F 03
    .byte 0x8B, 0xE3 # 7FB8
    mov    WORD PTR ds:0x345,bx                  # 7FBA: 89 1E 45 03
    mov    bx,WORD PTR ds:0x30                   # 7FBE: 8B 1E 30 00
    ...
    push   bx                                    # 7FCB: 53
    pop    bx                                    # 7FCC: 5B
    call   L_6550                                # 7FCD: E8 80 E5
    mov    bx,0x7fdc                             # 7FD0: BB DC 7F
    call   L_7B55                                # 7FD3: E8 7F FB
    call   L_2C71                                # 7FD6: E8 98 AC
...
L_7FE9:
    ...
    .byte 0x33, 0xC9 # 7FEC
    push   dx                                    # 7FEE: 52
    push   WORD PTR ds:0x481                     # 7FEF: FF 36 81 04
