...
# SEMANTIC RECOVERY SOURCE - PHASE 1 (exact C1.10 rebuild)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Recovered interpreter constants / DSEG map (phase 1, high-confidence only)
...
# Statement/syntax tokens used as inline SYNCHR operands.
.equ TOK_INPUT, 0x85
.equ TOK_GOTO,  0x89
.equ TOK_TO,    0xCC
.equ TOK_THEN,  0xCD
...
SCNLIN:
    ...
    .byte TK_MINUS                             # 0A45: EA -- inline SYNCHR operand
...
FOR:
    ...
    .byte TK_EQUAL                             # 0D9F: E7 -- inline SYNCHR operand
    push   dx                                    # 0DA0: 52 -- resumed after SYNCHR operand
...
L_0DEA:
    ...
    .byte TOK_TO                               # 0E07: CC -- inline SYNCHR operand
...
LET:
    ...
    .byte TK_EQUAL                             # 1195: E7 -- inline SYNCHR operand
    mov    WORD PTR ds:0x33b,dx                  # 1196: 89 -- resumed after SYNCHR operand
    push   ss                                    # 1197: 16
...
ONGOTO:
    ...
    .byte TOK_GOTO                             # 1208: 89 -- inline SYNCHR operand
    call LINGET                                  # 1209: E8 -- resumed after SYNCHR operand
    pop    di                                    # 120A: 5F
...
L_1234:
    ...
    .byte TOK_GOTO                             # 1242: 89 -- inline SYNCHR operand
    dec    bx                                    # 1243: 4B -- resumed after SYNCHR operand
L_1244:
    .byte 0x8A, 0xCA # 1244
L_1246:
...
AUTO:
    ...
    .byte ','                                  # 12CE: 2C -- inline SYNCHR operand
    mov    dx,WORD PTR ds:0x341                  # 12CF: 8B -- resumed after SYNCHR operand
    push   ss                                    # 12D0: 16
    inc    cx                                    # 12D1: 41
...
L_1304:
    ...
    .byte TOK_THEN                             # 130B: CD -- inline SYNCHR operand
    dec    bx                                    # 130C: 4B -- resumed after SYNCHR operand
L_130D:
    push   bx                                    # 130D: 53
...
L_144F:
    ...
    .byte ')'                                  # 1453: 29 -- inline SYNCHR operand
    dec    bx                                    # 1454: 4B -- resumed after SYNCHR operand
    pop    ax                                    # 1455: 58 -- resumed after SYNCHR operand
...
L_14E0:
    ...
    .byte TOK_INPUT                            # 14E3: 85 -- inline SYNCHR operand
    cmp    al,0x23                               # 14E4: 3C -- resumed after SYNCHR operand
...
L_1582:
    ...
    .byte ';'                                  # 1585: 3B -- inline SYNCHR operand
L_1586:
...
L_1644:
    ...
    .byte 0xE8, 0xA2, 0x17 # 164F -- unresolved bytes preceding SYNCHR inline operand
    .byte ','                                  # 1652: 2C -- inline SYNCHR operand
L_1653:
...
L_171C:
    ...
    .byte TK_EQUAL                             # 171F: E7 -- inline SYNCHR operand
    jmp L_1727                                   # 1720: E9 -- resumed after SYNCHR operand
    add    al,0x0                                # 1721: 04 00
L_1723:
    call   SYNCHR                                # 1723: E8 CE 16
    .byte '('                                  # 1726: 28 -- inline SYNCHR operand
L_1727:
    .byte 0x4B # 1727
L_1728:
    .byte 0xB6, 0x00 # 1728
...
L_194F:
    ...
    .byte '('                                  # 1959: 28 -- inline SYNCHR operand
    cmp    al,0x23                               # 195A: 3C -- resumed after SYNCHR operand
...
L_196E:
    ...
    .byte ')'                                  # 1971: 29 -- inline SYNCHR operand
    push   bx                                    # 1972: 53 -- resumed after SYNCHR operand
    xchg   dx,bx                                 # 1973: 87 -- resumed after SYNCHR operand
...
L_19C0:
    ...
    .byte ')'                                  # 19C6: 29 -- inline SYNCHR operand
    ret                                          # 19C7: C3 -- resumed after SYNCHR operand
L_19C8:
...
L_1A8D:
    ...
    .byte ','                                  # 1AA3: 2C -- inline SYNCHR operand
    call L_643B                                  # 1AA4: E8 -- resumed after SYNCHR operand
    xchg   sp,ax                                 # 1AA5: 94
    dec    cx                                    # 1AA6: 49
...
L_1BDD:
    ...
    .byte TK_EQUAL                             # 1BE4: E7 -- inline SYNCHR operand
    call L_22AA                                  # 1BE5: E8 -- resumed after SYNCHR operand
...
DEF:
    ...
    .byte 'S'                                  # 1BFB: 53 -- inline SYNCHR operand
    call   SYNCHR                                # 1BFC: E8 F5 11
    .byte 'E'                                  # 1BFF: 45 -- inline SYNCHR operand
    call   SYNCHR                                # 1C00: E8 F1 11
    .byte 'G'                                  # 1C03: 47 -- inline SYNCHR operand
    mov    dx,ds                                 # 1C04: 8C DA
    je     L_1C0F                                # 1C06: 74 07
    call   SYNCHR                                # 1C08: E8 E9 11
    .byte TK_EQUAL                             # 1C0B: E7 -- inline SYNCHR operand
    call L_22AA                                  # 1C0C: E8 -- resumed after SYNCHR operand
    fwait                                        # 1C0D: 9B
    push   es                                    # 1C0E: 06
L_1C0F:
...
L_1C38:
    ...
    .byte ','                                  # 1C3B: 2C -- inline SYNCHR operand
    jmp    0x1c2c                                # 1C3C: EB -- resumed after SYNCHR operand
    out    dx,al                                 # 1C3D: EE
L_1C3E:
...
L_1C5F:
    ...
    .byte '('                                  # 1C6F: 28 -- inline SYNCHR operand
    xor    al,al                                 # 1C70: 32 -- resumed after SYNCHR operand
    ...
    .byte ','                                  # 1CB9: 2C -- inline SYNCHR operand
    push   bx                                    # 1CBA: 53 -- resumed after SYNCHR operand
    mov    bx,WORD PTR ds:0x331                  # 1CBB: 8B 1E 31 03
    call   SYNCHR                                # 1CBF: E8 32 11
    .byte ','                                  # 1CC2: 2C -- inline SYNCHR operand
    jmp    0x1c76                                # 1CC3: EB -- resumed after SYNCHR operand
...
L_1D1C:
    ...
    .byte ')'                                  # 1D2B: 29 -- inline SYNCHR operand
    mov    al,0x52                               # 1D2C: B0 -- resumed after SYNCHR operand
L_1D2D:
...
L_1E0A:
    ...
    .byte TOK_FN                               # 1E0D: D1 -- inline SYNCHR operand
    mov    al,0x80                               # 1E0E: B0 80 -- resumed after SYNCHR operand
    mov    ds:0x339,al                           # 1E10: A2 -- resumed after SYNCHR operand
...
L_1E46:
    ...
    .byte ','                                  # 1E4D: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 1E4E: E8 -- resumed after SYNCHR operand
    retf                                         # 1E4F: CB
...
FNWAIT:
    ...
    .byte ','                                  # 1E68: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 1E69: E8 -- resumed after SYNCHR operand
...
L_1EA6:
    ...
    .byte ','                                  # 1EAC: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 1EAD: E8 -- resumed after SYNCHR operand
...
L_1ECA:
    ...
    .byte ','                                  # 1ED4: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 1ED5: E8 -- resumed after SYNCHR operand
    inc    sp                                    # 1ED6: 44
...
LIST:
    ...
    .byte ','                                  # 1F4C: 2C -- inline SYNCHR operand
    call L_3F13                                  # 1F4D: E8 -- resumed after SYNCHR operand
    ret                                          # 1F4E: C3
...
L_229B:
    .byte ','                                  # 229B: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 229C: E8 -- resumed after SYNCHR operand
...
L_22F1:
    ...
    .byte ','                                  # 22F4: 2C -- inline SYNCHR operand
    call L_105E                                  # 22F5: E8 -- resumed after SYNCHR operand
    in     eax,dx                                # 22F6: 66 ED
    je     L_2317                                # 22F8: 74 1D
    pop    ax                                    # 22FA: 58
    call   SYNCHR                                # 22FB: E8 F6 0A
    .byte ','                                  # 22FE: 2C -- inline SYNCHR operand
    push   dx                                    # 22FF: 52 -- resumed after SYNCHR operand
...
OPTION:
    ...
    .byte 'B'                                  # 2442: 42 -- inline SYNCHR operand
    call   SYNCHR                                # 2443: E8 AE 09
    .byte 'A'                                  # 2446: 41 -- inline SYNCHR operand
    call   SYNCHR                                # 2447: E8 AA 09
    .byte 'S'                                  # 244A: 53 -- inline SYNCHR operand
    call   SYNCHR                                # 244B: E8 A6 09
    .byte 'E'                                  # 244E: 45 -- inline SYNCHR operand
...
L_2571:
    ...
    .byte ','                                  # 25A4: 2C -- inline SYNCHR operand
    dec    bx                                    # 25A5: 4B -- resumed after SYNCHR operand
...
L_291B:
    ...
    .byte '('                                  # 2921: 28 -- inline SYNCHR operand
    call L_1F1C                                  # 2922: E8 -- resumed after SYNCHR operand
    div    bp                                    # 2923: F7 F5
    push   dx                                    # 2925: 52
    call   SYNCHR                                # 2926: E8 CB 04
    .byte ','                                  # 2929: 2C -- inline SYNCHR operand
    call L_1727                                  # 292A: E8 -- resumed after SYNCHR operand
    cli                                          # 292B: FA
    in     ax,dx                                 # 292C: ED
    call   SYNCHR                                # 292D: E8 C4 04
    .byte ')'                                  # 2930: 29 -- inline SYNCHR operand
    pop    si                                    # 2931: 5E -- resumed after SYNCHR operand
    xchg   si,bx                                 # 2932: 87 -- resumed after SYNCHR operand
...
L_2A0E:
    ...
    .byte ')'                                  # 2A13: 29 -- inline SYNCHR operand
L_2A14:
    .byte 0x59, 0x5A # 2A14
    push   cx                                    # 2A16: 51
    .byte 0x8A, 0xEA # 2A17
...
L_2A33:
    ...
    .byte ','                                  # 2A37: 2C -- inline SYNCHR operand
    call L_1727                                  # 2A38: E8 -- resumed after SYNCHR operand
    in     al,dx                                 # 2A39: EC
    in     al,dx                                 # 2A3A: EC
    call   L_643B                                # 2A3B: E8 FD 39
L_2A3E:
    call   SYNCHR                                # 2A3E: E8 B3 03
    .byte ','                                  # 2A41: 2C -- inline SYNCHR operand
    push   bx                                    # 2A42: 53 -- resumed after SYNCHR operand
    ...
    .byte ')'                                  # 2A51: 29 -- inline SYNCHR operand
    push   bx                                    # 2A52: 53 -- resumed after SYNCHR operand
    call L_28A6                                  # 2A53: E8 -- resumed after SYNCHR operand
    push   ax                                    # 2A54: 50
...
L_2AD0:
    ...
    .byte '('                                  # 2AD3: 28 -- inline SYNCHR operand
    call L_376E                                  # 2AD4: E8 -- resumed after SYNCHR operand
    xchg   di,ax                                 # 2AD5: 97
...
L_2AFB:
    ...
    .byte ','                                  # 2B03: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 2B04: E8 -- resumed after SYNCHR operand
...
L_2B7A:
    ...
    .byte ','                                  # 2B83: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 2B84: E8 -- resumed after SYNCHR operand
    xchg   bp,ax                                 # 2B85: 95
    .byte 0xF3 # 2B86
L_2B87:
    .byte 0xE8, 0x6A, 0x02 # 2B87
    .byte ')'                                  # 2B8A: 29 -- inline SYNCHR operand
    ret                                          # 2B8B: C3 -- resumed after SYNCHR operand
L_2B8C:
...
SWAP:
    ...
    .byte ','                                  # 2EBD: 2C -- inline SYNCHR operand
    call L_376E                                  # 2EBE: E8 -- resumed after SYNCHR operand
...
L_2F5F:
    ...
    .byte ','                                  # 2F62: 2C -- inline SYNCHR operand
    je L_2F4D                                    # 2F63: 74 -- resumed after SYNCHR operand
...
L_2F70:
    ...
    .byte ','                                  # 2F7A: 2C -- inline SYNCHR operand
    je L_2FC5                                    # 2F7B: 74 -- resumed after SYNCHR operand
    dec    ax                                    # 2F7C: 48
...
L_3761:
    ret                                          # 3761: C3
    .byte 0xE8, 0x8F, 0xF6 # 3762 -- unresolved bytes preceding SYNCHR inline operand
    .byte ','                                  # 3765: 2C -- inline SYNCHR operand
DIM:
...
L_3ACB:
    ...
    .byte ';'                                  # 3AD4: 3B -- inline SYNCHR operand
    xchg   dx,bx                                 # 3AD5: 87 DA -- resumed after SYNCHR operand
    mov    bx,WORD PTR ds:0x4a3                  # 3AD7: 8B -- resumed after SYNCHR operand
    push   ds                                    # 3AD8: 1E
...
L_3DDE:
    ...
    .byte ','                                  # 3DEC: 2C -- inline SYNCHR operand
    dec    bx                                    # 3DED: 4B -- resumed after SYNCHR operand
L_3DEE:
...
L_4040:
    ...
    .byte ','                                  # 4045: 2C -- inline SYNCHR operand
    cmp    al,0x23                               # 4046: 3C -- resumed after SYNCHR operand
    and    si,WORD PTR [di+0x3]                  # 4047: 23 75 03
    call   CHRGTR                                # 404A: E8 D0 CE
    call   L_1F1C                                # 404D: E8 CC DE
    call   SYNCHR                                # 4050: E8 A1 ED
    .byte ','                                  # 4053: 2C -- inline SYNCHR operand
    mov    al,dl                                 # 4054: 8A -- resumed after SYNCHR operand
...
L_406A:
    ...
    .byte 'A'                                  # 4089: 41 -- inline SYNCHR operand
    call   SYNCHR                                # 408A: E8 67 ED
    .byte 'P'                                  # 408D: 50 -- inline SYNCHR operand
    call   SYNCHR                                # 408E: E8 63 ED
    .byte 'P'                                  # 4091: 50 -- inline SYNCHR operand
    call   SYNCHR                                # 4092: E8 5F ED
    .byte 'E'                                  # 4095: 45 -- inline SYNCHR operand
    call   SYNCHR                                # 4096: E8 5B ED
    .byte 'N'                                  # 4099: 4E -- inline SYNCHR operand
    call   SYNCHR                                # 409A: E8 57 ED
    .byte 'D'                                  # 409D: 44 -- inline SYNCHR operand
    mov    dl,0x8                                # 409E: B2 08
    jmp    L_40CE                                # 40A0: EB 2C
L_40A2:
    call   CHRGTR                                # 40A2: E8 78 CE
    call   SYNCHR                                # 40A5: E8 4C ED
    .byte 'U'                                  # 40A8: 55 -- inline SYNCHR operand
    call   SYNCHR                                # 40A9: E8 48 ED
    .byte 'T'                                  # 40AC: 54 -- inline SYNCHR operand
    call   SYNCHR                                # 40AD: E8 44 ED
    .byte 'P'                                  # 40B0: 50 -- inline SYNCHR operand
    call   SYNCHR                                # 40B1: E8 40 ED
    .byte 'U'                                  # 40B4: 55 -- inline SYNCHR operand
    call   SYNCHR                                # 40B5: E8 3C ED
    .byte 'T'                                  # 40B8: 54 -- inline SYNCHR operand
    mov    dl,0x2                                # 40B9: B2 02
    jmp    L_40CE                                # 40BB: EB 11
L_40BD:
    call   CHRGTR                                # 40BD: E8 5D CE
    call   SYNCHR                                # 40C0: E8 31 ED
    .byte 'B'                                  # 40C3: 42 -- inline SYNCHR operand
    call   SYNCHR                                # 40C4: E8 2D ED
    .byte 'M'                                  # 40C7: 4D -- inline SYNCHR operand
...
L_40CE:
    ...
    .byte 'A'                                  # 40D1: 41 -- inline SYNCHR operand
    call   SYNCHR                                # 40D2: E8 1F ED
    .byte 'S'                                  # 40D5: 53 -- inline SYNCHR operand
    push   dx                                    # 40D6: 52
...
L_416F:
    ...
    .byte 'R'                                  # 418A: 52 -- inline SYNCHR operand
    pop    ax                                    # 418B: 58
    sahf                                         # 418C: 9E
    stc                                          # 418D: F9
    lahf                                         # 418E: 9F
...
L_41DF:
    ...
    .byte ','                                  # 41E4: 2C -- inline SYNCHR operand
    cmp    al,0x50                               # 41E5: 3C -- resumed after SYNCHR operand
    push   ax                                    # 41E6: 50
...
L_41F1:
    ...
    .byte 'A'                                  # 41F4: 41 -- inline SYNCHR operand
    .byte 0x0A, 0xC0 # 41F5
...
L_43EA:
    ...
    .byte '$'                                  # 43F0: 24 -- inline SYNCHR operand
    call SYNCHR                                  # 43F1: E8 -- resumed after SYNCHR operand
    add    dl,ch                                 # 43F2: 00 EA
    .byte '('                                  # 43F4: 28 -- inline SYNCHR operand
    push   bx                                    # 43F5: 53 -- resumed after SYNCHR operand
    mov    bx,WORD PTR ds:0x4e9                  # 43F6: 8B -- resumed after SYNCHR operand
    push   ds                                    # 43F7: 1E
    ...
    .byte 0xD3, 0xE9 # 441F -- unresolved bytes preceding SYNCHR inline operand
    .byte ')'                                  # 4421: 29 -- inline SYNCHR operand
    .byte 0x58, 0x9E, 0x5E, 0x87, 0xDE, 0x56, 0x9F, 0x50, 0x8A # 4422 -- unresolved bytes following SYNCHR inline operand
...
L_44E6:
    ...
    .byte ','                                  # 44F0: 2C -- inline SYNCHR operand
    mov    al,dl                                 # 44F1: 8A -- resumed after SYNCHR operand
...
L_466A:
    ...
    .byte ','                                  # 466E: 2C -- inline SYNCHR operand
    call   0x469d                                # 466F: E8 -- resumed after SYNCHR operand
...
L_467E:
    ...
    .byte ','                                  # 4681: 2C -- inline SYNCHR operand
    call   0x469d                                # 4682: E8 -- resumed after SYNCHR operand
...
L_4785:
    ...
    .byte '('                                  # 4788: 28 -- inline SYNCHR operand
    call L_1F0A                                  # 4789: E8 -- resumed after SYNCHR operand
    jle    L_4763                                # 478A: 7E D7
    push   dx                                    # 478C: 52
    call   SYNCHR                                # 478D: E8 64 E6
    .byte ','                                  # 4790: 2C -- inline SYNCHR operand
    call L_1F0A                                  # 4791: E8 -- resumed after SYNCHR operand
    jbe    L_476B                                # 4792: 76 D7
    call   SYNCHR                                # 4794: E8 5D E6
    .byte ')'                                  # 4797: 29 -- inline SYNCHR operand
    pop    cx                                    # 4798: 59 -- resumed after SYNCHR operand
    popf                                         # 4799: 9D -- resumed after SYNCHR operand
L_479A:
    push   bx                                    # 479A: 53
...
L_4809:
    ...
    .byte ','                                  # 4816: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 4817: 3C -- resumed after SYNCHR operand
...
L_4882:
    ...
    .byte TK_MINUS                             # 488A: EA -- inline SYNCHR operand
    call L_477B                                  # 488B: E8 ED FE -- resumed after SYNCHR operand
    call   0x4807                                # 488E: E8 -- resumed after SYNCHR operand
    .byte 0x76, 0xFF, 0x5A, 0x59, 0x74, 0x53, 0xE8, 0x5C, 0xE5 # 488F -- unresolved bytes preceding SYNCHR inline operand
    .byte ','                                  # 4898: 2C -- inline SYNCHR operand
    .byte 0xE8, 0x58 # 4899 -- unresolved bytes following SYNCHR inline operand
    .byte 0xE5, 0x42, 0x75, 0x03, 0xE9, 0x60, 0x00, 0xE8, 0x4F, 0xE5 # 489B -- unresolved bytes preceding SYNCHR inline operand
    .byte 'F'                                  # 48A5: 46 -- inline SYNCHR operand
    .byte 0x53 # 48A6 -- unresolved bytes following SYNCHR inline operand
...
KEYS:
    ...
    .byte ','                                  # 5052: 2C -- inline SYNCHR operand
    call L_1727                                  # 5053: E8 -- resumed after SYNCHR operand
    rol    si,1                                  # 5054: D1 C6
    push   bx                                    # 5056: 53
...
L_51C4:
    ...
    .byte ','                                  # 51C7: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 51C8: 3C -- resumed after SYNCHR operand
    ...
    .byte ','                                  # 51E4: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 51E5: 3C -- resumed after SYNCHR operand
    ...
    .byte ','                                  # 51F8: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 51F9: E8 -- resumed after SYNCHR operand
...
L_53AB:
    ...
    .byte ','                                  # 53AE: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 53AF: 3C -- resumed after SYNCHR operand
...
L_53BD:
    ...
    .byte ','                                  # 53C9: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 53CA: E8 -- resumed after SYNCHR operand
    dec    di                                    # 53CB: 4F
    retf                                         # 53CC: CB
...
L_543F:
    ...
    .byte ','                                  # 5442: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 5443: 3C -- resumed after SYNCHR operand
    ...
    .byte ','                                  # 5466: 2C -- inline SYNCHR operand
    cmp    al,0x2c                               # 5467: 3C -- resumed after SYNCHR operand
...
L_5481:
    ...
    .byte 0xE8, 0x6D, 0xD9 # 5484 -- unresolved bytes preceding SYNCHR inline operand
    .byte ','                                  # 5487: 2C -- inline SYNCHR operand
    .byte 0xE8, 0x91, 0xCA, 0x3C, 0x20, 0x73, 0xF2, 0x59 # 5488 -- unresolved bytes following SYNCHR inline operand
    .byte 0x80, 0xE5, 0x20, 0x0A, 0xE8, 0x8A, 0xC8, 0x51, 0xE8, 0x83, 0xBA, 0x74 # 5490
    .byte 0x0F, 0xE8, 0x54, 0xD9 # 549C -- unresolved bytes preceding SYNCHR inline operand
    .byte ','                                  # 54A0: 2C -- inline SYNCHR operand
    .byte 0xE8, 0x78, 0xCA, 0x3C, 0x20, 0x73, 0xD9 # 54A1 -- unresolved bytes following SYNCHR inline operand
...
L_55AF:
    ...
    .byte ','                                  # 55B2: 2C -- inline SYNCHR operand
    call L_1F1C                                  # 55B3: E8 -- resumed after SYNCHR operand
    leaved                                       # 55B4: 66 C9
L_55B6:
    push   ax                                    # 55B6: 50
    call   SYNCHR                                # 55B7: E8 3A D8
    .byte ')'                                  # 55BA: 29 -- inline SYNCHR operand
    pop    ax                                    # 55BB: 58 -- resumed after SYNCHR operand
    or     al,al                                 # 55BC: 0A -- resumed after SYNCHR operand
    rcr    BYTE PTR [bx+si+0x74],0x2             # 55BD: C0 58 74 02
    .byte 0x8A, 0xC4 # 55C1
    jmp    L_4BD8                                # 55C3: E9 12 F6
L_55C6:
    jmp    L_1059                                # 55C6: E9 90 BA
    .byte 0xE8, 0x05, 0x00, 0xE8, 0x25, 0xD8 # 55C9 -- unresolved bytes preceding SYNCHR inline operand
    .byte ')'                                  # 55CF: 29 -- inline SYNCHR operand
    .byte 0xC3 # 55D0 -- unresolved bytes following SYNCHR inline operand
L_55D1:
    call   SYNCHR                                # 55D1: E8 20 D8
    .byte '('                                  # 55D4: 28 -- inline SYNCHR operand
    call L_1F0A                                  # 55D5: E8 -- resumed after SYNCHR operand
    .byte 0x32, 0xC9 # 55D6
    push   dx                                    # 55D8: 52
    call   SYNCHR                                # 55D9: E8 18 D8
    .byte ','                                  # 55DC: 2C -- inline SYNCHR operand
    call L_1F0A                                  # 55DD: E8 -- resumed after SYNCHR operand
    .byte 0x2A, 0xC9 # 55DE
    pop    cx                                    # 55E0: 59
    ret                                          # 55E1: C3
L_55E2:
    ...
    .byte TOK_OFF                              # 55EC: DD -- inline SYNCHR operand
    xor    al,al                                 # 55ED: 32 -- resumed after SYNCHR operand
...
L_56FA:
    ...
    .byte TOK_OFF                              # 5704: DD -- inline SYNCHR operand
    xor    al,al                                 # 5705: 32 -- resumed after SYNCHR operand
...
SOUNDS:
    ...
    .byte ','                                  # 5835: 2C -- inline SYNCHR operand
    call L_22AA                                  # 5836: E8 -- resumed after SYNCHR operand
...
CALLS:
    ...
    .byte '('                                  # 5DC3: 28 -- inline SYNCHR operand
L_5DC4:
...
L_5DD3:
    ...
    .byte ')'                                  # 5DD6: 29 -- inline SYNCHR operand
L_5DD7:
