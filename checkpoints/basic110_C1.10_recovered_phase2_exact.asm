...
LET:
    ...
    .byte 0x89 # 1196 -- decoded continuation: mov    WORD PTR ds:0x33b,dx
    push   ss                                    # 1197: 16
...
AUTO:
    ...
    .byte 0x8B # 12CF -- decoded continuation: mov    dx,WORD PTR ds:0x341
    push   ss                                    # 12D0: 16
    inc    cx                                    # 12D1: 41
...
L_1644:
    ...
    .byte 0xE8, 0xA2, 0x17 # 164F -- pending CFG recovery before inline operand
    .byte ','                                  # 1652: 2C -- SYNCHR inline operand
L_1653:
...
L_1E0A:
    ...
    .byte 0xB0, 0x80, 0xA2 # 1E0E -- decoded continuation: mov    al,0x80 ; mov    ds:0x339,al
...
L_3761:
    ret                                          # 3761: C3
    .byte 0xE8, 0x8F, 0xF6 # 3762 -- pending CFG recovery before inline operand
    .byte ','                                  # 3765: 2C -- SYNCHR inline operand
DIM:
...
L_3ACB:
    ...
    .byte 0x87, 0xDA, 0x8B # 3AD5 -- decoded continuation: xchg   dx,bx ; mov    bx,WORD PTR ds:0x4a3
    push   ds                                    # 3AD8: 1E
...
L_43EA:
    ...
    .byte 0x53, 0x8B # 43F5 -- decoded continuation: push   bx ; mov    bx,WORD PTR ds:0x4e9
    push   ds                                    # 43F7: 1E
    ...
    .byte 0xD3, 0xE9 # 441F -- pending CFG recovery before inline operand
    .byte ')'                                  # 4421: 29 -- SYNCHR inline operand
...
L_4882:
    ...
    .byte TK_MINUS                             # 488A: EA -- SYNCHR inline operand
    .byte 0xE8, 0xED, 0xFE, 0xE8 # 488B -- decoded continuation: call   0x477b ; call   0x4807
    .byte 0x76, 0xFF, 0x5A, 0x59, 0x74, 0x53, 0xE8, 0x5C, 0xE5 # 488F -- pending CFG recovery before inline operand
    .byte ','                                  # 4898: 2C -- SYNCHR inline operand
    .byte 0xE8, 0x58 # 4899 -- call   0x2df4
    .byte 0xE5, 0x42, 0x75, 0x03, 0xE9, 0x60, 0x00, 0xE8, 0x4F, 0xE5 # 489B -- pending CFG recovery before inline operand
    .byte 'F'                                  # 48A5: 46 -- SYNCHR inline operand
    .byte 0x53 # 48A6 -- push   bx
...
L_5481:
    ...
    .byte 0xE8, 0x6D, 0xD9 # 5484 -- pending CFG recovery before inline operand
    .byte ','                                  # 5487: 2C -- SYNCHR inline operand
    .byte 0xE8, 0x91, 0xCA, 0x3C, 0x20, 0x73, 0xF2, 0x59 # 5488 -- call   0x1f1c ; cmp    al,0x20 ; jae    0x5481 ; pop    cx
    .byte 0x80, 0xE5, 0x20, 0x0A, 0xE8, 0x8A, 0xC8, 0x51, 0xE8, 0x83, 0xBA, 0x74 # 5490
    .byte 0x0F, 0xE8, 0x54, 0xD9 # 549C -- pending CFG recovery before inline operand
    .byte ','                                  # 54A0: 2C -- SYNCHR inline operand
    .byte 0xE8, 0x78, 0xCA, 0x3C, 0x20, 0x73, 0xD9 # 54A1 -- call   0x1f1c ; cmp    al,0x20 ; jae    0x5481
...
L_55AF:
    ...
    .byte ','                                  # 55B2: 2C -- SYNCHR inline operand
    .byte 0xE8 # 55B3 -- decoded continuation: call   0x1f1c
    leaved                                       # 55B4: 66 C9
L_55B6:
    push   ax                                    # 55B6: 50
    call   SYNCHR                                # 55B7: E8 3A D8
    .byte ')'                                  # 55BA: 29 -- SYNCHR inline operand
    .byte 0x58, 0x0A # 55BB -- decoded continuation: pop    ax ; or     al,al
    rcr    BYTE PTR [bx+si+0x74],0x2             # 55BD: C0 58 74 02
    .byte 0x8A, 0xC4 # 55C1
    jmp    L_4BD8                                # 55C3: E9 12 F6
L_55C6:
    jmp    L_1059                                # 55C6: E9 90 BA
    .byte 0xE8, 0x05, 0x00, 0xE8, 0x25, 0xD8 # 55C9 -- pending CFG recovery before inline operand
    .byte ')'                                  # 55CF: 29 -- SYNCHR inline operand
    .byte 0xC3 # 55D0 -- ret
L_55D1:
    call   SYNCHR                                # 55D1: E8 20 D8
    .byte '('                                  # 55D4: 28 -- SYNCHR inline operand
    .byte 0xE8 # 55D5 -- decoded continuation: call   0x1f0a
    .byte 0x32, 0xC9 # 55D6
    push   dx                                    # 55D8: 52
    call   SYNCHR                                # 55D9: E8 18 D8
    .byte ','                                  # 55DC: 2C -- SYNCHR inline operand
    .byte 0xE8 # 55DD -- decoded continuation: call   0x1f0a
    .byte 0x2A, 0xC9 # 55DE
    pop    cx                                    # 55E0: 59
    ret                                          # 55E1: C3
L_55E2:
