...
# SEMANTIC RECOVERY SOURCE - PHASE 8 (exact C1.10 rebuild)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Recovered interpreter constants / DSEG map (phase 8, high-confidence only)
...
L_3ADD:
    ...
    push   bx                                    # 3AE7: 53
    .byte 0x32, 0xC0 # 3AE8
    mov    ds:FLGINP,al                           # 3AEA: A2 3A 03
    inc    al                                    # 3AED: FE C0
    pushf                                        # 3AEF: 9C
    push   dx                                    # 3AF0: 52
