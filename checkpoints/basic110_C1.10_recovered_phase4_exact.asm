...
# SEMANTIC RECOVERY SOURCE - PHASE 4 (exact C1.10 rebuild)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Recovered interpreter constants / DSEG map (phase 4, high-confidence only)
