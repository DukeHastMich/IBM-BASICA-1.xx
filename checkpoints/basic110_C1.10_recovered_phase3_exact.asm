...
# SEMANTIC RECOVERY SOURCE - PHASE 3 (exact C1.10 rebuild)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Recovered interpreter constants / DSEG map (phase 3, high-confidence only)
...
L_3ACB:
    ...
    .byte 0x87, 0xDA, 0x8B # 3AD5 -- decoded continuation: xchg   dx,bx ; mov    bx,WORD PTR ds:FACLO
    push   ds                                    # 3AD8: 1E
