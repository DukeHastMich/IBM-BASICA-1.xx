...
.equ CASSETTE_MOTOR_STATE, 0x0064   # semantic: remembered cassette MOTOR on/off state passed through BIOS INT 15h
...
MOTOR:
    ...
    mov    al,ds:CASSETTE_MOTOR_STATE                            # 5D2C: A0 64 00
...
L_5D3E:
    mov    ds:CASSETTE_MOTOR_STATE,al                            # 5D3E: A2 64 00
    .byte 0x8A, 0xE0 # 5D41
    int    0x15                                  # 5D43: CD 15
    ret                                          # 5D45: C3
L_5D46:
